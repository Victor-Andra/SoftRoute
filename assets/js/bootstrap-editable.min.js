...
!(function (a) {
                    ...
                    .done(
                        a.proxy(function (a) {
                            ...
                            return b === !1
                                ...
                                : (b && "object" == typeof b && b.hasOwnProperty("newValue") && (c = b.newValue), this.error(!1), (this.value = c), void this.$div.triggerHandler("save", { newValue: c, submitValue: e, response: a }));
                        }, this)
                    )
                    .fail(
                        a.proxy(function (a) {
        ...
        save: function (b) {
            ...
            return e
                ? (this.showLoading(),
                  ...
                  "function" == typeof this.options.params ? (c = this.options.params.call(this.options.scope, c)) : ((this.options.params = a.fn.editableutils.tryParseJson(this.options.params, !0)), a.extend(c, this.options.params)),
                  "function" == typeof this.options.url ? this.options.url.call(this.options.scope, c) : a.ajax(a.extend({ url: this.options.url, data: c, type: "POST" }, this.options.ajaxOptions)))
                : void 0;
        },
        validate: function (a) {
    ...
    (function (a) {
        ...
        (b.prototype = {
            ...
            (a.fn.editableContainer.defaults = { value: null, placement: "top", autohide: !0, onblur: "cancel", anim: !1, mode: "popup" }),
        ...
        (b.prototype = {
                    ...
                    switch (
                        (void 0 === this.options.value || null === this.options.value
                            ...
                            : ((this.options.value = a.fn.editableutils.tryParseJson(this.options.value, !0)),
                              "string" == typeof this.options.value ? (this.value = this.input.str2value(this.options.value)) : (this.value = this.options.value)),
            ...
            option: function (b, c) {
                return b && "object" == typeof b
                    ...
                    : ((this.options[b] = c),
                      "disabled" === b ? (c ? this.disable() : this.enable()) : ("value" === b && this.setValue(c), this.container && this.container.option(b, c), void (this.input.option && this.input.option(b, c))));
            },
            handleEmpty: function (b) {
                this.options.display !== !1 &&
                    (void 0 !== b ? (this.isEmpty = b) : "function" == typeof this.input.isEmpty ? (this.isEmpty = this.input.isEmpty(this.$element)) : (this.isEmpty = "" === a.trim(this.$element.html())),
                    this.options.disabled
                        ? this.isEmpty && (this.$element.empty(), this.options.emptyclass && this.$element.removeClass(this.options.emptyclass))
                        : this.isEmpty
                        ? (this.$element.html(this.options.emptytext), this.options.emptyclass && this.$element.addClass(this.options.emptyclass))
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
                ...
                doPrepend: function () {
                    null !== this.options.prepend &&
                        ...
                        (a.isArray(this.prependData) ||
                            ...
                            "string" == typeof this.options.prepend && (this.options.prepend = { "": this.options.prepend }),
                            (this.prependData = this.makeArray(this.options.prepend))),
                        a.isArray(this.prependData) && a.isArray(this.sourceData) && (this.sourceData = this.prependData.concat(this.sourceData)));
                },
                renderList: function () {},
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { source: null, prepend: !1, sourceError: "Error when loading list", sourceCache: !0, sourceOptions: null })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { tpl: '<input type="text">', placeholder: null, clear: !0 })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { tpl: "<textarea></textarea>", inputclass: "input-large", placeholder: null, rows: 7 })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.list),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.list.defaults, { tpl: '<div class="editable-checklist"></div>', inputclass: null, separator: "," })),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            a.extend(b.prototype, {
                ...
                value2input: function (b) {
                    if (
                        ...
                        this.$input.data("select2") ? this.$input.val(b).trigger("change", !0) : (this.$input.val(b), this.$input.select2(this.options.select2)),
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, { tpl: "<select></select>", select2: null, placeholder: null, source: null, viewseparator: ", " })),
        ...
        (b.prototype = {
            ...
            getValue: function (b) {
                ...
                return (
                    ...
                    f
                        ? ""
                        : (this.$ampm && (12 === d.hour ? (d.hour = "am" === this.$ampm.val() ? 0 : 12) : (d.hour = "am" === this.$ampm.val() ? d.hour : d.hour + 12)),
            ...
            setValue: function (b) {
                ...
                if (b) {
                    ...
                    d.isValid() &&
                        ...
                        this.$ampm && (f.hour >= 12 ? ((f.ampm = "pm"), f.hour > 12 && (f.hour -= 12)) : ((f.ampm = "am"), 0 === f.hour && (f.hour = 12))),
                        a.each(f, function (a, b) {
                            e["$" + a] &&
                                ("minute" === a && e.options.minuteStep > 1 && e.options.roundTime && (b = c(e["$" + a], b)), "second" === a && e.options.secondStep > 1 && e.options.roundTime && (b = c(e["$" + a], b)), e["$" + a].val(b));
                        }),
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
            a.extend(b.prototype, {
                ...
                parseDate: function (a, b) {
                    ...
                    return (
                        a &&
                            ((d = this.dpg.parseDate(a, b, this.options.datetimepicker.language, this.options.formatType)),
                            "string" == typeof a && ((c = this.dpg.formatDate(d, b, this.options.datetimepicker.language, this.options.formatType)), a !== c && (d = null))),
                        d
                    );
                },
            }),
