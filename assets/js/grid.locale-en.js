    ...
    (a.jgrid = a.jgrid || {}),
        ...
        (a.jgrid.regional.en = {
            defaults: {
                ...
                loadtext: "Carreegando...",
                savetext: "Salvando...",
                pgtext: "Página {0} de {1}",
                pgfirst: "Primeira Página",
                pglast: "Ultima Página",
                pgnext: "Próxima Página",
                pgprev: "Página Anterior",
                pgrecs: "Registros por Página",
                showhide: "Encolhe e Expande Tabela",
                pagerCaption: "Tabela::Página de configuração",
                pageText: "Páginas:",
                recordPage: "Registros por Página",
                nomorerecs: "Não Há mais Registros...",
                scrollPullup: "Click para mostra mais...",
                scrollPulldown: "presione para recarregar...",
                scrollRefresh: "aperte para recarregar...",
            },
            search: {
                caption: "Pesquisar...",
                Find: "Achar",
