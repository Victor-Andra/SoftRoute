...
!(function (a) {
    ...
    (f.Client.prototype = {
        ...
        glue: function (a, b) {
            ...
            (g.position = "absolute"),
                ...
                this.domElement && (this.domElement.appendChild(this.div), (this.div.innerHTML = this.getHTML(e.width, e.height).replace(/&/g, "&amp;")));
        },
        ...
        receiveEvent: function (a, d) {
            ...
            switch ((a = a.toString().toLowerCase().replace(/^on/, ""))) {
                case "load":
                    if (((this.movie = c.getElementById(this.movieId)), !this.movie))
                        return (
                            (e = this),
        ...
        m = function (a, b) {
            for (
                var c = l(b),
                    ...
                    k = b.header ? j(e.header) + c : "",
                    m = b.footer && e.footer ? c + j(e.footer) : "",
                    n = [],
                    o = 0,
                    p = e.body.length;
                p > o;
    ...
    return (
        (e.Buttons.swfPath = "assets/swf/flashExport.swf"),
        ...
        (e.ext.buttons.copyFlash = a.extend({}, n, {
            ...
            action: function (a, b, c, d) {
                if (d._fromFlash) {
                    ...
                    e.setAction("copy"), k(e, g), b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), b.i18n("buttons.copyInfo", { _: "Copied %d rows to clipboard", 1: "Copied 1 row to clipboard" }, f.rows), 3e3);
                }
            },
            fieldSeparator: "	",
            fieldBoundary: "",
        ...
        (e.ext.buttons.pdfFlash = a.extend({}, n, {
            ...
            action: function (a, b, c, d) {
                ...
                e.setAction("pdf"),
                    e.setFileName(j(d)),
                    k(e, JSON.stringify({ title: h(d, !1), message: d.message, colWidth: i.toArray(), orientation: d.orientation, size: d.pageSize, header: d.header ? f.header : null, footer: d.footer ? f.footer : null, body: f.body }));
            },
            extension: ".pdf",
