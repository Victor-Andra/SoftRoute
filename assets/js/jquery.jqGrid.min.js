...
!(function (a) {
    ...
    ($.jgrid = $.jgrid || {}),
        ...
        $.extend($.jgrid, {
            ...
            htmlDecode: function (a) {
                return a && ("&nbsp;" === a || "&#160;" === a || (1 === a.length && 160 === a.charCodeAt(0)))
                    ? ""
                    : a
                    ? String(a)
                          .replace(/&gt;/g, ">")
                ...
                if ((void 0 === d && (d = $.jgrid.getRegional(this, "formatter.date")), void 0 === d.parseRe && (d.parseRe = /[#%\\\/:_;.,\t\s-]/), d.masks.hasOwnProperty(a) && (a = d.masks[a]), b && null != b))
                    if (isNaN(b - 0) || "u" !== String(a).toLowerCase())
                        if (b.constructor === Date) o = b;
                            ...
                            for (
                                "ISO8601Long" === d.srcformat && "Z" === b.charAt(b.length - 1) && (q -= new Date().getTimezoneOffset()),
                    ...
                    QueryObject = function (d, q) {
                        ...
                        return (
                            ...
                            (this._compare = function (a, b, c) {
                                ...
                                return (
                                    ...
                                    null === a && null === b
                                        ...
                                        : null !== a && null === b
                                        ? -1
                                        : "[object Date]" === d.call(a) && "[object Date]" === d.call(b)
                                        ? b > a
                                            ? -c
                                            : a > b
                                            ? c
                                            : 0
                                        : (_usecase || "number" == typeof a || "number" == typeof b || ((a = String(a)), (b = String(b))), b > a ? -c : a > b ? c : 0)
                                );
                            }),
                            ...
                            (this._getOrder = function (a, b, c, d, e, f) {
                                ...
                                void 0 === d && (d = "text"),
                                    (j =
                                        "float" === d || "number" === d || "currency" === d || "numeric" === d
                                            ? function (a) {
                            ...
                            (this.startsWith = function (a, b) {
                                ...
                                return (
                                    _useProperties
                                        ? self._append(self._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + d + ") == " + self._getStr('"' + self._toStr(b) + '"'))
                                        : (null != b && (d = _trim ? $.trim(b.toString()).length : b.toString().length), self._append(self._getStr("this") + ".substr(0," + d + ") == " + self._getStr('"' + self._toStr(a) + '"'))),
                            ...
                            (this.endsWith = function (a, b) {
                                ...
                                return (
                                    _useProperties
                                        ? self._append(
                                              self._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + self._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + d + "," + d + ') == "' + self._toStr(b) + '"'
                                          )
                                        : self._append(self._getStr("this") + ".substr(" + self._getStr("this") + '.length-"' + self._toStr(a) + '".length,"' + self._toStr(a) + '".length) == "' + self._toStr(a) + '"'),
                            ...
                            (this.contains = function (a, b) {
                                return (
                                    _useProperties
                                        ? self._append(self._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + self._toStr(b) + '",0) > -1')
                                        : self._append(self._getStr("this") + '.indexOf("' + self._toStr(a) + '",0) > -1'),
                            ...
                            (this.orderBy = function (a, b, c, d, e) {
                                return (
                                    ...
                                    _sorting.push({ by: a, dir: b, type: c, datefmt: d, sfunc: e }),
                                    self
                                );
                            }),
                            self
            ...
            styleUI: {
                jQueryUI: {
                    ...
                    inlinedit: { inputClass: "ui-widget-content ui-corner-all", icon_edit_nav: "ui-icon-pencil", icon_add_nav: "ui-icon-plus", icon_save_nav: "ui-icon-disk", icon_cancel_nav: "ui-icon-cancel" },
                    formedit: {
                    ...
                    treegrid: { icon_plus: "ui-icon-triangle-1-", icon_minus: "ui-icon-triangle-1-s", icon_leaf: "ui-icon-radio-off" },
                    fmatter: { icon_edit: "ui-icon-pencil", icon_add: "ui-icon-plus", icon_save: "ui-icon-disk", icon_cancel: "ui-icon-cancel", icon_del: "ui-icon-trash" },
                },
                Bootstrap: {
                    common: {
                    ...
                    inlinedit: { inputClass: "form-control", icon_edit_nav: "glyphicon-edit", icon_add_nav: "glyphicon-plus", icon_save_nav: "glyphicon-save", icon_cancel_nav: "glyphicon-remove-circle" },
                    formedit: {
                    ...
                    filter: { table_widget: "table table-condensed", srSelect: "form-control", srInput: "form-control", menu_widget: "", icon_search: "glyphicon-search", icon_reset: "glyphicon-refresh", icon_query: "glyphicon-comment" },
                    subgrid: { icon_plus: "glyphicon-triangle-right", icon_minus: "glyphicon-triangle-bottom", icon_open: "glyphicon-indent-left" },
                    treegrid: { icon_plus: "glyphicon-triangle-right", icon_minus: "glyphicon-triangle-bottom", icon_leaf: "glyphicon-unchecked" },
                    fmatter: { icon_edit: "glyphicon-edit", icon_add: "glyphicon-plus", icon_save: "glyphicon-save", icon_cancel: "glyphicon-remove-circle", icon_del: "glyphicon-trash" },
                },
            },
        }),
        ($.fn.jqGrid = function (a) {
            ...
            return this.each(function () {
                if (!this.grid) {
                    ...
                    var d = this,
                        e = {
                            ...
                            dragStart: function (a, b, e) {
                                ...
                                (this.resizing = { idx: a, startX: b.pageX, sOL: b.pageX - f }),
                                    (this.hDiv.style.cursor = "col-resize"),
                                    (this.curGbox = $("#rs_m" + $.jgrid.jqID(c.id), "#gbox_" + $.jgrid.jqID(c.id))),
                                    this.curGbox.css({ display: "block", left: b.pageX - f, top: e[1], height: e[2] }),
                            ...
                            dragMove: function (a) {
                                if (this.resizing) {
                                    ...
                                    g > 33 &&
                                        ...
                                        c.forceFit === !0
                                            ? ((b = this.headers[this.resizing.idx + c.nv]), (d = "ltr" === c.direction ? b.width - e : b.width + e), d > c.minColWidth && ((f.newWidth = g), (b.newWidth = d)))
                                            : ((this.newWidth = "ltr" === c.direction ? c.tblwidth + e : c.tblwidth - e), (f.newWidth = g)));
                                }
                            },
                            dragEnd: function (a) {
                                if (((this.hDiv.style.cursor = "default"), this.resizing)) {
                                    ...
                                    (e = parseInt(e, 10)),
                                        ...
                                        c.forceFit === !0
                                            ? ((e = this.headers[b + c.nv].newWidth || this.headers[b + c.nv].width),
                                            ...
                                            : ((c.tblwidth = this.newWidth || c.tblwidth),
                                              ...
                                              c.footerrow && ($("table:first", this.sDiv).css("width", c.tblwidth + "px"), (this.sDiv.scrollLeft = this.bDiv.scrollLeft))),
                                ...
                                if (a) {
                                    ...
                                    if (f) {
                                        ...
                                        if (
                                            (a > o &&
                                                0 >= n &&
                                                (void 0 === c.lastpage || (parseInt((o + m + p - 1) / p, 10) || 0) <= c.lastpage) &&
                                                ((j = parseInt((a - o + p - 1) / p, 10) || 1), o >= 0 || 2 > j || c.scroll === !0 ? ((i = (Math.round((o + m) / p) || 0) + 1), (n = -1)) : (n = 1)),
                                            n > 0 && ((i = (parseInt(m / p, 10) || 0) + 1), (j = (parseInt((m + a) / p, 10) || 0) + 2 - i), (k = !0)),
                                            j)
                                        ) {
                                            ...
                                            e.hDiv.loading ? (e.timer = setTimeout(e.populateVisible, c.scrollTimeout)) : ((c.page = i), k && (e.selectionPreserver(g[0]), e.emptyRows.call(g[0], !1, !1)), e.populate(j)),
                                                c.scrollPopUp &&
                                                    ...
                                                    ($("#scroll_g" + c.id)
                                                        .show()
                                                        .html($.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", c.pgtext), c.page, c.lastpage))
                                                        .css({ top: c.scrollTopOffset + m * ((parseInt(c.height, 10) - 45) / (parseInt(f, 10) * parseInt(c.records, 10))) + "px", left: c.scrollLeftOffset }),
                    ...
                    var w,
                        ...
                        z = function (a, b, c, f, g, h) {
                            ...
                            return (
                                ...
                                0 === b
                                    ...
                                    : ($.isFunction(k.cellattr) || ("string" == typeof k.cellattr && null != $.jgrid.cellattr && $.isFunction($.jgrid.cellattr[k.cellattr]))) &&
                                      ((i = $.isFunction(k.cellattr) ? k.cellattr : $.jgrid.cellattr[k.cellattr]),
                                      (j = i.call(d, g, c, f, k, h)),
                                      j &&
                                          "string" == typeof j &&
                                          ((j = j.replace(/style/i, "style").replace(/title/i, "title")),
                                          j.indexOf("title") > -1 && (k.title = !1),
                                          j.indexOf("class") > -1 && (n = void 0),
                                          (p = j.replace(/\-style/g, "-sti").split(/style/)),
                                          2 === p.length
                                              ? ((p[1] = $.trim(p[1].replace(/\-sti/g, "-style").replace("=", ""))), (0 !== p[1].indexOf("'") && 0 !== p[1].indexOf('"')) || (p[1] = p[1].substring(1)), (m += p[1].replace(/'/gi, '"')))
                                              : (m += '"'))),
                                p.length || ((p[0] = ""), (m += '"')),
                            ...
                            for (c = 0; c < d.p.colModel.length; c++)
                                (b = d.p.colModel[c]),
                                    "cb" !== b.name &&
                                        "subgrid" !== b.name &&
                                        "rn" !== b.name &&
                                        ((e[f] = "local" === a ? b.name : "xml" === a || "xmlstring" === a ? b.xmlmap || b.name : b.jsonmap || b.name), d.p.keyName !== !1 && b.key === !0 && (d.p.keyName = e[f]), f++);
                            return e;
                        },
                        G = function (a) {
                        ...
                        H = function (a, b) {
                            ...
                            this.p.deepempty ? $(this.rows).slice(1).remove() : ((c = this.rows.length > 0 ? this.rows[0] : null), $(this.firstChild).empty().append(c)),
                                a &&
                                    this.p.scroll &&
                                    ($(this.grid.bDiv.firstChild).css({ height: "auto" }), $(this.grid.bDiv.firstChild.firstChild).css({ height: "0px", display: "none" }), 0 !== this.grid.bDiv.scrollTop && (this.grid.bDiv.scrollTop = 0)),
                                ...
                                for (j = G(s), k = F("local"), e = m.keyIndex === !1 ? ($.isFunction(p.id) ? p.id.call(d, n) : p.id) : m.keyIndex, a = 0; o > a; a++) {
                                    for (
                                        c = n[a],
                                            ...
                                            void 0 === f &&
                                                ("number" == typeof e && null != q[e + s] && (f = $.jgrid.getAccessor(c, q[e + s].name)),
                                                void 0 === f && ((f = t + a), r && ((g = $.jgrid.getAccessor(c, r) || c), (f = null != g && void 0 !== g[e] ? g[e] : f), (g = null)))),
                                            i = {},
                                            i[p.id] = f,
                        ...
                        J = function () {
                            ...
                            for (a = d.p.keyName === !1 || d.p.loadonce === !0 ? d.p.localReader.id : d.p.keyName, d.p._index = [], b = 0; e > b; b++)
                                (c = $.jgrid.getAccessor(d.p.data[b], a)), void 0 === c && (c = String(b + 1)), (d.p._index[c] = b);
                        },
                            ...
                            if (
                                ("object" != typeof k &&
                                    (k = $.isFunction(d.p.rowattr)
                                        ...
                                        : "string" == typeof d.p.rowattr && null != $.jgrid.rowattr && $.isFunction($.jgrid.rowattr[d.p.rowattr])
                                        ? $.jgrid.rowattr[d.p.rowattr].call(d, e, f, a)
                                        : {}),
                                !$.isEmptyObject(k))
                            ) {
                        ...
                        L = function (a, b, c, e) {
                            ...
                            if ((g && ((d.p.data = []), (d.p._index = {}), (d.p.localReader.id = h)), (d.p.reccount = 0), $.isXMLDoc(a))) {
                                ...
                                if ((Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q)) {
                                    e && (T *= e + 1);
                                    var W,
                                        X = $.isFunction(d.p.afterInsertRow),
                                        Y = !1,
                                    ...
                                    for (d.p.grouping && ((Y = d.p.groupingView.groupCollapse === !0), (W = $.jgrid.getMethod("groupingPrepare"))); Q > R; ) {
                                        ...
                                        if (
                                            ((L[aa] = K(u, Y, v, J, t)),
                                            L.push("</tr>"),
                                            d.p.grouping && (S.push(L), d.p.groupingView._locgr || W.call(w, J, R), (L = [])),
                                            (g || (d.p.treeGrid === !0 && !d.p._ald)) && ((J[h] = $.jgrid.stripPref(d.p.idPrefix, u)), d.p.data.push(J), (d.p._index[J[h]] = d.p.data.length - 1)),
                                            d.p.gridview === !1 && (V.append(L.join("")), w.triggerHandler("jqGridAfterInsertRow", [u, J, t]), X && d.p.afterInsertRow.call(d, u, J, t), (L = [])),
                                            (J = {}),
                                            x++,
                                            R++,
                                            x === T)
                                ...
                                if (
                                    (d.p.gridview === !0 &&
                                        ...
                                        d.p.grouping
                                            ? g || (w.jqGrid("groupingRender", S, d.p.colModel.length, d.p.page, T), (S = null))
                                            : d.p.treeGrid === !0 && n > 0
                                            ? $(d.rows[n]).after(L.join(""))
                                            : (V.append(L.join("")), (d.grid.cols = d.rows[0].cells))),
                                    d.p.subGrid === !0)
                                )
                                    try {
                                        w.jqGrid("addSubGrid", z + B);
                                    } catch (ca) {}
                                if (((d.p.totaltime = new Date() - f), x > 0 && 0 === d.p.records && (d.p.records = Q), (L = null), d.p.treeGrid === !0))
                                    try {
                                ...
                                if (
                                    ...
                                    g && ((d.p.records = Q), (d.p.lastpage = Math.ceil(Q / T))),
                                    c || d.updatepager(!1, !0),
                                    g)
                                ) {
                                    for (; Q > x; ) {
                            ...
                            if (a) {
                                ...
                                for (d.p.grouping && ((aa = d.p.groupingView.groupCollapse === !0), (Y = $.jgrid.getMethod("groupingPrepare"))); t > o; ) {
                                    if (
                                        ...
                                        void 0 === x &&
                                            ("number" == typeof v && null != d.p.colModel[v + J + L + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + L + M].name)), void 0 === x && ((x = W + o), 0 === I.length && g.cell)))
                                    ) {
                                    ...
                                    for (
                                        Q.push(""),
                                            M && Q.push(E(0, o, d.p.page, d.p.rowNum, ca)),
                                            J && Q.push(D(x, M, o, U, da)),
                                            L && Q.push(r.call(A, J + M, o + b)),
                                            s = O,
                                            g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q), $.isArray(q) && (s = N)),
                                            p = 0;
                                        p < s.length;
                                        p++
                                    )
                                        (m = $.jgrid.getAccessor(q, s[p])), (P[d.p.colModel[p + J + L + M].name] = m), Q.push(C(x, m, p + J + L + M, o + b, q, P));
                                    if (
                                        ((z += U ? " " + n : ""),
                                        (Q[fa] = K(x, aa, z, P, q)),
                                        Q.push("</tr>"),
                                        d.p.grouping && (_.push(Q), d.p.groupingView._locgr || Y.call(A, P, o), (Q = [])),
                                        (j || (d.p.treeGrid === !0 && !d.p._ald)) && ((P[i] = $.jgrid.stripPref(d.p.idPrefix, x)), d.p.data.push(P), (d.p._index[P[i]] = d.p.data.length - 1)),
                                        d.p.gridview === !1 && (ba.append(Q.join("")), A.triggerHandler("jqGridAfterInsertRow", [x, P, q]), Z && d.p.afterInsertRow.call(d, x, P, q), (Q = [])),
                                        (P = {}),
                                        B++,
                                        o++,
                                        B === V)
                                ...
                                if (
                                    (d.p.gridview === !0 &&
                                        ((w = d.p.treeANode > -1 ? d.p.treeANode : 0),
                                        d.p.grouping
                                            ? j || (A.jqGrid("groupingRender", _, d.p.colModel.length, d.p.page, V), (_ = null))
                                            : d.p.treeGrid === !0 && w > 0
                                            ? $(d.rows[w]).after(Q.join(""))
                                            : (ba.append(Q.join("")), (d.grid.cols = d.rows[0].cells))),
                                    d.p.subGrid === !0)
                                )
                                    try {
                                        A.jqGrid("addSubGrid", J + M);
                                    } catch (ga) {}
                                if (((d.p.totaltime = new Date() - f), B > 0 && 0 === d.p.records && (d.p.records = t), (Q = null), d.p.treeGrid === !0))
                                    try {
                                ...
                                if (
                                    ...
                                    j && ((d.p.records = t), (d.p.lastpage = Math.ceil(t / V))),
                                    c || d.updatepager(!1, !0),
                                    j)
                                ) {
                                    for (; t > B && u[B]; ) {
                                        if (
                                            ...
                                            (x = $.jgrid.getAccessor(q, v)),
                                            void 0 === x &&
                                                ("number" == typeof v && null != d.p.colModel[v + J + L + M] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + J + L + M].name)), void 0 === x && ((x = W + B), 0 === I.length && g.cell)))
                                        ) {
                        ...
                        N = function () {
                            function a(b) {
                                ...
                                if (null != b.rules)
                                    try {
                                        for (f = b.rules.length && "OR" === b.groupOp.toString().toUpperCase(), f && r.orBegin(), c = 0; c < b.rules.length; c++)
                                            (h = b.rules[c]),
                                                ...
                                                q[h.op] &&
                                                    ...
                                                    (r = q[h.op](r, g)(h.field, h.data, j[h.field]))),
                                                k++;
                                        f && r.orEnd();
                                    } catch (m) {
                                        alert(m);
                            ...
                            if ($.isArray(d.p.data)) {
                                var m,
                                    n,
                                    o,
                                    p = d.p.grouping ? d.p.groupingView : !1;
                                if (
                                    ($.each(d.p.colModel, function () {
                                        if (
                                            ((c = this.sorttype || "text"),
                                            (o = this.index || this.name),
                                            "date" === c || "datetime" === c
                                                ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter
                                                      ? ((b = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(d, "formatter.date.srcformat")),
                                                        (e = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(d, "formatter.date.newformat")))
                                                      : (b = e = this.datefmt || "Y-m-d"),
                                                  (j[o] = { stype: c, srcfmt: b, newfmt: e, sfunc: this.sortfunc || null }))
                                                : (j[o] = { stype: c, srcfmt: "", newfmt: "", sfunc: this.sortfunc || null }),
                                            d.p.grouping)
                                        )
                                            for (n = 0, m = p.groupField.length; m > n; n++) this.name === p.groupField[n] && ((k[n] = j[o]), (l[n] = o));
                                        d.p.multiSort || i || o !== d.p.sortname || ((g = o), (i = !0));
                                    }),
                                    d.p.multiSort && ((g = s), (h = t)),
                                ...
                                d.p.multiSort
                                    ...
                                    : g &&
                                      d.p.sortorder &&
                                      i &&
                                      ("DESC" === d.p.sortorder.toUpperCase() ? r.orderBy(d.p.sortname, "d", j[g].stype, j[g].srcfmt, j[g].sfunc) : r.orderBy(d.p.sortname, "a", j[g].stype, j[g].srcfmt, j[g].sfunc));
                                var w = r.select(),
                                ...
                                return (
                                    (w = d.p.treeGrid && d.p.search ? $(d).jqGrid("searchTree", w) : w.slice((z - 1) * x, z * x)),
                                    (r = null),
                                    (j = null),
                        ...
                        O = function (a, b) {
                            ...
                            if (((p = d.p.pager || ""), (p += d.p.toppager ? (p ? "," + d.p.toppager : d.p.toppager) : ""))) {
                                if (
                                    ((j = $.jgrid.getRegional(d, "formatter.integer")),
                                    (c = y(d.p.page)),
                                    (e = y(d.p.lastpage)),
                                    ...
                                    d.p.pginput === !0 &&
                                        ($("#input" + r).html(
                                            $.jgrid.template(
                                                $.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "",
                                                "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>",
                                        ...
                                        d.p.toppager &&
                                            $("#input_t" + s).html(
                                                $.jgrid.template(
                                                    $.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "",
                                                    "<input " + k(l, "pgInput", !1, "ui-pg-input") + " type='text' size='2' maxlength='7' value='0' role='textbox'/>",
                                                    "<span id='sp_1_" + $.jgrid.jqID(q) + "_toppager'></span>"
                                                )
                                            ),
                                        ...
                                        ? ($("#first" + r + ", #prev" + r)
                                          ...
                                          d.p.toppager &&
                                              $("#first_t" + s + ", #prev_t" + s)
                                                  .addClass(m)
                                                  .removeClass(o))
                                        : ($("#first" + r + ", #prev" + r).removeClass(m), d.p.toppager && $("#first_t" + s + ", #prev_t" + s).removeClass(m)),
                                    c === e || 0 === c
                                        ? ($("#next" + r + ", #last" + r)
                                              .addClass(m)
                                              .removeClass(o),
                                          d.p.toppager &&
                                              $("#next_t" + s + ", #last_t" + s)
                                                  .addClass(m)
                                                  .removeClass(o))
                                        : ($("#next" + r + ", #last" + r).removeClass(m), d.p.toppager && $("#next_t" + s + ", #last_t" + s).removeClass(m)));
                            }
                            a === !0 &&
                                d.p.rownumbers === !0 &&
                                            ...
                                            $.extend(
                                                {
                                                    ...
                                                    success: function (c, f, g) {
                                                        return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1
                                                            ? void Q()
                                                            : ("xml" === b ? L(c, o, a > 1, j) : M(c, o, a > 1, j),
                        ...
                        T = function (a, b) {
                                ...
                                $("#" + $.jgrid.jqID(a))
                                    .append(
                                        "<div id='" +
                                            ...
                                            k(l, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") +
                                            "><tbody><tr><td id='" +
                                            e +
                                            "' align='left'></td><td id='" +
                                            f +
                            ...
                            if (
                                ...
                                var w = ["first" + b, "prev" + b, "next" + b, "last" + b],
                                    ...
                                    z = [
                                        $.jgrid.getRegional(d, "defaults.pgfirst", d.p.pgfirst) || "",
                                        $.jgrid.getRegional(d, "defaults.pgprev", d.p.pgprev) || "",
                                        $.jgrid.getRegional(d, "defaults.pgnext", d.p.pgnext) || "",
                                        $.jgrid.getRegional(d, "defaults.pglast", d.p.pglast) || "",
                                    ];
                            ...
                            "ltr" === h && (s += t),
                                ...
                                (d.p._nvtd = []),
                                (d.p._nvtd[0] = i ? Math.floor((d.p.width - i) / 2) : Math.floor(d.p.width / 3)),
                                (d.p._nvtd[1] = 0),
                                (s = null),
                                $(".ui-pg-selbox", "#" + c).bind("change", function () {
                                    return u("records", this)
                                    ...
                                    $("#first" + $.jgrid.jqID(b) + ", #prev" + $.jgrid.jqID(b) + ", #next" + $.jgrid.jqID(b) + ", #last" + $.jgrid.jqID(b)).click(function () {
                                        ...
                                        return (
                                            ...
                                            u(this.id.split("_")[0], this)
                                                ? (this.id === "first" + b && f && ((d.p.page = 1), (e = !0)),
                                                  this.id === "prev" + b && g && ((d.p.page = a - 1), (e = !0)),
                                                  this.id === "next" + b && h && ((d.p.page = a + 1), (e = !0)),
                                                  this.id === "last" + b && i && ((d.p.page = c), (e = !0)),
                                                  e && R(),
                                                  !1)
                                                : !1
                                        );
                            ...
                            $("span.ui-grid-ico-sort", f).addClass(m),
                                ...
                                e[a].lso
                                    ? "asc" === e[a].lso
                                        ...
                                        : "desc" === e[a].lso
                                        ? ((e[a].lso += "-asc"), (g = "asc"))
                                        : ("asc-desc" !== e[a].lso && "desc-asc" !== e[a].lso) || (e[a].lso = "")
                                    : (e[a].lso = g = e[a].firstsortorder || "asc"),
                        ...
                        V = function (a, b, c, e, f) {
                            if (d.p.colModel[b].sortable && !(d.p.savedRow.length > 0)) {
                                if (
                                    (c ||
                                        (d.p.lastsort === b && "" !== d.p.sortname
                                            ? "asc" === d.p.sortorder
                                                ? (d.p.sortorder = "desc")
                                                : "desc" === d.p.sortorder && (d.p.sortorder = "asc")
                                            : (d.p.sortorder = d.p.colModel[b].firstsortorder || "asc"),
                                        (d.p.page = 1)),
                                    d.p.multiSort)
                                )
                                    U(b, f);
                                    ...
                                    (g = $(h).find("span.ui-grid-ico-sort")),
                                        ...
                                        d.p.viewsortcols[0] ||
                                            (d.p.lastsort !== b ? (d.p.frozenColumns && d.grid.fhDiv.find("span.s-ico").hide(), $("span.s-ico", h).hide(), $("span.s-ico", i).show()) : "" === d.p.sortname && $("span.s-ico", i).show()),
                                ...
                                d.p.subGrid &&
                                    "local" === d.p.datatype &&
                                    $("td.sgexpanded", "#" + $.jgrid.jqID(d.p.id)).each(function () {
                                        $(this).trigger("click");
                                    }),
                                    (d.p._sort = !0),
                                    R(),
                        ...
                        W = function () {
                            ...
                            $.each(d.p.colModel, function () {
                                ...
                                d.p.shrinkToFit === !0 &&
                                    ...
                                    d.p.tblwidth > d.p.width && ((d.p.colModel[a].width -= d.p.tblwidth - parseInt(d.p.width, 10)), (d.p.tblwidth = d.p.width)));
                        },
                        X = function (a) {
                            var b,
                                c = a,
                        ...
                        Y = function (a) {
                            ...
                            return (
                                "rtl" === d.p.direction && (c[0] = d.p.width - c[0]),
                    ...
                    for (this.p.id = this.id, -1 === $.inArray(d.p.multikey, x) && (d.p.multikey = !1), d.p.keyName = !1, i = 0; i < d.p.colModel.length; i++)
                        (w =
                            "string" == typeof d.p.colModel[i].template
                                ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template]
                                    ? $.jgrid.cmTemplate[d.p.colModel[i].template]
                                    : {}
                                : d.p.colModel[i].template),
                    ...
                    if (
                        ...
                        d.p.grouping === !0 && ((d.p.scroll = !1), (d.p.rownumbers = !1), (d.p.treeGrid = !1), (d.p.gridview = !0)),
                        this.p.treeGrid === !0)
                    ) {
                        try {
                    ...
                    this.p.multiselect &&
                        ...
                        this.p.rownumbers && (this.p.colNames.unshift(""), this.p.colModel.unshift({ name: "rn", width: d.p.rownumWidth, sortable: !1, resizable: !1, hidedlg: !0, search: !1, align: "center", fixed: !0, frozen: !0 })),
                        (d.p.xmlReader = $.extend(
                            !0,
                            {
                                root: "rows",
                                row: "row",
                        ...
                        (d.p.jsonReader = $.extend(
                            !0,
                            { root: "rows", page: "page", total: "total", records: "records", repeatitems: !0, cell: "cell", id: "id", userdata: "userdata", subgrid: { root: "rows", repeatitems: !0, cell: "cell" } },
                            d.p.jsonReader
                        )),
                        (d.p.localReader = $.extend(
                            !0,
                            { root: "rows", page: "page", total: "total", records: "records", repeatitems: !1, cell: "cell", id: "id", userdata: "userdata", subgrid: { root: "rows", repeatitems: !0, cell: "cell" } },
                            d.p.localReader
                        )),
                    ...
                    var ba,
                        ...
                        ha,
                        ia,
                        ja = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                        ka = "",
                        la = "",
                        ma = "";
                    ...
                    if (
                        ("horizontal" === d.p.viewsortcols[1]
                            ? ((la = " ui-i-asc"), (ma = " ui-i-desc"))
                            : "single" === d.p.viewsortcols[1] && ((la = " ui-single-sort-asc"), (ma = " ui-single-sort-desc"), (ka = " style='display:none'"), (d.p.viewsortcols[0] = !1)),
                        (ba = r ? "class='ui-th-div-ie'" : ""),
                        (ia = "<span class='s-ico' style='display:none'>"),
                        (ia += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + la + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + ka + "></span>"),
                        (ia += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + ma + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + ka + "></span></span>"),
                    ...
                    for (i = 0; i < this.p.colNames.length; i++) {
                        ...
                        (ja += "<th id='" + d.p.id + "_" + d.p.colModel[i].name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + na + ">"),
                            (ca = d.p.colModel[i].index || d.p.colModel[i].name),
                            (ja += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[i].name + "' " + ba + ">" + d.p.colNames[i]),
                            d.p.colModel[i].width ? (d.p.colModel[i].width = parseInt(d.p.colModel[i].width, 10)) : (d.p.colModel[i].width = 150),
                            "boolean" != typeof d.p.colModel[i].title && (d.p.colModel[i].title = !0),
                            (d.p.colModel[i].lso = ""),
                            ca === d.p.sortname && (d.p.lastsort = i),
                            d.p.multiSort && ((u = $.inArray(ca, s)), -1 !== u && (d.p.colModel[i].lso = t[u])),
                            (ja += ia + "</div></th>");
                    }
                    if (
                        ((ja += "</tr></thead>"),
                                ...
                                ? ($(d.rows).each(function (b) {
                                      b > 0 &&
                                          ($(this).hasClass("ui-subgrid") ||
                                              ...
                                              ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", !0),
                                              $(this).addClass(n).attr("aria-selected", "true"),
                                              d.p.selarrrow.push(this.id),
                                              (d.p.selrow = this.id),
                                              a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", !0), $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).addClass(n))));
                                  }),
                                  (oa = !0),
                                  (pa = []))
                                : ($(d.rows).each(function (b) {
                                      b > 0 &&
                                          ($(this).hasClass("ui-subgrid") ||
                                              ...
                                              $(this).hasClass(m) ||
                                              $(this).hasClass("jqfoot") ||
                                              ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id))[d.p.useProp ? "prop" : "attr"]("checked", !1),
                                              $(this).removeClass(n).attr("aria-selected", "false"),
                                              pa.push(this.id),
                                              a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", !1), $("#" + $.jgrid.jqID(this.id), d.grid.fbDiv).removeClass(n))));
                                  }),
                                  (d.p.selrow = null),
                                  (oa = !1)),
                                $(d).triggerHandler("jqGridSelectAll", [oa ? d.p.selarrrow : pa, oa]),
                                $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, oa ? d.p.selarrrow : pa, oa);
                        });
                    }
                    if (d.p.autowidth === !0) {
                        var qa = $(v).innerWidth();
                    ...
                    W(),
                        $(v)
                            ...
                            .append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"),
                        d.p.scrollPopUp && $(v).append("<div " + k(l, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + d.p.id + "'></div>"),
                        $(j).css("width", e.width + "px"),
                        (ja = $("thead:first", d).get(0));
                    var ra = "";
                    d.p.footerrow &&
                        (ra +=
                            "<table role='presentation' style='width:" + d.p.tblwidth + "px' " + k(l, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + k(l, "footerBox", !1, "footrow footrow-" + h) + ">");
                    var sa = $("tr:first", ja),
                        ...
                        $("th", sa)
                            .each(function (a) {
                                ...
                                d.p.colModel[a].hidden && ($(this).css("display", "none"), (b = "display:none;")),
                                    (ta += "<td role='gridcell' style='height:0px;width:" + da + "px;" + b + "'></td>"),
                                    (e.headers[a] = { width: da, el: this }),
                                    (ka = d.p.colModel[a].sortable),
                                    "boolean" != typeof ka && ((d.p.colModel[a].sortable = !0), (ka = !0));
                                        ...
                                        (d.p.multiSort
                                            ? d.p.viewsortcols[0]
                                                ? ($("div span.s-ico", this).show(),
                                                  d.p.colModel[a].lso &&
                                                      $("div span.ui-icon-" + d.p.colModel[a].lso, this)
                                                          .removeClass(m)
                                                          .css("display", ""))
                                                : d.p.colModel[a].lso &&
                                                  ($("div span.s-ico", this).show(),
                                            ...
                                            ? ($("div span.s-ico", this).show(),
                                              a === d.p.lastsort &&
                                                  $("div span.ui-icon-" + d.p.sortorder, this)
                                                      .removeClass(m)
                                                      .css("display", ""))
                                            : a === d.p.lastsort &&
                                              "" !== d.p.sortname &&
                                              ...
                                              $("div span.ui-icon-" + d.p.sortorder, this)
                                                  .removeClass(m)
                                                  .css("display", ""))),
                                    d.p.footerrow && (ra += "<td role='gridcell' " + z(a, 0, "", null, "", !1) + ">&#160;</td>");
                            })
                    ...
                    d.p.footerrow && (ra += "</tr></tbody></table>"),
                        (ta += "</tr>"),
                        (ha = document.createElement("tbody")),
                        this.appendChild(ha),
                        $(this).addClass(k(l, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(ta),
                        (ta = null);
                    ...
                    (ja = null),
                        ...
                        wa && $(e.hDiv).hide(),
                        d.p.pager &&
                            ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : (d.p.pager = "#" + $(d.p.pager).attr("id")),
                            $(d.p.pager)
                                .css({ width: e.width + "px" })
                                .addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager"))
                                .appendTo(v),
                            wa && $(d.p.pager).hide(),
                            T(d.p.pager, "")),
                        d.p.cellEdit === !1 &&
                    ...
                    $(d)
                        ...
                        .click(function (a) {
                            if (
                                ((fa = a.target),
                                (ga = $(fa, d.rows).closest("tr.jqgrow")),
                                0 === $(ga).length || ga[0].className.indexOf(m) > -1 || ($(fa, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)
                            )
                                return this;
                            ...
                            if ("A" !== fa.tagName && (("INPUT" !== fa.tagName && "TEXTAREA" !== fa.tagName && "OPTION" !== fa.tagName && "SELECT" !== fa.tagName) || b))
                                if (
                                    ((ya = ga[0].id),
                                    (fa = $(fa).closest("tr.jqgrow>td")),
                                    fa.length > 0 &&
                                        ((za = $.jgrid.getCellIndex(fa)),
                                        (Aa = $(fa).closest("td,th").html()),
                                        $(d).triggerHandler("jqGridCellSelect", [ya, za, Aa, a]),
                                        $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ya, za, Aa, a)),
                                    d.p.cellEdit !== !0)
                                ) {
                                    if (c)
                                        if (d.p.multikey)
                                            a[d.p.multikey]
                                                ...
                                                : d.p.multiselect && b && ((b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya).is(":checked")), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                                            ...
                                            if (b) $(d).jqGrid("setSelection", ya, !0, a);
                                                ...
                                                $(d.p.selarrrow).each(function (a, b) {
                                                    ...
                                                    c && $(c).removeClass(n),
                                                        ...
                                                        f &&
                                                            ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass(n),
                                                            $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f))[d.p.useProp ? "prop" : "attr"]("checked", !1));
                                                }),
                                                    (d.p.selarrrow = []),
                                                    $(d).jqGrid("setSelection", ya, !0, a);
                                            }
                        ...
                        .bind("reloadGrid", function (a, b) {
                            if (
                                ...
                                "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"), d.p.data.length && (I(), J())) : d.p.treeGrid || ((d.p.selrow = null), d.p.multiselect && ((d.p.selarrrow = []), S(!1)), (d.p.savedRow = [])),
                        ...
                        $(e.bDiv)
                            ...
                            .css({ height: d.p.height + (isNaN(d.p.height) ? "" : "px"), width: e.width + "px" })
                            .scroll(e.scrollGrid),
                        $("table:first", e.bDiv).css({ width: d.p.tblwidth + "px" }),
                        $.support.tbody || (2 === $("tbody", this).length && $("tbody:gt(0)", this).remove()),
                        d.p.multikey &&
                            ($.jgrid.msie
                                ? $(e.bDiv).bind("selectstart", function () {
                                      return !1;
                                  })
                    ...
                    var Da =
                        d.p.hidegrid === !0
                            ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />")
                                  .hover(
                                      function () {
                                          Da.addClass(o);
                                      },
                                  ...
                                  .append("<span class='ui-jqgrid-headlink " + Ba + "'></span>")
                                  .css("rtl" === h ? "left" : "right", "0px")
                            : "";
                    if (
                        ($(e.cDiv)
                            .append(Da)
                            .append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>")
                            .addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)),
                        ...
                        (e.uDiv = document.createElement("div")),
                            ...
                            "both" === d.p.toolbar[1]
                                ? ((e.ubDiv = document.createElement("div")),
                                  $(e.uDiv)
                                      .addClass(Ea + " ui-userdata-top")
                                      .attr("id", "t_" + this.id)
                                      .insertBefore(e.hDiv)
                                      .width(e.width),
                                  $(e.ubDiv)
                                      .addClass(Ea + " ui-userdata-bottom")
                                      .attr("id", "tb_" + this.id)
                                      .insertAfter(e.hDiv)
                                      .width(e.width),
                                  wa && $(e.ubDiv).hide())
                    ...
                    if (
                        (d.p.toppager &&
                            ((d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager"),
                            ...
                            T(d.p.toppager, "_t")),
                        d.p.footerrow &&
                            ((e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0]),
                            (xa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>")),
                            $(e.sDiv).append(xa).width(e.width).insertAfter(e.hDiv),
                            $(xa).append(ra),
                        ...
                        var Fa = d.p.datatype;
                        d.p.hidegrid === !0 &&
                            ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function (a) {
                                var b,
                                    c = $.isFunction(d.p.onHeaderClick),
                                    f = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv",
                                    g = this;
                                return (
                                    d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")), (f += ", #" + $(e.uDiv).attr("id"))),
                                    (b = $(f, "#gview_" + $.jgrid.jqID(d.p.id)).length),
                                    "visible" === d.p.gridstate
                                        ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function () {
                                              b--,
                                                  0 === b &&
                                                      ($("span", g).removeClass(Ba).addClass(Ca),
                                                      ...
                                                      c && (wa || d.p.onHeaderClick.call(d, d.p.gridstate, a)));
                                          })
                                        : "hidden" === d.p.gridstate &&
                                          $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function () {
                                              b--,
                                                  0 === b &&
                                                      ($("span", g).removeClass(Ca).addClass(Ba),
                                                      wa && ((d.p.datatype = Fa), R(), (wa = !1)),
                    ...
                    if (
                        ...
                        $.extend(e, { populate: R, emptyRows: H, beginReq: P, endReq: Q }),
                        (this.grid = e),
        ...
        $.jgrid.extend({
                ...
                return this.each(function () {
                    ...
                    void 0 !== a &&
                        ...
                        !f ||
                            ...
                            (l.p.scrollrows === !0 && ((g = $(l).jqGrid("getGridRowById", a).rowIndex), g >= 0 && d(g)),
                            ...
                            l.p.multiselect
                                ? (l.setHeadCheckBox(!1),
                                  ...
                                  -1 === h
                                      ? ("ui-subgrid" !== f.className && $(f).addClass(n).attr("aria-selected", "true"), (e = !0), l.p.selarrrow.push(l.p.selrow))
                                      : ("ui-subgrid" !== f.className && $(f).removeClass(n).attr("aria-selected", "false"), (e = !1), l.p.selarrrow.splice(h, 1), (i = l.p.selarrrow[0]), (l.p.selrow = void 0 === i ? null : i)),
                                  $("#jqg_" + $.jgrid.jqID(l.p.id) + "_" + $.jgrid.jqID(f.id))[l.p.useProp ? "prop" : "attr"]("checked", e),
                                  j &&
                                      (-1 === h ? $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass(n) : $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).removeClass(n),
                                      $("#jqg_" + $.jgrid.jqID(l.p.id) + "_" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j))[l.p.useProp ? "prop" : "attr"]("checked", e)),
                                  b && ($(l).triggerHandler("jqGridSelectRow", [f.id, e, c]), l.p.onSelectRow && l.p.onSelectRow.call(l, f.id, e, c)))
                                : "ui-subgrid" !== f.className &&
                                  (l.p.selrow !== f.id
                                      ? ((k = $(l).jqGrid("getGridRowById", l.p.selrow)),
                                        k && $(k).removeClass(n).attr({ "aria-selected": "false", tabindex: "-1" }),
                                        $(f).addClass(n).attr({ "aria-selected": "true", tabindex: "0" }),
                                        j && ($("#" + $.jgrid.jqID(l.p.selrow), "#" + $.jgrid.jqID(j)).removeClass(n), $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(j)).addClass(n)),
                                        (e = !0))
                                      : (e = !1),
                                  (l.p.selrow = f.id),
                                  b && ($(l).triggerHandler("jqGridSelectRow", [f.id, e, c]), l.p.onSelectRow && l.p.onSelectRow.call(l, f.id, e, c)))));
                ...
                return this.each(function () {
                    ...
                    if ((d.p.frozenColumns === !0 && (c = d.p.id + "_frozen"), void 0 !== a)) {
                        if (
                            ...
                            $("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(b))
                                .removeClass(f)
                        ...
                        d.p.multiselect
                            ? ($(d.p.selarrrow).each(function (a, b) {
                              ...
                              (d.p.selrow = null))
                            : d.p.selrow &&
                              ($("#" + $.jgrid.jqID(d.p.id) + " tbody:first tr#" + $.jgrid.jqID(d.p.selrow))
                                  .removeClass(f)
                                  .attr("aria-selected", "false"),
            ...
            delRowData: function (a) {
                ...
                return (
                    this.each(function () {
                        ...
                        if (
                            (f.p.subGrid && ((d = $(b).next()), d.hasClass("ui-subgrid") && d.remove()),
                            $(b).remove(),
                            f.p.records--,
                            f.p.reccount--,
                            f.updatepager(!0, !1),
                            (e = !0),
                            f.p.multiselect && ((c = $.inArray(a, f.p.selarrrow)), -1 !== c && f.p.selarrrow.splice(c, 1)),
                            ...
                            try {
                                if (
                                    ($(this.p.colModel).each(function (c) {
                                        ...
                                        void 0 !== f &&
                                            ((k[d] = this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? $.unformat.date.call(i, f, this) : f),
                                            (g = i.formatter(a, k[d], c, b, "edit")),
                                            (e = this.title ? { title: $.jgrid.stripHtml(g) } : {}),
                                            i.p.treeGrid === !0 && d === i.p.ExpandColumn
                        ...
                        this.each(function () {
                            ...
                            for (i && (t = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")), g && (u = $(w).jqGrid("getStyleUI", w.p.styleUI + ".base", "multiBox", !1, "cbox")); x > z; ) {
                                ...
                                for (
                                    r = a,
                                        a = w.p.idPrefix + a,
                                        i && ((v = w.formatCol(0, 1, "", null, a, !0)), (f[f.length] = '<td role="gridcell" ' + t + " " + v + ">0</td>")),
                                        g &&
                                            ((l = '<input role="checkbox" type="checkbox" id="jqg_' + w.p.id + "_" + a + '" ' + u + "/>"),
                                            (v = w.formatCol(i, 1, "", null, a, !0)),
                                            (f[f.length] = '<td role="gridcell" ' + v + ">" + l + "</td>")),
                                        h && (f[f.length] = $(w).jqGrid("addSubGridCell", g + i, 1)),
                                        k = g + h + i;
                                    k < w.p.colModel.length;
                                    k++
                                )
                                    (q = w.p.colModel[k]),
                                        (e = q.name),
                            ...
                            w.p.altRows !== !0 ||
                                m ||
                                ("last" === c
                                    ? (w.rows.length - 1) % 2 === 0 && $(w.rows[w.rows.length - 1]).addClass(o)
                                          ...
                                          "set" === a
                                              ? void 0 !== b[e] &&
                                                ...
                                                $("tr.footrow td:eq(" + d + ")", j.grid.sDiv)
                                                    ...
                                                    .attr(f),
                                                (g = !0))
                                              : "get" === a && (h[e] = $("tr.footrow td:eq(" + d + ")", j.grid.sDiv).html());
                                  }))
                            : !1;
                    }),
                    "get" === a ? h : g
                    ...
                    if (this.grid) {
                        ...
                        if (("boolean" != typeof b && (b = g.p.shrinkToFit), !isNaN(a))) {
                            if (
                                ...
                                g.p.toolbar[0] === !0 && ($(g.grid.uDiv).css("width", a + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a + "px")),
                            ...
                            g.p.tblwidth &&
                                ($("table:first", g.grid.bDiv).css("width", g.p.tblwidth + "px"),
                        ...
                        if (k) {
                            ...
                            if ("" !== c || f === !0) {
                                ...
                                if (
                                    ...
                                    (h = i.p.colModel[j].title ? { title: $.jgrid.stripHtml(g) } : {}),
                        ...
                        $(a).keydown(function (c) {
                            ...
                            if (g)
                                if (((f = a.p._index[$.jgrid.stripPref(a.p.idPrefix, g.id)]), 37 === c.keyCode || 38 === c.keyCode || 39 === c.keyCode || 40 === c.keyCode)) {
                                    ...
                                    37 === c.keyCode &&
                                        (a.p.treeGrid && a.p.data[f][h] && $(g).find("div.treeclick").trigger("click"), $(a).triggerHandler("jqGridKeyLeft", [a.p.selrow]), $.isFunction(b.onLeftKey) && b.onLeftKey.call(a, a.p.selrow)),
                                        39 === c.keyCode &&
                                            (a.p.treeGrid && !a.p.data[f][h] && $(g).find("div.treeclick").trigger("click"),
                                            $(a).triggerHandler("jqGridKeyRight", [a.p.selrow]),
                                            $.isFunction(b.onRightKey) && b.onRightKey.call(a, a.p.selrow));
                                } else
                                    13 === c.keyCode
                                        ? ($(a).triggerHandler("jqGridKeyEnter", [a.p.selrow]), $.isFunction(b.onEnter) && b.onEnter.call(a, a.p.selrow))
                                        : 32 === c.keyCode && ($(a).triggerHandler("jqGridKeySpace", [a.p.selrow]), $.isFunction(b.onSpace) && b.onSpace.call(a, a.p.selrow));
                        });
                });
            },
            unbindKeys: function () {
            ...
            progressBar: function (a) {
                return (
                    (a = $.extend({ htmlcontent: "", method: "hide", loadtype: "disable" }, a || {})),
                    this.each(function () {
                        var b,
                            c,
                            d = "show" === a.method,
            ...
            setGridState: function (a) {
                return this.each(function () {
                    if (this.grid) {
                        ...
                        "hidden" === a
                            ? ($(".ui-jqgrid-bdiv, .ui-jqgrid-hdiv", "#gview_" + $.jgrid.jqID(b.p.id)).slideUp("fast"),
                              b.p.pager && $(b.p.pager).slideUp("fast"),
                              b.p.toppager && $(b.p.toppager).slideUp("fast"),
                              b.p.toolbar[0] === !0 && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideUp("fast"), $(b.grid.uDiv).slideUp("fast")),
                            ...
                            : "visible" === a &&
                              ($(".ui-jqgrid-hdiv, .ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(b.p.id)).slideDown("fast"),
                              b.p.pager && $(b.p.pager).slideDown("fast"),
                              b.p.toppager && $(b.p.toppager).slideDown("fast"),
                              b.p.toolbar[0] === !0 && ("both" === b.p.toolbar[1] && $(b.grid.ubDiv).slideDown("fast"), $(b.grid.uDiv).slideDown("fast")),
                ...
                return this.each(function () {
                    if (this.grid && this.p.frozenColumns === !0) {
                        ...
                        if (
                            ...
                            (a.grid.fhDiv = null),
                            (a.grid.fbDiv = null),
                            a.p.footerrow && ($(a.grid.fsDiv).remove(), (a.grid.fsDiv = null)),
                ...
                return this.each(function () {
                    ...
                    if (h.grid && h.p.cellEdit === !0) {
                        ...
                        if (((g = h.p.colModel[b]), (d = g.name), "subgrid" !== d && "cb" !== d && "rn" !== d)) {
                            if (((f = $("td:eq(" + b + ")", h.rows[a])), g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || ($.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b))))
                                parseInt(h.p.iCol, 10) >= 0 &&
                                    parseInt(h.p.iRow, 10) >= 0 &&
                                    $(h.rows[h.p.iRow])
                                        .removeClass("selected-row " + j)
                                        .find("td:eq(" + h.p.iCol + ")")
                                        .removeClass("edit-cell " + i),
                                ...
                                if (
                                    (h.p.autoencode && (e = $.jgrid.htmlDecode(e)),
                                    g.edittype || (g.edittype = "text"),
                                    h.p.savedRow.push({ id: a, ic: b, name: d, v: e }),
                                ...
                                var n = $.extend({}, g.editoptions || {}, { id: a + "_" + d, name: d, rowId: h.rows[a].id, oper: "edit" }),
                                ...
                                $.inArray(g.edittype, ["text", "textarea", "password", "select"]) > -1 && $(o).addClass(k),
                                    ...
                                    $("input, select, textarea", f).bind("keydown", function (c) {
                                        if (
                                            (27 === c.keyCode &&
                                                ($("input.hasDatepicker", f).length > 0
                                                    ? $(".ui-datepicker").is(":hidden")
                                                        ? $(h).jqGrid("restoreCell", a, b)
                                                        : $("input.hasDatepicker", f).datepicker("hide")
                                                    : $(h).jqGrid("restoreCell", a, b)),
                                            13 === c.keyCode && !c.shiftKey)
                                        )
                                            return $(h).jqGrid("saveCell", a, b), !1;
                                        if (9 === c.keyCode) {
                        ...
                        if (((c = d.p.savedRow.length >= 1 ? 0 : null), null !== c)) {
                            ...
                            switch (j.edittype) {
                                case "select":
                                    if (j.editoptions.multiple) {
                                        ...
                                        (g = $(n).val()),
                                            g ? g.join(",") : (g = ""),
                                            $("option:selected", n).each(function (a, b) {
                                                o[a] = $(b).text();
                                            }),
                                            (h = o.join(","));
                                ...
                                case "custom":
                                    try {
                                        ...
                                        "e1" === q
                                            ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.nodefined, f.bClose, { styleUI: d.p.styleUI })
                                            : "e2" === q
                                            ? $.jgrid.info_dialog(e.errcap, "function 'custom_value' " + f.msg.novalue, f.bClose, { styleUI: d.p.styleUI })
                                            : $.jgrid.info_dialog(e.errcap, q.message, f.bClose, { styleUI: d.p.styleUI });
                                    }
                            }
                            if (h !== d.p.savedRow[c].v) {
                                ...
                                if (t[0] === !0) {
                                    ...
                                    if (
                                        ($.isFunction(d.p.beforeSubmitCell) && ((v = d.p.beforeSubmitCell.call(d, d.rows[a].id, k, g, a, b)), v || (v = {})),
                                        ...
                                        if (d.p.cellurl) {
                                            ...
                                            (z = d.p.prmNames),
                                                (x = z.id),
                                                (y = z.oper),
                                                (w[x] = $.jgrid.stripPref(d.p.idPrefix, d.rows[a].id)),
                                                (w[y] = z.editoper),
                                                (w = $.extend(v, w)),
                                                $(d).jqGrid("progressBar", { method: "show", loadtype: d.p.loadui, htmlcontent: $.jgrid.getRegional(d, "defaults.savetext") }),
                                                    ...
                                                    $.extend(
                                                        {
                                                            ...
                                                            complete: function (c, j) {
                                                                if (($(d).jqGrid("progressBar", { method: "hide", loadtype: d.p.loadui }), (d.grid.hDiv.loading = !1), "success" === j)) {
                                                                    ...
                                                                    l[0] === !0 && $.isFunction(d.p.afterSubmitCell) && (l = d.p.afterSubmitCell.call(d, c, w.id, k, g, a, b)),
                                                                        l[0] === !0
                                                                            ? (u && (g = ""),
                                                                              $(i).empty(),
                                                                            ...
                                                                            : ($.jgrid.info_dialog(e.errcap, l[1], f.bClose, { styleUI: d.p.styleUI }), d.p.restoreCellonFail && $(d).jqGrid("restoreCell", a, b));
                                                                }
                                                            },
                                                            error: function (c, g, h) {
                                                                $("#lui_" + $.jgrid.jqID(d.p.id)).hide(),
                                                                    ...
                                                                    $.isFunction(d.p.errorCell)
                                                                        ? d.p.errorCell.call(d, c, g, h)
                                                                        : $.jgrid.info_dialog(e.errcap, c.status + " : " + c.statusText + "<br/>" + g, f.bClose, { styleUI: d.p.styleUI }),
                                    ...
                                    try {
                                        window.setTimeout(function () {
                                            $.jgrid.info_dialog(e.errcap, g + " " + t[1], f.bClose, { styleUI: d.p.styleUI, top: m.top + 40, left: m.left });
                                        }, 100),
                ...
                return this.each(function () {
                    function a(a, b, d) {
                        ...
                        if ("h" === d) {
                            ...
                            k >= i + parseInt(j, 10)
                                ? ($(c.grid.bDiv)[0].scrollLeft = $(c.grid.bDiv)[0].scrollLeft + c.rows[a].cells[b].clientWidth)
                                : j > l && ($(c.grid.bDiv)[0].scrollLeft = $(c.grid.bDiv)[0].scrollLeft - c.rows[a].cells[b].clientWidth);
                        }
                    }
                    function b(a, b) {
                        var d, e;
        ...
        $.extend($.jgrid, {
            ...
            hideModal: function (a, b) {
                ...
                if (b.formprop && c && b.form) {
                    ...
                    "edit" === b.form ? ((g = "#" + $.jgrid.jqID("FrmGrid_" + b.gb.substr(6))), (h = "formProp")) : "view" === b.form && ((g = "#" + $.jgrid.jqID("ViewGrid_" + b.gb.substr(6))), (h = "viewProp")),
                        $(c).data(h, { top: parseFloat($(a).css("top")), left: parseFloat($(a).css("left")), width: f, height: e, dataheight: $(g).height(), datawidth: $(g).width() });
                }
            ...
            createModal: function (a, b, c, d, e, f, g) {
                ...
                var n = $("<a class='ui-jqdialog-titlebar-close " + k.cornerall + "'></a>")
                    .hover(
                        function () {
                            n.addClass(k.hover);
                        },
                ...
                $(m).append(n),
                    i
                        ? ((l.dir = "rtl"), $(".ui-jqdialog-title", m).css("float", "right"), $(".ui-jqdialog-titlebar-close", m).css("left", "0.3em"))
                        : ((l.dir = "ltr"), $(".ui-jqdialog-title", m).css("float", "left"), $(".ui-jqdialog-titlebar-close", m).css("right", "0.3em"));
                var o = document.createElement("div");
                $(o)
                    .addClass("ui-jqdialog-content " + j.content)
                    .attr("id", a.modalcontent),
                    $(o).append(b),
                    l.appendChild(o),
                    $(l).prepend(m),
                ...
                if (
                    ($("a.ui-jqdialog-titlebar-close", m).click(function () {
                ...
                var s = 0;
                if (
                    (i && p.left && !f && ((s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8), (p.left = parseInt(p.left, 10) + parseInt(s, 10))),
                    p.left && (p.left += "px"),
                    $(l)
                        .css($.extend({ width: isNaN(c.width) ? "auto" : c.width + "px", height: isNaN(c.height) ? "auto" : c.height + "px", zIndex: c.zIndex, overflow: "hidden" }, p))
                        .attr({ tabIndex: "-1", role: "dialog", "aria-labelledby": a.modalhead, "aria-hidden": "true" }),
                    void 0 === c.drag && (c.drag = !0),
                    void 0 === c.resize && (c.resize = !0),
                    c.drag)
                )
                    if (($(m).css("cursor", "move"), $.fn.tinyDraggable)) $(l).tinyDraggable({ handle: "#" + $.jgrid.jqID(m.id) });
                    else
                        try {
            ...
            viewModal: function (a, b) {
                if (
                    ((b = $.extend({ toTop: !0, overlay: 10, modal: !1, overlayClass: "ui-widget-overlay", onShow: $.jgrid.showModal, onHide: $.jgrid.closeModal, gbox: "", jqm: !0, jqM: !0 }, b || {})),
                ...
                else if (("" !== b.gbox && ($(".jqgrid-overlay:first", b.gbox).show(), $(a).data("gbox", b.gbox)), $(a).show().attr("aria-hidden", "false"), b.focusField >= 0))
                    try {
                ...
                (n += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:" + l + ";" + m + "'>" + b + "</div>"),
                    (n += c
                        ? "<div class='" +
                          ...
                          "</div>"
                        : "" !== k
                        ? "<div class='" + h.header + "' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + k + "</div>"
                        : ""),
                    (n += "</div>");
                try {
                    "false" === $("#info_dialog").attr("aria-hidden") && $.jgrid.hideModal("#info_dialog", { jqm: f }), $("#info_dialog").remove();
                } catch (o) {}
                $.jgrid.createModal({ themodal: "info_dialog", modalhead: "info_head", modalcontent: "info_content", scrollelm: "infocnt" }, n, e, "", "", !0),
                    k &&
                        $.each(e.buttons, function (a) {
                ...
                switch (a) {
                    case "textarea":
                        (g = document.createElement("textarea")),
                            d ? b.cols || $(g).css({ width: "98%" }) : b.cols || (b.cols = 20),
                            b.rows || (b.rows = 2),
                            ("&nbsp;" === c || "&#160;" === c || (1 === c.length && 160 === c.charCodeAt(0))) && (c = ""),
                            (g.value = c),
                            f(g, b),
                            $(g).attr({ role: "textbox", multiline: "true" });
                        break;
                    case "checkbox":
                    ...
                    case "select":
                        ...
                        if ((b.multiple === !0 ? ((k = !0), (g.multiple = "multiple"), $(g).attr("aria-multiselectable", "true")) : (k = !1), null != b.dataUrl)) {
                                                    ...
                                                    l &&
                                                        ...
                                                        setTimeout(function () {
                                                            if (
                                                                ...
                                                                if ("edit" === g.oper) $(h).jqGrid("setColProp", g.name, { editoptions: { buildSelect: null, dataUrl: null, value: k } });
                                                                else if ("search" === g.oper) $(h).jqGrid("setColProp", g.name, { searchoptions: { dataUrl: null, value: k } });
                            ...
                            if ("string" == typeof b.value)
                                for (q = b.value.split(x), p = 0; p < q.length; p++)
                                    (r = q[p].split(w)),
                                        r.length > 2 &&
                                            (r[1] = $.map(r, function (a, b) {
                                                return b > 0 ? a : void 0;
                                            }).join(w)),
                                ...
                                for (t = b.value, p = 0; p < t.length; p++)
                                    2 === t[p].length &&
                                        ((u = t[p][0]),
                                        (v = t[p][1]),
                                        (s = document.createElement("option")),
                    ...
                    case "custom":
                        ...
                        try {
                            ...
                            "e1" === o
                                ? $.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.nodefined, A.bClose, { styleUI: h.p.styleUI })
                                : "e2" === o
                                ? $.jgrid.info_dialog(z.errcap, "function 'custom_element' " + A.msg.novalue, A.bClose, { styleUI: h.p.styleUI })
                                : $.jgrid.info_dialog(z.errcap, "string" == typeof o ? o : o.message, A.bClose, { styleUI: h.p.styleUI });
                        }
                        break;
                    default:
                        var B;
                        (B = "button" === a ? "button" : "textbox"),
                            ...
                            (g.value = c),
                            f(g, b),
                            "button" !== a && (d ? b.size || $(g).css({ width: "96%" }) : b.size || (b.size = 20)),
                            $(g).attr("role", B);
                }
                return g;
            },
            checkDate: function (a, b) {
                ...
                return -1 === h
                    ...
                    : ((l = e[a[h]].toString()),
                      2 === f && 1 === l.length && (f = 1),
                      l.length !== f || (0 === e[a[h]] && "00" !== b[h])
                          ? !1
                          : -1 === j
                          ? !1
                          : ((l = e[a[j]].toString()),
                            l.length < 1 || e[a[j]] < 1 || e[a[j]] > 12 ? !1 : -1 === i ? !1 : ((l = e[a[i]].toString()), !(l.length < 1 || e[a[i]] < 1 || e[a[i]] > 31 || (2 === e[a[j]] && e[a[i]] > d(e[a[h]])) || e[a[i]] > m[e[a[j]]]))));
            },
            isEmpty: function (a) {
                return !(!a.match(/^\s+$/) && "" !== a);
            },
            ...
            checkValues: function (a, b, c, d) {
                ...
                if (e) {
                    ...
                    if (
                        ...
                        !(
                            (n === !1 && $.jgrid.isEmpty(a)) ||
                            (l[b].formatoptions && l[b].formatoptions.newformat
                                ? ((h = l[b].formatoptions.newformat), (j = $.jgrid.getRegional(k, "formatter.date.masks")), j && j.hasOwnProperty(h) && (h = j[h]))
                                : (h = l[b].datefmt || "Y-m-d"),
                            $.jgrid.checkDate(h, a))
                        )
                    )
                    ...
                    if (e.url === !0 && !((n === !1 && $.jgrid.isEmpty(a)) || ((o = /^(((https?)|(ftp)):\/\/([\-\w]+\.)+\w{2,3}(\/[%\-\w]+(\.\w{2,})?)*(([\w\-\.\?\\\/+@&#;`~=%!]*)(\.\w{2,})?)*\/?)/i), o.test(a))))
                        return [!1, g + ": " + m.url, ""];
        ...
        ($.fn.jqFilter = function (a) {
            ...
            return this.each(function () {
                if (!this.filter) {
                    (this.p = d),
                        (null !== this.p.filter && void 0 !== this.p.filter) || (this.p.filter = { groupOp: this.p.groupOps[0].op, rules: [], groups: [] }),
                    ...
                    if (((this.p.initFilter = $.extend(!0, {}, this.p.filter)), c)) {
                        ...
                        this.p.showQuery &&
                            $(this).append("<table class='queryresult " + h.table_widget + "' style='display:block;max-width:440px;border:0px none;' dir='" + this.p.direction + "'><tbody><tr><td class='query'></td></tr></tbody></table>");
                        var j = function (a, b) {
                            var c = [!0, ""],
                                e = f();
                        ...
                        (this.onchange = function () {
                            ...
                            (this.createTableForGroup = function (a, b) {
                                ...
                                if ((j.append(k), this.p.ruleButtons === !0)) {
                                    ...
                                    for (c = 0; c < d.groupOps.length; c++)
                                        (m = a.groupOp === e.p.groupOps[c].op ? " selected='selected'" : ""), (n += "<option value='" + e.p.groupOps[c].op + "'" + m + ">" + e.p.groupOps[c].text + "</option>");
                                ...
                                if (
                                    (this.p.groupButton &&
                                        ((o = $("<input type='button' value='+ {}' title='Add subgroup' class='add-group " + i.button + "'/>")),
                                    ...
                                    q.bind("click", function () {
                                        ...
                                        var g;
                                        return (
                                            (g = p.searchoptions.sopt ? p.searchoptions.sopt : e.p.sopt ? e.p.sopt : -1 !== $.inArray(p.searchtype, e.p.strarr) ? e.p.stropts : e.p.numopts),
                                            a.rules.push({ field: p.name, op: g[0], data: "" }),
                                            e.reDraw(),
                                            !1
                                        );
                                    }),
                            ...
                            (this.createTableRowForRule = function (a, b) {
                                    ...
                                    s.bind("change", function () {
                                        ...
                                        if (k) {
                                            ...
                                            for (
                                                ...
                                                (r = $.inArray(g[c], t)), -1 !== r && (0 === f && (a.op = m.p.ops[r].oper), (d += "<option value='" + m.p.ops[r].oper + "'>" + m.p.ops[r].text + "</option>"), f++);
                                            ...
                                            $(".data", j).append(b),
                                                ...
                                                $(".input-elm", j).bind("change", function (b) {
                                                    var c = b.target;
                                                    (a.data =
                                                        "SPAN" === c.nodeName.toUpperCase() && k.searchoptions && $.isFunction(k.searchoptions.custom_value)
                                                            ? k.searchoptions.custom_value.call(n, $(c).children(".customelement:first"), "get")
                                                            : c.value),
                                                        m.onchange();
                                                }),
                                                setTimeout(function () {
                                ...
                                for (c = 0; c < m.p.columns.length; c++) {
                                    ...
                                    ((x && v) || (v && !w)) &&
                                        ((l = ""), a.field === m.p.columns[c].name && ((l = " selected='selected'"), (u = c)), (p += "<option value='" + m.p.columns[c].name + "'" + l + ">" + m.p.columns[c].label + "</option>"));
                                }
                                s.append(p);
                                ...
                                for (
                                    y.append(A),
                                        A.bind("change", function () {
                                            ...
                                            var b = $(".input-elm", j)[0];
                                            "nu" === a.op || "nn" === a.op
                                                ? ((a.data = ""), "SELECT" !== b.tagName.toUpperCase() && (b.value = ""), b.setAttribute("readonly", "true"), b.setAttribute("disabled", "true"))
                                                : ("SELECT" === b.tagName.toUpperCase() && (a.data = b.value), b.removeAttribute("readonly"), b.removeAttribute("disabled")),
                                                m.onchange();
                                        }),
                                    ...
                                    (r = $.inArray(g[c], t)), -1 !== r && ((l = a.op === m.p.ops[r].oper ? " selected='selected'" : ""), (p += "<option value='" + m.p.ops[r].oper + "'" + l + ">" + m.p.ops[r].text + "</option>"));
                                A.append(p);
                    ...
                    this.each(function () {
                        ...
                        if (!c.p.filterToolbar) {
                            ...
                            var d,
                                e,
                                f,
                                g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                                ...
                                j = function () {
                                    ...
                                    $.each(c.p.colModel, function () {
                                        ...
                                        if (
                                            ...
                                            (e = a.searchOperators
                                                ? i.parent().prev().children("a").attr("soper") || a.defaultSearch
                                                ...
                                                : a.defaultSearch),
                                            (b =
                                                "custom" === this.stype && $.isFunction(this.searchoptions.custom_value) && i.length > 0 && "SPAN" === i[0].nodeName.toUpperCase()
                                ...
                                k = function (b) {
                                            ...
                                            switch ((this.searchoptions && void 0 !== this.searchoptions.defaultValue && (a = this.searchoptions.defaultValue), (d = this.index || this.name), this.stype)) {
                                                ...
                                                case "custom":
                                                    $.isFunction(this.searchoptions.custom_value) &&
                                                        b.length > 0 &&
                                                        "SPAN" === b[0].nodeName.toUpperCase() &&
                                                        this.searchoptions.custom_value.call(c, b.children(".customelement:first"), "set", a || "");
                                            }
                                        });
                                    var g = f > 0;
                                    ...
                                    !k && $.isFunction(a.beforeClear) && (k = a.beforeClear.call(c)),
                                        k ||
                                            (b &&
                                                $(c)
                                                    .jqGrid("setGridParam", { search: g })
                                                    .trigger("reloadGrid", [{ page: 1 }])),
                                        j && $(c).jqGrid("setGridParam", { url: j }),
                                ...
                                m = function (b, d, e) {
                                    ...
                                    for (
                                        s.sopt || ((s.sopt = []), (s.sopt[0] = "select" === r.stype ? "eq" : a.defaultSearch)),
                                        ...
                                        (i = $.inArray(s.sopt[o], n)),
                                            -1 !== i &&
                                                ((f = m === a.odata[i].oper ? h.highlight : ""),
                                                (l +=
                            ...
                            a.restoreFromFilters && ((f = c.p.postData.filters), f && ("string" == typeof f && (f = $.jgrid.parse(f)), (e = f.rules.length ? f.rules : !1))),
                                $.each(c.p.colModel, function (b) {
                                    ...
                                    if (
                                        (this.hidden === !0 && $(u).css("display", "none"),
                                        (this.search = this.search !== !1),
                                        void 0 === this.stype && (this.stype = "text"),
                                        (f = $.extend({}, this.searchoptions || {}, { name: r.index || r.name, id: "gs_" + c.p.idPrefix + r.name, oper: "search" })),
                                        this.search)
                                    ) {
                                        ...
                                        if (a.searchOperators) {
                                            ...
                                            (l = null != f.searchtitle ? f.searchtitle : a.operandTitle),
                                                (s = "<a title='" + l + "' style='padding-right: 0.5em;' soper='" + h + "' class='soptclass' colname='" + this.name + "'>" + t + "</a>");
                                        }
                                        switch (
                                            ($("td:eq(0)", w).attr("colindex", b).append(s),
                                            void 0 === f.clearSearch && (f.clearSearch = !0),
                                            f.clearSearch
                                                ? ((m = a.resetTitle || "Clear Search Value"),
                                                  $("td:eq(2)", w).append("<a title='" + m + "' style='padding-right: 0.3em;padding-left: 0.3em;' class='clearsearchclass'>" + a.resetIcon + "</a>"))
                                                : $("td:eq(2)", w).hide(),
                    ...
                    this.each(function () {
                        function b(b) {
                            (f = $(c).triggerHandler("jqGridFilterBeforeShow", [b])),
                                ...
                                f &&
                                    ($.jgrid.viewModal("#" + $.jgrid.jqID(h.themodal), { gbox: "#gbox_" + $.jgrid.jqID(e), jqm: a.jqModal, modal: a.modal, overlay: a.overlay, toTop: a.toTop }),
                        ...
                        if (c.grid) {
                            var d,
                                ...
                                f = !0,
                                g = !0,
                                h = { themodal: "searchmod" + e, modalhead: "searchhd" + e, modalcontent: "searchcnt" + e, scrollelm: e },
                                i = c.p.postData[a.sFilter],
                                j = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter,
                                k = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common;
                            if (((a.styleUI = c.p.styleUI), "string" == typeof i && (i = $.jgrid.parse(i)), a.recreateFilter === !0 && $("#" + $.jgrid.jqID(h.themodal)).remove(), void 0 !== $("#" + $.jgrid.jqID(h.themodal))[0]))
                                ...
                                if (
                                    ...
                                    a.columns.length
                                        ? ((q = a.columns), (w = 0), (o = q[0].index || q[0].name))
                                        : $.each(q, function (a, b) {
                                    ...
                                    var x = "eq";
                                    w >= 0 && q[w].searchoptions && q[w].searchoptions.sopt ? (x = q[w].searchoptions.sopt[0]) : a.sopt && a.sopt.length && (x = a.sopt[0]), (i = { groupOp: "AND", rules: [{ field: o, op: x, data: "" }] });
                                }
                                (v = !1),
                                    a.tmplNames &&
                                        a.tmplNames.length &&
                                    ...
                                    v &&
                                        a.tmplFilters &&
                                        a.tmplFilters.length &&
                                        $(".ui-template", l).bind("change", function () {
                                            var b = $(this).val();
                                    ...
                                    (a.gbox = "#gbox_" + e),
                                    a.layer
                                        ? $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0], "#" + $.jgrid.jqID(a.layer), { position: "relative" })
                                        : $.jgrid.createModal(h, l, a, "#gview_" + $.jgrid.jqID(c.p.id), $("#gbox_" + $.jgrid.jqID(c.p.id))[0]),
                                    (a.searchOnEnter || a.closeOnEscape) &&
                                        $("#" + $.jgrid.jqID(h.themodal)).keydown(function (b) {
                                            var c = $(b.target);
                                            return !a.searchOnEnter ||
                                                13 !== b.which ||
                                                c.hasClass("add-group") ||
                                                c.hasClass("add-rule") ||
                                                c.hasClass("delete-group") ||
                                                c.hasClass("delete-rule") ||
                                                (c.hasClass("fm-button") && c.is("[id$=_query]"))
                                                ? a.closeOnEscape && 27 === b.which
                                                    ? ($("#" + $.jgrid.jqID(h.modalhead))
                                    ...
                                    $("#" + e + "_search").bind("click", function () {
                                        var b,
                                            f,
                                            i = {};
                                        if (((d = $("#" + e)), d.find(".input-elm:focus").change(), (f = d.jqFilter("filterData")), a.errorcheck && (d[0].hideError(), a.showQuery || d.jqFilter("toSQLString"), d[0].p.error)))
                                            return d[0].showError(), !1;
                                        if (a.stringResult) {
                                            try {
                                                b = JSON.stringify(f);
                                            } catch (j) {}
                                        ...
                                        return (
                                            ...
                                            g !== !1 && $(c).trigger("reloadGrid", [{ page: 1 }]),
                                            a.closeAfterSearch && $.jgrid.hideModal("#" + $.jgrid.jqID(h.themodal), { gb: "#gbox_" + $.jgrid.jqID(c.p.id), jqm: a.jqModal, onClose: a.onClose }),
                                            !1
                                        );
                                    }),
                                    $("#" + e + "_reset").bind("click", function () {
                                        ...
                                        return (
                                            ...
                                            g !== !1 && $(c).trigger("reloadGrid", [{ page: 1 }]),
                                            a.closeAfterReset && $.jgrid.hideModal("#" + $.jgrid.jqID(h.themodal), { gb: "#gbox_" + $.jgrid.jqID(c.p.id), jqm: a.jqModal, onClose: a.onClose }),
                                            !1
                                        );
                                    }),
                                    b($("#" + e)),
                                    $(".fm-button:not(." + k.disabled + ")", l).hover(
                                        function () {
    ...
    if (
        ($.jgrid.extend({
                ...
                return (
                    ...
                    this.each(function () {
                                        ...
                                        $.each(q.p.colModel, function () {
                                            if (this.name === d && this.editoptions && $.isFunction(this.editoptions.custom_value)) {
                                                try {
                                                    ...
                                                    "e1" === a
                                                        ? $.jgrid.info_dialog(E.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.novalue, rp_ge[$(this)[0]].p.bClose, { styleUI: rp_ge[$(this)[0]].p.styleUI })
                                                        : $.jgrid.info_dialog(E.errcap, a.message, rp_ge[$(this)[0]].p.bClose, { styleUI: rp_ge[$(this)[0]].p.styleUI });
                                                }
                                                return !0;
                                            }
                                        });
                        ...
                        function d(a, b, c, d) {
                            ...
                            for (l = 1; d >= l; l++) r += p;
                            if (
                                ("_empty" !== a && (o = $(b).jqGrid("getInd", a)),
                                $(b.p.colModel).each(function (l) {
                                    if (
                                        ((f = this.name),
                                        (g = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0),
                                        ...
                                        var s = $.extend({}, this.editoptions || {}, { id: f, name: f, rowId: a, oper: "edit" }),
                                            t = $.extend({}, { elmprefix: "", elmsuffix: "", rowabove: !1, rowcontent: "" }, this.formoptions || {}),
                                            u = parseInt(t.rowpos, 10) || m + 1,
                                            v = parseInt(2 * (parseInt(t.colpos, 10) || 1), 10);
                                        if (
                                            ("_empty" === a && s.defaultValue && (i = $.isFunction(s.defaultValue) ? s.defaultValue.call(q) : s.defaultValue),
                                            this.edittype || (this.edittype = "text"),
                                            q.p.autoencode && (i = $.jgrid.htmlDecode(i)),
                                            (k = $.jgrid.createEl.call(q, this.edittype, s, i, !1, $.extend({}, $.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {}))),
                                            "select" === this.edittype && ((i = $(k).val()), "select-multiple" === $(k).get(0).type && i && (i = i.join(","))),
                                            "checkbox" === this.edittype && (i = $(k).is(":checked") ? $(k).val() : $(k).attr("offval")),
                                            (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[f] = i),
                                ...
                                var s;
                                D
                                    ? ((s = "<div class='FormData' style='display:none'><input class='FormElement' id='id_g' type='text' name='" + b.p.id + "_id' value='" + a + "'/>"), $(J).append(s))
                                    : ((s = $(
                                    ...
                                    $(k).each(function () {
                                        (d = this.name),
                                            ...
                                            f &&
                                                ...
                                                null !== f[0] &&
                                                ((h = ""),
                                                "custom" === this.edittype && $.isFunction(g.custom_value)
                                                    ? g.custom_value.call(q, $("#" + d, c), "set", h)
                                                    : g.defaultValue
                                                    ? ((h = $.isFunction(g.defaultValue) ? g.defaultValue.call(q) : g.defaultValue),
                                                      "checkbox" === f[0].type
                                                          ? ((i = h.toLowerCase()),
                                                            i.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== i
                                                                ? ((f[0].checked = !0), (f[0].defaultChecked = !0), (f[0].value = h))
                                                                : ((f[0].checked = !1), (f[0].defaultChecked = !1)))
                                                          : f.val(h))
                                                    : "checkbox" === f[0].type
                                                    ? ((f[0].checked = !1), (f[0].defaultChecked = !1), (h = $(f).attr("offval")))
                                                    : f[0].type && "select" === f[0].type.substr(0, 6)
                                                    ? (f[0].selectedIndex = 0)
                                                    : f.val(h),
                                                (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = h));
                                    }),
                                    void $("#id_g", c).val(a)
                                );
                            var l = $(b).jqGrid("getInd", a, !0);
                            l &&
                                ($('td[role="gridcell"]', l).each(function (f) {
                                    if (((d = k[f].name), "cb" !== d && "subgrid" !== d && "rn" !== d && k[f].editable === !0)) {
                                        ...
                                        switch (
                                            (q.p.autoencode && (e = $.jgrid.htmlDecode(e)), (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (rp_ge[q.p.id]._savedData[d] = e), (d = $.jgrid.jqID(d)), k[f].edittype)
                                        ) {
                                            case "password":
                                            case "text":
                                            case "button":
                                            ...
                                            case "select":
                                                ...
                                                (h = $.map(h, function (a) {
                                                    ...
                                                    $("#" + d + " option", c).each(function () {
                                                        k[f].editoptions.multiple || ($.trim(e) !== $.trim($(this).text()) && h[0] !== $.trim($(this).text()) && h[0] !== $.trim($(this).val()))
                                                            ? k[f].editoptions.multiple && ($.inArray($.trim($(this).text()), h) > -1 || $.inArray($.trim($(this).val()), h) > -1)
                                                                ? (this.selected = !0)
                                                                : (this.selected = !1)
                                                            : (this.selected = !0);
                                                    }),
                                            ...
                                            case "checkbox":
                                                if (((e = String(e)), k[f].editoptions && k[f].editoptions.value)) {
                                                    ...
                                                    i[0] === e ? $("#" + d, c)[q.p.useProp ? "prop" : "attr"]({ checked: !0, defaultChecked: !0 }) : $("#" + d, c)[q.p.useProp ? "prop" : "attr"]({ checked: !1, defaultChecked: !1 });
                                                } else
                                                    (e = e.toLowerCase()),
                                                        e.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== e
                                                            ? ($("#" + d, c)[q.p.useProp ? "prop" : "attr"]("checked", !0), $("#" + d, c)[q.p.useProp ? "prop" : "attr"]("defaultChecked", !0))
                                                            : ($("#" + d, c)[q.p.useProp ? "prop" : "attr"]("checked", !1), $("#" + d, c)[q.p.useProp ? "prop" : "attr"]("defaultChecked", !1));
                                                (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) &&
                                                    ((e = $("#" + d, c).is(":checked") ? $("#" + d, c).val() : $("#" + d, c).attr("offval")), (rp_ge[q.p.id]._savedData[d] = e));
                                                break;
                                            case "custom":
                                                try {
                                                    ...
                                                    "e1" === l
                                                        ? $.jgrid.info_dialog(E.errcap, "function 'custom_value' " + rp_ge[$(this)[0]].p.msg.nodefined, $.rp_ge[$(this)[0]].p.bClose, { styleUI: rp_ge[$(this)[0]].p.styleUI })
                                                        : $.jgrid.info_dialog(E.errcap, l.message, $.rp_ge[$(this)[0]].p.bClose, { styleUI: rp_ge[$(this)[0]].p.styleUI });
                                                }
                                        }
                                        j++;
                                    }
                        ...
                        function i() {
                            ...
                            if (
                                (h(),
                                l[0] &&
                                    ((m = $(q).triggerHandler("jqGridAddEditClickSubmit", [rp_ge[q.p.id], s, u])),
                                ...
                                var t = $.extend(
                                    {
                                        ...
                                        complete: function (e, h) {
                                            var j;
                                            if (
                                                ($("#sData", y + "_2").removeClass(f.active),
                                                (s[c] = q.p.idPrefix + s[c]),
                                                e.status >= 300 && 304 !== e.status
                                                    ? ((l[0] = !1),
                                                      (l[1] = $(q).triggerHandler("jqGridAddEditErrorTextFormat", [e, u])),
                                                      $.isFunction(rp_ge[q.p.id].errorTextFormat) ? (l[1] = rp_ge[q.p.id].errorTextFormat.call(q, e, u)) : (l[1] = h + " Status: '" + e.statusText + "'. Error code: " + e.status))
                                                    : ((l = $(q).triggerHandler("jqGridAddEditAfterSubmit", [e, s, u])),
                                                      void 0 === l && (l = [!0, "", ""]),
                                                      l[0] && $.isFunction(rp_ge[q.p.id].afterSubmit) && (l = rp_ge[q.p.id].afterSubmit.call(q, e, s, u))),
                                                l[0] === !1)
                                            )
                                                $(".FormError", w).html(l[1]), $(".FormError", w).show();
                                            else if (
                                                (q.p.autoencode &&
                                                    $.each(s, function (a, b) {
                                                ...
                                                s[d] === n.addoper
                                                    ? (l[2] || (l[2] = $.jgrid.randId()),
                                                      null == s[c] || "_empty" === s[c] ? (s[c] = l[2]) : (l[2] = s[c]),
                                                      rp_ge[q.p.id].reloadAfterSubmit ? $(q).trigger("reloadGrid") : q.p.treeGrid === !0 ? $(q).jqGrid("addChildNode", l[2], i, s) : $(q).jqGrid("addRowData", l[2], s, b.addedrow),
                                                      rp_ge[q.p.id].closeAfterAdd
                                                          ? (q.p.treeGrid !== !0 && $(q).jqGrid("setSelection", l[2]),
                                                          ...
                                                          : rp_ge[q.p.id].clearAfterAdd && g("_empty", q, w))
                                                    : (rp_ge[q.p.id].reloadAfterSubmit
                                                          ? ($(q).trigger("reloadGrid"),
                                                            rp_ge[q.p.id].closeAfterEdit ||
                                                                setTimeout(function () {
                                                                    $(q).jqGrid("setSelection", s[c]);
                                                                }, 1e3))
                                                          : q.p.treeGrid === !0
                                                          ? $(q).jqGrid("setTreeRow", s[c], s)
                                                          : $(q).jqGrid("setRowData", s[c], s),
                                                      rp_ge[q.p.id].closeAfterEdit &&
                                                          $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                                              gb: "#gbox_" + $.jgrid.jqID(v),
                                                              jqm: b.jqModal,
                                                ...
                                                $.isFunction(rp_ge[q.p.id].afterComplete) &&
                                                    ((a = e),
                                                    setTimeout(function () {
                                                        $(q).triggerHandler("jqGridAddEditAfterComplete", [a, s, $(w), u]), rp_ge[q.p.id].afterComplete.call(q, a, s, $(w), u), (a = null);
                                                    }, 500)),
                                                (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && ($(w).data("disabled", !1), "_empty" !== rp_ge[q.p.id]._savedData[q.p.id + "_id"]))
                                            )
                                ...
                                if ((t.url || rp_ge[q.p.id].useDataProxy || ($.isFunction(q.p.dataProxy) ? (rp_ge[q.p.id].useDataProxy = !0) : ((l[0] = !1), (l[1] += " " + E.nourl))), l[0]))
                                    if (rp_ge[q.p.id].useDataProxy) {
                                        ...
                                        void 0 === x && (x = [!0, ""]),
                                            x[0] === !1
                                                ? ((l[0] = !1), (l[1] = x[1] || "Error deleting the selected row!"))
                                                : (t.data.oper === n.addoper &&
                                                      rp_ge[q.p.id].closeAfterAdd &&
                                                      $.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                                          gb: "#gbox_" + $.jgrid.jqID(v),
                                                          jqm: b.jqModal,
                                    ...
                                    } else "clientArray" === t.url ? ((rp_ge[q.p.id].reloadAfterSubmit = !1), (s = t.data), t.complete({ status: 200, statusText: "" }, "")) : $.ajax(t);
                            }
                        ...
                        function o(a) {
                            ...
                            return (
                                "string" == typeof a &&
                                    (b = a.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function (a, b) {
                        ...
                        if (q.grid && a) {
                            var r,
                                ...
                                x = "TblGrid_" + v,
                                y = "#" + $.jgrid.jqID(x),
                                z = { themodal: "editmod" + v, modalhead: "edithd" + v, modalcontent: "editcnt" + v, scrollelm: w },
                                A = !0,
                                B = 1,
                                C = 0,
                            ...
                            (rp_ge[q.p.id].styleUI = q.p.styleUI || "jQueryUI"),
                                ...
                                "new" === a ? ((a = "_empty"), (u = "add"), (b.caption = rp_ge[q.p.id].addCaption)) : ((b.caption = rp_ge[q.p.id].editCaption), (u = "edit")),
                            ...
                            if (
                                (D ? ((G = o(rp_ge[$(this)[0].p.id].template)), (r = y)) : ((G = $("<table id='" + x + "' class='EditTable ui-common-table'><tbody></tbody></table>")), (r = y + "_2")),
                                (w = "#" + $.jgrid.jqID(w)),
                                ...
                                if (
                                    (D
                                        ? ($(J).find("#pData").replaceWith(N), $(J).find("#nData").replaceWith(O), $(J).find("#sData").replaceWith(P), $(J).find("#cData").replaceWith(Q), (U = $("<div id=" + x + "></div>").append(J)))
                                        : (U = $("<div></div>").append(J).append(R)),
                                    $(J).append("<div class='binfo topinfo bottominfo'>" + rp_ge[q.p.id].bottominfo + "</div>"),
                                    $.jgrid.createModal(z, U, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(q.p.id), $("#gbox_" + $.jgrid.jqID(q.p.id))[0]),
                                    K && ($("#pData, #nData", y + "_2").css("float", "right"), $(".EditButton", y + "_2").css("text-align", "left")),
                                    ...
                                    b.checkOnUpdate &&
                                        ($("a.ui-jqdialog-titlebar-close span", "#" + $.jgrid.jqID(z.themodal)).removeClass("jqmClose"),
                                        $("a.ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(z.themodal))
                                            .unbind("click")
                                            .click(function () {
                                                return k()
                                                    ? ($.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                    ...
                                    b.saveicon[0] === !0 &&
                                        $("#sData", r)
                                            .addClass("right" === b.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left")
                                            .append("<span class='" + f.icon_base + " " + b.saveicon[2] + "'></span>"),
                                    b.closeicon[0] === !0 &&
                                        $("#cData", r)
                                            .addClass("right" === b.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left")
                                            .append("<span class='" + f.icon_base + " " + b.closeicon[2] + "'></span>"),
                                ...
                                $(q).triggerHandler("jqGridAddEditInitializeForm", [$(w), u]),
                                    ...
                                    $.jgrid.viewModal("#" + $.jgrid.jqID(z.themodal), {
                                        ...
                                        onHide: function (a) {
                                            ...
                                            b.indexOf("px") > -1 && (b = parseFloat(b)),
                                                ...
                                                $(q).data("formProp", { top: parseFloat($(a.w).css("top")), left: parseFloat($(a.w).css("left")), width: c, height: b, dataheight: $(w).height(), datawidth: $(w).width() }),
                                                a.w.remove(),
                                                a.o && a.o.remove();
                                        },
                                    }),
                                    F ||
                                        $("." + $.jgrid.jqID(b.overlayClass)).click(function () {
                                            return k()
                                                ? ($.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                                                      gb: "#gbox_" + $.jgrid.jqID(v),
                                                      jqm: b.jqModal,
                                    ...
                                    $(".fm-button", "#" + $.jgrid.jqID(z.themodal)).hover(
                                        function () {
                                    ...
                                    $("#sData", r).click(function () {
                                        return (
                                            ...
                                            "_empty" === s[q.p.id + "_id"]
                                                ? i()
                                                : b.checkOnSubmit === !0
                                                ? ((t = j(s, rp_ge[q.p.id]._savedData)), t ? ($(w).data("disabled", !0), $(".confirm", "#" + $.jgrid.jqID(z.themodal)).show()) : i())
                                                : i(),
                                            !1
                                        );
                                    }),
                                    ...
                                    $("#nData", r).click(function () {
                                        ...
                                        if (((a[0] = parseInt(a[0], 10)), -1 !== a[0] && a[1][a[0] + 1])) {
                                            ...
                                            g(a[1][a[0] + 1], q, w),
                                                $(q).jqGrid("setSelection", a[1][a[0] + 1]),
            ...
            viewGridRow: function (a, b) {
                ...
                return (
                    ...
                    this.each(function () {
                        function c() {
                            (rp_ge[j.p.id].closeOnEscape !== !0 && rp_ge[j.p.id].navkeys[0] !== !0) ||
                                setTimeout(function () {
                                    $(".ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(p.modalhead))
                                        .attr("tabindex", "-1")
                                        .focus();
                                }, 0);
                        }
                        function d(a, c, d, e) {
                            ...
                            if (
                                ($(c.p.colModel).each(function () {
                                    (h = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0),
                                    ...
                                    if (
                                        ...
                                        (i = $(d).find("tr[rowpos=" + f + "]")),
                                            ...
                                            $("td:eq(" + (l - 1) + ")", i[0])
                                                .append("<span>" + j + "</span>")
                                                .attr("id", "v_" + g),
                                            n && $("td:eq(" + (l - 1) + ") span", i[0]).css({ "text-align": "right", width: m + "px" }),
                                            (q[p] = a),
                                            p++;
                                    }
                                }),
                        ...
                        function g(a, b) {
                            ...
                            (f = $(b).jqGrid("getInd", a, !0)),
                                f &&
                                    ($("td", f).each(function (a) {
                                        (c = b.p.colModel[a].name),
                                            (d = b.p.colModel[a].editrules && b.p.colModel[a].editrules.edithidden === !0 ? !1 : b.p.colModel[a].hidden === !0),
                                            "cb" !== c &&
                                                "subgrid" !== c &&
                                                "rn" !== c &&
                                                ((e = c === b.p.ExpandColumn && b.p.treeGrid === !0 ? $(this).text() : $(this).html()),
                                                (c = $.jgrid.jqID("v_" + c)),
                                                $("#" + c + " span", "#" + m).html(e),
                                                d &&
                                                    $("#" + c, "#" + m)
                        ...
                        function h(a, b) {
                            var c = b[1].length - 1;
                            0 === a
                                ? $("#pData", "#" + m + "_2").addClass(f.disabled)
                                : void 0 !== b[1][a - 1] && $("#" + $.jgrid.jqID(b[1][a - 1])).hasClass(f.disabled)
                                ? $("#pData", m + "_2").addClass(f.disabled)
                                : $("#pData", "#" + m + "_2").removeClass(f.disabled),
                                a === c
                        ...
                        if (j.grid && a) {
                            var k = j.p.id,
                                ...
                                n = "ViewGrid_" + k,
                                o = "ViewTbl_" + k,
                                p = { themodal: "viewmod" + k, modalhead: "viewhd" + k, modalcontent: "viewcnt" + k, scrollelm: l },
                            ...
                            if (
                                ...
                                $.jgrid.createModal(p, F, rp_ge[$(this)[0].p.id], "#gview_" + $.jgrid.jqID(j.p.id), $("#gview_" + $.jgrid.jqID(j.p.id))[0]),
                                    ...
                                    $("#" + p.themodal).keydown(function (a) {
                                        if (27 === a.which)
                                            return (
                                                rp_ge[j.p.id].closeOnEscape &&
                                                    $.jgrid.hideModal("#" + $.jgrid.jqID(p.themodal), {
                                                        gb: b.gbox,
                                                        jqm: b.jqModal,
                                                        onClose: b.onClose,
                                    ...
                                    $(".fm-button:not(." + f.disabled + ")", "#" + m + "_2").hover(
                                        function () {
                                            $(this).addClass(f.hover);
                                        },
                                        function () {
                        ...
                        if (c.grid && a) {
                            ...
                            if (((rp_ge[c.p.id].styleUI = c.p.styleUI || "jQueryUI"), $.isArray(a) && (a = a.join()), void 0 !== $("#" + $.jgrid.jqID(r.themodal))[0])) {
                                ...
                                $("#DelData>td", "#" + p).text(a),
                                    ...
                                    $.jgrid.viewModal("#" + $.jgrid.jqID(r.themodal), { gbox: "#gbox_" + $.jgrid.jqID(m), jqm: rp_ge[c.p.id].jqModal, jqM: !1, overlay: rp_ge[c.p.id].overlay, modal: rp_ge[c.p.id].modal }),
                                ...
                                if (
                                    ...
                                    l && ((o = l.call(c, $(u))), void 0 === o && (o = !0)),
                                    o === !1)
                                )
                                    return;
                                $(".fm-button", "#" + p + "_2").hover(
                                    function () {
                                        $(this).addClass(f.hover);
                                    },
                                    function () {
                                    ...
                                    b.delicon[0] === !0 &&
                                        $("#dData", "#" + p + "_2")
                                            .addClass("right" === b.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left")
                                            .append("<span class='" + f.icon_base + " " + b.delicon[2] + "'></span>"),
                                    b.cancelicon[0] === !0 &&
                                        $("#eData", "#" + p + "_2")
                                            .addClass("right" === b.cancelicon[1] ? "fm-button-icon-right" : "fm-button-icon-left")
                                            .append("<span class='" + f.icon_base + " " + b.cancelicon[2] + "'></span>"),
                                    $("#dData", "#" + p + "_2").click(function () {
                                        ...
                                        if (
                                            ...
                                            if (((rp_ge[c.p.id].processing = !0), (h = c.p.prmNames), (d = $.extend({}, rp_ge[c.p.id].delData, n)), (i = h.oper), (d[i] = h.deloper), (g = h.id), (j = String(j).split(",")), !j.length))
                                                return !1;
                                            ...
                                            var k = $.extend(
                                                {
                                                    ...
                                                    complete: function (a, g) {
                                                        var h;
                                                        if (
                                                            ($("#dData", "#" + p + "_2").removeClass(f.active),
                                                            a.status >= 300 && 304 !== a.status
                                                                ? ((e[0] = !1),
                                                                  $.isFunction(rp_ge[c.p.id].errorTextFormat) ? (e[1] = rp_ge[c.p.id].errorTextFormat.call(c, a)) : (e[1] = g + " Status: '" + a.statusText + "'. Error code: " + a.status))
                                                                : $.isFunction(rp_ge[c.p.id].afterSubmit) && (e = rp_ge[c.p.id].afterSubmit.call(c, a, d)),
                                                            e[0] === !1)
                                                        )
                                                            $("#DelError>td", "#" + p).html(e[1]), $("#DelError", "#" + p).show();
                                                        else {
                                                            ...
                                                            $.isFunction(rp_ge[c.p.id].afterComplete) &&
                                                                setTimeout(function () {
                                            ...
                                            if ((k.url || rp_ge[c.p.id].useDataProxy || ($.isFunction(c.p.dataProxy) ? (rp_ge[c.p.id].useDataProxy = !0) : ((e[0] = !1), (e[1] += " " + $.jgrid.getRegional(c, "errors.nourl")))), e[0]))
                                                if (rp_ge[c.p.id].useDataProxy) {
                                                    ...
                                                    void 0 === l && (l = [!0, ""]),
                                                        l[0] === !1
                                                            ? ((e[0] = !1), (e[1] = l[1] || "Error deleting the selected row!"))
                                                            : $.jgrid.hideModal("#" + $.jgrid.jqID(r.themodal), { gb: "#gbox_" + $.jgrid.jqID(m), jqm: b.jqModal, onClose: rp_ge[c.p.id].onClose });
                                    ...
                                    j && rp_ge[c.p.id].beforeShowForm.call(c, $("#" + p)),
                                    $.jgrid.viewModal("#" + $.jgrid.jqID(r.themodal), { gbox: "#gbox_" + $.jgrid.jqID(m), jqm: rp_ge[c.p.id].jqModal, overlay: rp_ge[c.p.id].overlay, modal: rp_ge[c.p.id].modal }),
                                    k && rp_ge[c.p.id].afterShowForm.call(c, $("#" + p));
                            }
                            rp_ge[c.p.id].closeOnEscape === !0 &&
                                setTimeout(function () {
                                    $(".ui-jqdialog-titlebar-close", "#" + $.jgrid.jqID(r.modalhead))
                                        .attr("tabindex", "-1")
                                        .focus();
                                }, 0);
                        }
                    ...
                    this.each(function () {
                        if (!this.p.navGrid) {
                            var j,
                                l,
                                m,
                                n = { themodal: "alertmod_" + this.p.id, modalhead: "alerthd_" + this.p.id, modalcontent: "alertcnt_" + this.p.id },
                                o = this;
                                    ...
                                    void 0 === $("#" + n.themodal)[0] &&
                                        (m.alerttop ||
                                            ...
                                            (void 0 !== window.innerWidth
                                                ? ((m.alertleft = window.innerWidth), (m.alerttop = window.innerHeight))
                                                : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth
                                                ? ((m.alertleft = document.documentElement.clientWidth), (m.alerttop = document.documentElement.clientHeight))
                                                : ((m.alertleft = 1024), (m.alerttop = 768)),
                                            (m.alertleft = m.alertleft / 2 - parseInt(m.alertwidth, 10) / 2),
                                            (m.alerttop = m.alerttop / 2 - 25)),
                                        $.jgrid.createModal(
                                            n,
                                            "<div>" + m.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",
                                            {
                                            ...
                                            "#gview_" + $.jgrid.jqID(o.p.id),
                                            $("#gbox_" + $.jgrid.jqID(o.p.id))[0],
                                            !0
                                        ));
                                var p,
                                    q = 1,
                                ...
                                for (m.cloneToTop && o.p.toppager && (q = 2), p = 0; q > p; p++) {
                                    ...
                                    0 === p ? ((u = a), (v = o.p.id), u === o.p.toppager && ((v += "_top"), (q = 1))) : ((u = o.p.toppager), (v = o.p.id + "_top")),
                                        ...
                                        m.edit &&
                                            ...
                                            $("tr", w).append(t),
                                            $(t, w)
                                                .attr({ title: m.edittitle || "", id: c.id || "edit_" + v })
                                                .click(function () {
                                                    if (!$(this).hasClass(k.disabled)) {
                                                        var a = o.p.selrow;
                                                        a
                                                            ? $.isFunction(m.editfunc)
                                                                ? m.editfunc.call(o, a)
                                                                : $(o).jqGrid("editGridRow", a, c)
                                                            : ($.jgrid.viewModal("#" + n.themodal, { gbox: "#gbox_" + $.jgrid.jqID(o.p.id), jqm: !0 }), $("#jqg_alrt").focus());
                                                    }
                                                    return !1;
                                                })
                                                .hover(r, s),
                                        ...
                                        m.view &&
                                            ...
                                            $("tr", w).append(t),
                                            $(t, w)
                                                .attr({ title: m.viewtitle || "", id: g.id || "view_" + v })
                                                .click(function () {
                                                    if (!$(this).hasClass(k.disabled)) {
                                                        var a = o.p.selrow;
                                                        a
                                                            ? $.isFunction(m.viewfunc)
                                                                ? m.viewfunc.call(o, a)
                                                                : $(o).jqGrid("viewGridRow", a, g)
                                                            : ($.jgrid.viewModal("#" + n.themodal, { gbox: "#gbox_" + $.jgrid.jqID(o.p.id), jqm: !0 }), $("#jqg_alrt").focus());
                                                    }
                                                    return !1;
                                                })
                                        ...
                                        m.del &&
                                            ...
                                            $("tr", w).append(t),
                                            $(t, w)
                                                .attr({ title: m.deltitle || "", id: e.id || "del_" + v })
                                                .click(function () {
                                                    if (!$(this).hasClass(k.disabled)) {
                                                        var a;
                                                        o.p.multiselect ? ((a = o.p.selarrrow), 0 === a.length && (a = null)) : (a = o.p.selrow),
                                                            a
                                                                ? $.isFunction(m.delfunc)
                                                                    ? m.delfunc.call(o, a)
                                                                    : $(o).jqGrid("delGridRow", a, e)
                                                                : ($.jgrid.viewModal("#" + n.themodal, { gbox: "#gbox_" + $.jgrid.jqID(o.p.id), jqm: !0 }), $("#jqg_alrt").focus());
                                                    }
                                                    return !1;
                                                })
                                        ...
                                        m.search &&
                                            ...
                                            $("tr", w).append(t),
                                            $(t, w)
                                                .attr({ title: m.searchtitle || "", id: f.id || "search_" + v })
                                                .click(function () {
                                        ...
                                        m.refresh &&
                                            ...
                                            $("tr", w).append(t),
                                            $(t, w)
                                                .attr({ title: m.refreshtitle || "", id: "refresh_" + v })
                                                .click(function () {
                                                    if (!$(this).hasClass(k.disabled)) {
                                        ...
                                        o.p._nvtd &&
                                            (m.dropmenu
                                                ? ((w = null), $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g))
                                                : j > o.p._nvtd[0]
                                                ? (o.p.responsive
                                                      ? ((w = null), $(o).jqGrid("_buildNavMenu", u, v, b, c, d, e, f, g))
                                                      : $(u + "_" + m.position, u)
            ...
            navButtonAdd: function (a, b) {
                ...
                return (
                    (b = $.extend({ caption: "newButton", title: "", buttonicon: d.icon_newbutton_nav, onClickButton: null, position: "last", cursor: "pointer", internal: !1 }, b || {})),
                    this.each(function () {
                        if (this.grid) {
                            ...
                            if ((e.p.storeNavOptions && !b.internal && e.p.navButtons.push([a, b]), d)) {
                                ...
                                var j = $("<td></td>");
                                "NONE" === b.buttonicon.toString().toUpperCase()
                                    ? $(j)
                                          .addClass("ui-pg-button " + h)
                                          .append("<div class='ui-pg-div'>" + b.caption + "</div>")
                                    : $(j)
                                          .addClass("ui-pg-button " + h)
                                          .append("<div class='ui-pg-div'><span class='" + i + " " + b.buttonicon + "'></span>" + b.caption + "</div>"),
                                    b.id && $(j).attr("id", b.id),
                                ...
                                k &&
                                    ("first" === b.position ? $("#" + k).prepend(m) : $("#" + k).append(m),
                                    $(m)
                                        .on("click", function (a) {
            ...
            navSeparatorAdd: function (a, b) {
                ...
                return (
                    (b = $.extend({ sepclass: "ui-separator", sepcontent: "", position: "last" }, b || {})),
                    this.each(function () {
                        if (this.grid) {
                            "string" == typeof a && 0 !== a.indexOf("#") && (a = "#" + $.jgrid.jqID(a));
                            var c,
                            ...
                            this.p.storeNavOptions && this.p.navButtons.push([a, b]),
                                f
                                    ? ((c = "<td class='ui-pg-button " + d.disabled + "' style='width:4px;'><span class='" + b.sepclass + "'></span>" + b.sepcontent + "</td>"),
                                      "first" === b.position ? (0 === f.rows[0].cells.length ? $("tr", f).append(c) : $("tr td:eq(0)", f).before(c)) : $("tr", f).append(c))
                                    : ((f = $(".dropdownmenu", a)[0]),
                                      (c = "<li class='ui-menu-item " + d.disabled + "' style='width:100%' role='presentation'><hr class='ui-separator-li'></li>"),
                                      f && ((e = $(f).val()), e && ("first" === b.position ? $("#" + e).prepend(c) : $("#" + e).append(c))));
                        }
                    })
                );
            },
            _buildNavMenu: function (a, b, c, d, e, f, g, h) {
                return this.each(function () {
                    ...
                    var q = { themodal: "alertmod_" + this.p.id, modalhead: "alerthd_" + this.p.id, modalcontent: "alertcnt_" + this.p.id },
                        r = function () {
                            var a,
                                j,
                                k = $(".ui-jqgrid-view").css("font-size") || "11px",
                            ...
                            c.add &&
                                ...
                                c.edit &&
                                    ((d = d || {}),
                                    (a = d.id || "edit_" + b),
                                    (j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.edittext || c.edittitle) + "</a></li>").click(
                                        function () {
                                            if (!$(this).hasClass(m.disabled)) {
                                                var a = i.p.selrow;
                                                a
                                                    ? $.isFunction(c.editfunc)
                                                        ? c.editfunc.call(i, a)
                                                        : $(i).jqGrid("editGridRow", a, d)
                                                    : ($.jgrid.viewModal("#" + q.themodal, { gbox: "#gbox_" + $.jgrid.jqID(i.p.id), jqm: !0 }), $("#jqg_alrt").focus()),
                                                    $(o).hide();
                                            }
                                            return !1;
                                        }
                                ...
                                c.view &&
                                    ((h = h || {}),
                                    (a = h.id || "view_" + b),
                                    (j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.viewtext || c.viewtitle) + "</a></li>").click(
                                        function () {
                                            if (!$(this).hasClass(m.disabled)) {
                                                var a = i.p.selrow;
                                                a
                                ...
                                c.search &&
                                    ((g = g || {}),
                                    (a = g.id || "search_" + b),
                                    (j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.searchtext || c.searchtitle) + "</a></li>").click(
                                        function () {
                                ...
                                c.refresh &&
                                    ((a = g.id || "search_" + b),
                                    (j = $('<li class="ui-menu-item" role="presentation"><a class="' + m.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + a + '">' + (c.refreshtext || c.refreshtitle) + "</a></li>").click(
                                        function () {
                                            if (!$(this).hasClass(m.disabled)) {
                    ...
                    r(),
                        $(".dropdownmenu", a + "_" + c.position).on("click", function (a) {
                            ...
                            $("#" + e)
                                .show()
                                .css({ top: d - ($("#" + e).height() + 10) + "px", left: c + "px" }),
                                a.stopPropagation();
                        }),
                        $("body").on("click", function (a) {
                ...
                return this.each(function () {
                    ...
                    if (d.grid) {
                        ...
                        if (e)
                            for (c in e)
                                e.hasOwnProperty(c) &&
                                    ($("[name=" + $.jgrid.jqID(c) + "]", b).is("input:radio") || $("[name=" + $.jgrid.jqID(c) + "]", b).is("input:checkbox")
                                        ? $("[name=" + $.jgrid.jqID(c) + "]", b).each(function () {
        ...
        $.jgrid.extend({
            groupingSetup: function () {
                return this.each(function () {
                    ...
                    if (null === f || ("object" != typeof f && !$.isFunction(f))) d.p.grouping = !1;
                        ...
                        for (void 0 === f.visibiltyOnNextGrouping && (f.visibiltyOnNextGrouping = []), f.lastvalues = [], f._locgr || (f.groups = []), f.counters = [], a = 0; a < f.groupField.length; a++)
                            f.groupOrder[a] || (f.groupOrder[a] = "asc"),
                                ...
                                f.groupColumnShow[a] === !0
                                    ? ((f.visibiltyOnNextGrouping[a] = !0), $(d).jqGrid("showCol", f.groupField[a]))
                                    : ((f.visibiltyOnNextGrouping[a] = $("#" + $.jgrid.jqID(d.p.id + "_" + f.groupField[a])).is(":visible")), $(d).jqGrid("hideCol", f.groupField[a]));
                        for (
                            f.summary = [],
                                f.hideFirstGroupCol &&
                                    $.isArray(f.formatDisplayField) &&
                                    !$.isFunction(f.formatDisplayField[0]) &&
                                    (f.formatDisplayField[0] = function (a) {
                                        return a;
                                    }),
                                b = 0,
                                c = e.length;
                            ...
                            f.hideFirstGroupCol &&
                                (e[b].hidden ||
                                    f.groupField[0] !== e[b].name ||
                                    (e[b].formatter = function () {
                                        return "";
                                    })),
                                e[b].summaryType &&
                                    (e[b].summaryDivider
                                        ? f.summary.push({ nm: e[b].name, st: e[b].summaryType, v: "", sd: e[b].summaryDivider, vd: "", sr: e[b].summaryRound, srt: e[b].summaryRoundType || "round" })
                                        : f.summary.push({ nm: e[b].name, st: e[b].summaryType, v: "", sr: e[b].summaryRound, srt: e[b].summaryRoundType || "round" }));
                    } else d.p.grouping = !1;
                });
            },
                ...
                return (
                    this.each(function () {
                        var c,
                            ...
                            j = function () {
                                $.isFunction(this.st)
                                    ? (this.v = this.st.call(i, this.v, this.nm, a))
                                    : ((this.v = $(i).jqGrid("groupingCalculations.handler", this.st, this.v, this.nm, this.sr, this.srt, a)),
                        ...
                        for (c = 0; k > c; c++)
                            (d = h.groupField[c]),
                                ...
                                void 0 !== e &&
                                    (0 === b
                                        ? (h.groups.push({ idx: c, dataIndex: d, value: e, displayValue: g, startRow: b, cnt: 1, summary: [] }),
                                          (h.lastvalues[c] = e),
                                          (h.counters[c] = { cnt: 1, pos: h.groups.length - 1, summary: $.extend(!0, [], h.summary) }),
                                          $.each(h.counters[c].summary, j),
                                          (h.groups[h.counters[c].pos].summary = h.counters[c].summary))
                                        : "object" == typeof e || ($.isArray(h.isInTheSameGroup) && $.isFunction(h.isInTheSameGroup[c]) ? h.isInTheSameGroup[c].call(i, h.lastvalues[c], e, c, h) : h.lastvalues[c] === e)
                                        ? 1 === l
                                            ? (h.groups.push({ idx: c, dataIndex: d, value: e, displayValue: g, startRow: b, cnt: 1, summary: [] }),
                                              (h.lastvalues[c] = e),
                                              (h.counters[c] = { cnt: 1, pos: h.groups.length - 1, summary: $.extend(!0, [], h.summary) }),
                                              $.each(h.counters[c].summary, j),
                                              (h.groups[h.counters[c].pos].summary = h.counters[c].summary))
                                            : ((h.counters[c].cnt += 1), (h.groups[h.counters[c].pos].cnt = h.counters[c].cnt), $.each(h.counters[c].summary, j), (h.groups[h.counters[c].pos].summary = h.counters[c].summary))
                                        : (h.groups.push({ idx: c, dataIndex: d, value: e, displayValue: g, startRow: b, cnt: 1, summary: [] }),
                                          (h.lastvalues[c] = e),
                                          (l = 1),
                                          (h.counters[c] = { cnt: 1, pos: h.groups.length - 1, summary: $.extend(!0, [], h.summary) }),
                                    ...
                                    if (((f = n(l.className)), void 0 === g && (g = void 0 === f), (p = $(l).hasClass("ui-subgrid") && $(l).hasClass("ui-sg-collapsed")), void 0 !== f)) {
                                        ...
                                        f === e + 1 &&
                                            (p ||
                                                ($(l)
                                                    .show()
                                                    .find(">td>span.tree-wrap-" + b.p.direction)
                                                    .removeClass(i)
                                                    .addClass(j),
                                                q &&
                                                    $(s)
                        ...
                        $.each(k.groups, function (e, u) {
                            ...
                            s++,
                                ...
                                (m =
                                    ...
                                    "');return false;\"></span>");
                            try {
                                $.isArray(k.formatDisplayField) && $.isFunction(k.formatDisplayField[u.idx])
                                    ? ((u.displayValue = k.formatDisplayField[u.idx].call(j, u.displayValue, u.value, j.p.colModel[o[u.idx]], u.idx, k)), (i = u.displayValue))
                                    : (i = j.formatter(g, u.displayValue, o[u.idx], u.value));
                            } catch (v) {
                                i = u.displayValue;
                            }
                            var w = "";
                            (w = $.isFunction(k.groupText[u.idx]) ? k.groupText[u.idx].call(j, i, u.cnt, u.summary) : $.jgrid.template(k.groupText[u.idx], i, u.cnt, u.summary)),
                                ...
                                "header" === k.groupSummaryPos[u.idx]
                                    ? ((l +=
                                          '<tr id="' +
                                          g +
                                          '"' +
                                          (k.groupCollapse && u.idx > 0 ? ' style="display:none;" ' : " ") +
                                          'role="row" class= "' +
                                          q.content +
                                          " jqgroup ui-row-" +
                                          j.p.direction +
                                    ...
                                    : (l +=
                                          ...
                                          12 * u.idx +
                                          'px;" colspan="' +
                                          (k.groupColumnShow[u.idx] === !1 ? b - 1 : b) +
                                          '">' +
                                          m +
                                          w +
                                          "</td></tr>");
            ...
            setGroupHeaders: function (a) {
                return (
                    (a = $.extend({ useColSpanStyle: !1, groupHeaders: [] }, a || {})),
                    this.each(function () {
                        var b,
                            c,
                            d,
                        ...
                        for ($(p).prepend(w), d = $("<tr>", { role: "row" }).addClass("ui-jqgrid-labels jqg-third-row-header"), b = 0; s > b; b++)
                            if (
                                ((f = t[b].el),
                                (g = $(f)),
                                (c = r[b]),
                                (h = { height: "0px", width: t[b].width + "px", display: c.hidden ? "none" : "" }),
                                $("<th>", { role: "gridcell" })
                                    .css(h)
                                    .addClass("ui-first-th-" + p.p.direction)
                                    .appendTo(x),
                                (f.style.width = ""),
                                ...
                                (e = $("<th>")
                                    ...
                                    .addClass(y.headerBox + " ui-th-column-header ui-th-" + p.p.direction + " " + n)
                                    .html(l)),
                                ...
                                0 === q
                                    ? a.useColSpanStyle
                                        ...
                                        : ($("<th>", { role: "columnheader" })
                                              .addClass(y.headerBox + " ui-th-column-header ui-th-" + p.p.direction)
                                              .css({ display: c.hidden ? "none" : "" })
                                              .insertBefore(g),
                                          d.append(f))
                                    : (d.append(f), q--);
                        (o = $(p).children("thead")),
                            ...
                            u.append(o),
                            a.useColSpanStyle &&
                                (u.find("span.ui-jqgrid-resize").each(function () {
                                    var a = $(this).parent();
        ...
        $.extend($.jgrid, {
            saveState: function (a, b) {
                if (((b = $.extend({ useStorage: !0, storageType: "localStorage", beforeSetItem: null, compression: !1, compressionModule: "LZString", compressionMethod: "compressToUTF16" }, b || {})), a)) {
                    ...
                    if (g.grid) {
                        if (
                            ((d = $(g).data("inlineNav")),
                            d && g.p.inlineNav && $(g).jqGrid("setGridParam", { _iN: d }),
                            (d = $(g).data("filterToolbar")),
                            d && g.p.filterToolbar && $(g).jqGrid("setGridParam", { _fT: d }),
                            (e = $(g).jqGrid("jqGridExport", { exptype: "jsonstring", ident: "", root: "" })),
                            $(g.grid.bDiv)
                                .find(".ui-jqgrid-btable tr:gt(0)")
                                .each(function (a, b) {
                                    f += b.outerHTML;
                                }),
                            $.isFunction(b.beforeSetItem) && ((c = b.beforeSetItem.call(g, e)), null != c && (e = c)),
            ...
            loadState: function (a, b, c) {
                if (
                    ((c = $.extend(
                        { useStorage: !0, storageType: "localStorage", clearAfterLoad: !1, beforeSetGrid: null, afterSetGrid: null, decompression: !1, decompressionModule: "LZString", decompressionMethod: "decompressFromUTF16" },
                        c || {}
                    )),
                    a)
                ) {
                    ...
                    if (b) {
                        ...
                        if (((d = jqGridUtils.parse(b)), d && "object" === $.type(d))) {
                            ...
                            if (
                                ...
                                d.storeNavOptions &&
                                    d.navGrid &&
                                    ((m[0].p.navGrid = !1), m.jqGrid("navGrid", d.pager, d.navOptions, d.editOptions, d.addOptions, d.delOptions, d.searchOptions, d.viewOptions), d.navButtons && d.navButtons.length))
                            )
                                for (var n = 0; n < d.navButtons.length; n++)
                                    "sepclass" in d.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", d.navButtons[n][0], d.navButtons[n][1]) : m.jqGrid("navButtonAdd", d.navButtons[n][0], d.navButtons[n][1]);
                            d.inlineNav && g && (m.jqGrid("setGridParam", { inlineNav: !1 }), m.jqGrid("inlineNav", d.pager, g)),
                                d.filterToolbar && h && (m.jqGrid("setGridParam", { filterToolbar: !1 }), (h.restoreFromFilters = !0), m.jqGrid("filterToolbar", h)),
                                d.frozenColumns && m.jqGrid("setFrozenColumns"),
                                m[0].updatepager(!0, !0),
                                $.isFunction(c.afterSetGrid) && c.afterSetGrid(m),
        ...
        $.jgrid.extend({
                ...
                return (
                    this.each(function () {
                        if (this.grid) {
                            ...
                            if (
                                (d.rownumbers && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)),
                                d.multiselect && (d.colNames.splice(0, 1), d.colModel.splice(0, 1)),
            ...
            excelExport: function (a) {
                return (
                    (a = $.extend({ exptype: "remote", url: null, oper: "oper", tag: "excel", exportOptions: {} }, a || {})),
                    this.each(function () {
                        if (this.grid) {
                            var b;
                            if ("remote" === a.exptype) {
        ...
        $.jgrid.extend({
            editRow: function (a, b, c, d, e, f, g, h, i) {
                ...
                return (
                    ...
                    (j = $.extend(
                        !0,
                        { keys: !1, keyevent: "keydown", oneditfunc: null, successfunc: null, url: null, extraparam: {}, aftersavefunc: null, errorfunc: null, afterrestorefunc: null, restoreAfterError: !0, mtype: "POST", focusField: !0 },
                        $.jgrid.inlineEdit,
                        j
                    )),
                    this.each(function () {
                        ...
                        h.grid &&
                            ((e = $(h).jqGrid("getInd", a, !0)),
                            e !== !1 &&
                                ((g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0),
                                void 0 === g && (g = !0),
                                g &&
                                    ((d = $(e).attr("editable") || "0"),
                                    "0" !== d ||
                                        $(e).hasClass("not-editable-row") ||
                                        ((f = h.p.colModel),
                                        ...
                                        i > 0 &&
                                            ...
                                            $(e).attr("editable", "1"),
                                            j.focusField &&
                                                ("number" == typeof j.focusField && parseInt(j.focusField, 10) <= f.length && (k = j.focusField),
                                                setTimeout(function () {
                                                    var a = $("td:eq(" + k + ") :input:visible", e).not(":disabled");
                                                    a.length > 0 && a.focus();
                                                }, 0)),
                                            j.keys === !0 &&
                                                $(e).bind(j.keyevent, function (b) {
                                                    if (27 === b.keyCode) {
                                                        if (($(h).jqGrid("restoreRow", a, j.afterrestorefunc), h.p.inlineNav))
                                                            try {
            ...
            saveRow: function (a, b, c, d, e, f, g) {
                ...
                if ((void 0 === x && (x = !0), x)) {
                    if (((l = $(o).attr("editable")), (i.url = i.url || j.p.editurl), "1" === l)) {
                        var y;
                        if (
                            ($('td[role="gridcell"]', o).each(function (a) {
                                    ...
                                    switch (y.edittype) {
                                        ...
                                        case "custom":
                                            try {
                                                ...
                                                "e1" === e
                                                    ? $.jgrid.info_dialog(v.errcap, "function 'custom_value' " + w.msg.nodefined, w.bClose, { styleUI: j.p.styleUI })
                                                    : $.jgrid.info_dialog(v.errcap, e.message, w.bClose, { styleUI: j.p.styleUI });
                                            }
                                    }
                        ...
                        if ("clientArray" === i.url) {
                            ...
                            $(j).jqGrid("progressBar", { method: "show", loadtype: i.saveui, htmlcontent: i.savetext }),
                                (s = $.extend({}, q, s)),
                                            ...
                                            complete: function (b, c) {
                                                if (($(j).jqGrid("progressBar", { method: "hide", loadtype: i.saveui, htmlcontent: i.savetext }), "success" === c)) {
                                                    var d,
                                                        ...
                                                        f = !0;
                                                    if (
                                                        ((d = $(j).triggerHandler("jqGridInlineSuccessSaveRow", [b, a, i])),
                                                        $.isArray(d) || (d = [!0, s]),
                                                        d[0] && $.isFunction(i.successfunc) && (d = i.successfunc.call(j, b)),
                                                        $.isArray(d) ? ((f = d[0]), (q = d[1] || q)) : (f = d),
                                                        f === !0)
                                                    ) {
                                                        for (
                                                            j.p.autoencode &&
            ...
            restoreRow: function (a, b) {
                var c = $.makeArray(arguments).slice(1),
                    d = {};
                return (
                    "object" === $.type(c[0]) ? (d = c[0]) : $.isFunction(b) && (d.afterrestorefunc = b),
                            ...
                            if ((void 0 === h && (h = !0), h)) {
                                ...
                                if (f >= 0) {
                                    ...
                                    $.each(e.p.colModel, function () {
                                        ...
                                        $("#" + $.jgrid.jqID(a), "#" + $.jgrid.jqID(e.p.id)).hasClass("jqgrid-new-row") &&
                                            setTimeout(function () {
            ...
            addRow: function (a) {
                return (
                    (a = $.extend(!0, { rowID: null, initdata: {}, position: "first", useDefValues: !0, useFormatter: !1, addRowParams: { extraparam: {} } }, a || {})),
                    this.each(function () {
                        if (this.grid) {
                            var b = this,
                            ...
                            if ((void 0 === c && (c = !0), c))
                                if (
                                    ((a.rowID = $.isFunction(a.rowID) ? a.rowID.call(b, a) : null != a.rowID ? a.rowID : $.jgrid.randId()),
                                    a.useDefValues === !0 &&
                                        $(b.p.colModel).each(function () {
                ...
                return (
                    ...
                    this.each(function () {
                        if (this.grid && !this.p.inlineNav) {
                            ...
                            if (
                                (c.p.navGrid || $(c).jqGrid("navGrid", a, { refresh: !1, edit: !1, add: !1, del: !1, search: !1, view: !1 }),
                                ...
                                for (g = 0; g < h.length; g++)
                                    if (h[g].formatter && "actions" === h[g].formatter) {
                                        if (h[g].formatoptions) {
                                            var i = { keys: !1, onEdit: null, onSuccess: null, afterSave: null, onError: null, afterRestore: null, extraparam: {}, url: null },
                                    ...
                                    $(c).jqGrid("navButtonAdd", a, {
                                        ...
                                        onClickButton: function () {
                                            ...
                                            a
                                                ...
                                                : ($.jgrid.viewModal("#alertmod_" + e, { gbox: "#gbox_" + e, jqm: !0 }), $("#jqg_alrt").focus());
                                        },
                                    }),
                                b.save &&
                                    ($(c).jqGrid("navButtonAdd", a, {
                                        ...
                                        onClickButton: function () {
                                            ...
                                            if (a) {
                                                var d = c.p.prmNames,
                                                    f = d.oper,
                                                    g = b.editParams;
                                                $("#" + $.jgrid.jqID(a), "#" + e).hasClass("jqgrid-new-row")
                                                    ? ((b.addParams.addRowParams.extraparam[f] = d.addoper), (g = b.addParams.addRowParams))
                                                    : (b.editParams.extraparam || (b.editParams.extraparam = {}), (b.editParams.extraparam[f] = d.editoper)),
                                    ...
                                    ($(c).jqGrid("navButtonAdd", a, {
                                        ...
                                        onClickButton: function () {
                                            var a = c.p.savedRow[0].id,
                                                d = b.editParams;
                                            a
                                                ? ($("#" + $.jgrid.jqID(a), "#" + e).hasClass("jqgrid-new-row") && (d = b.addParams.addRowParams), $(c).jqGrid("restoreRow", a, d), $(c).jqGrid("showAddEditButtons"))
                                                : ($.jgrid.viewModal("#alertmod", { gbox: "#gbox_" + e, jqm: !0 }), $("#jqg_alrt").focus());
                                        },
                                    }),
                                    $("#" + e + "_ilcancel").addClass(f)),
                                b.restoreAfterSelect === !0 &&
                                    $(c).bind("jqGridBeforeSelectRow.inlineNav", function (a, d) {
                                        c.p.savedRow.length > 0 &&
                                            c.p.inlineNav === !0 &&
                                            d !== c.p.selrow &&
                                            null !== c.p.selrow &&
                                            (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : $(c).jqGrid("restoreRow", c.p.selrow, b.editParams), $(c).jqGrid("showAddEditButtons"));
                                    });
                        }
                    })
                );
    ...
    $.jgrid.extend({
        ...
        columnChooser: function (a) {
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(k[0].p.id)).length) {
                if (
                    ((d = $('<div id="colchooser_' + k[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>')),
                    (e = $("select", d)),
                    (a = $.extend(
                        {
                            width: 400,
                ...
                a.caption && d.attr("title", a.caption),
                    ...
                    a.width && ($(">div", d).css({ width: a.width, margin: "0 auto" }), e.css("width", a.width)),
                    ...
                    h.css({ margin: "auto" }),
                    h.find(">div").css({ width: "100%", height: "100%", margin: "auto" }),
                    (i = p(e)),
                    i.container.css({ width: "100%", height: "100%", margin: "auto" }),
                    i.selectedContainer.css({ width: 100 * i.options.dividerLocation + "%", height: "100%", margin: "auto", boxSizing: "border-box" }),
                    i.availableContainer.css({ width: 100 - 100 * i.options.dividerLocation + "%", height: "100%", margin: "auto", boxSizing: "border-box" }),
        ...
        sortableRows: function (a) {
            return this.each(function () {
                ...
                b.grid &&
                    (b.p.treeGrid ||
                        ($.fn.sortable &&
                            ((a = $.extend({ cursor: "move", axis: "y", items: " > .jqgrow" }, a || {})),
                            a.start && $.isFunction(a.start) ? ((a._start_ = a.start), delete a.start) : (a._start_ = !1),
                            a.update && $.isFunction(a.update) ? ((a._update_ = a.update), delete a.update) : (a._update_ = !1),
                                    ...
                                    return $.extend(
                                        {
                                            ...
                                            stop: function (b, c) {
                                                var d, f;
                                                for (
                                                    c.helper.dropped && !a.dragcopy && ((f = $(c.helper).attr("id")), void 0 === f && (f = $(this).attr("id")), $(e).jqGrid("delRowData", f)), d = 0;
        ...
        gridResize: function (opts) {
            return this.each(function () {
                ...
                if ($t.grid && $.fn.resizable) {
                    if (
                        ((opts = $.extend({}, opts || {})),
                        opts.alsoResize ? ((opts._alsoResize_ = opts.alsoResize), delete opts.alsoResize) : (opts._alsoResize_ = !1),
                        opts.stop && $.isFunction(opts.stop) ? ((opts._stop_ = opts.stop), delete opts.stop) : (opts._stop_ = !1),
        ...
        $.jgrid.extend({
            pivotSetup: function (a, b) {
                var c = [],
                    ...
                    f = [],
                    g = [],
                    h = { grouping: !0, groupingView: { groupField: [], groupSummary: [], groupSummaryPos: [] } },
                    i = [],
                    j = $.extend({ rowTotals: !1, rowTotalsText: "Total", colTotals: !1, groupSummary: !0, groupSummaryPos: "header", frozenStaticCols: !1 }, b || {});
                return (
                    this.each(function () {
                        function b(a, b, c) {
                            var d;
                            ...
                            for (e in a)
                                if (a.hasOwnProperty(e)) {
                                    if ("object" != typeof a[e]) {
                                        if ("level" === e) {
                                            if (
                                                (void 0 === J[a.level] && ((J[a.level] = ""), a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (i[a.level - 1] = { useColSpanStyle: !1, groupHeaders: [] })),
                        ...
                        if (j.rowTotals && j.yDimension.length > 0) {
                            ...
                            j.yDimension.splice(0, 0, { dataName: y }),
                        ...
                        var z;
                        for (q = 0; r > q; q++)
                            (z = { name: j.xDimension[q].dataName, frozen: j.frozenStaticCols }), null == j.xDimension[q].isGroupField && (j.xDimension[q].isGroupField = !0), (z = $.extend(!0, z, j.xDimension[q])), c.push(z);
                        for (var A = r - 1, B = {}; w > x; ) {
                            o = a[x];
                            var C = [],
                                D = [];
                            (u = {}), (q = 0);
                            do (C[q] = $.trim(o[j.xDimension[q].dataName])), (u[j.xDimension[q].dataName] = C[q]), q++;
                            while (r > q);
                            var E = 0;
                            if (((p = -1), (v = b(d, k, C)))) {
                                if (p >= 0) {
                            ...
                            for (F in f)
                                if (f.hasOwnProperty(F)) {
                                    if (0 === G) (B.children && void 0 !== B.children) || (B = { text: F, level: 0, children: [], label: F }), (H = B.children);
                                    else {
                ...
                return this.each(function () {
                    function e(a) {
                        var d,
                            ...
                            g,
                            h,
                            i = jQuery(f).jqGrid("pivotSetup", a, b),
                            j = $.assocArraySize(i.summary) > 0,
                            k = $.jgrid.from.call(f, i.rows);
                        for (b.ignoreCase && (k = k.ignoreCase()), d = 0; d < i.groupOptions.groupingView.groupField.length; d++)
                            (e = b.xDimension[d].sortorder ? b.xDimension[d].sortorder : "asc"), (g = b.xDimension[d].sorttype ? b.xDimension[d].sorttype : "text"), k.orderBy(i.groupOptions.groupingView.groupField[d], e, g, "", g);
                        (h = b.xDimension.length),
                            i.groupOptions.sortname &&
                                h &&
                                ((e = b.xDimension[h - 1].sortorder ? b.xDimension[h - 1].sortorder : "asc"), (g = b.xDimension[h - 1].sorttype ? b.xDimension[h - 1].sorttype : "text"), k.orderBy(i.groupOptions.sortname, e, g, "", g)),
                            jQuery(f).jqGrid(
                                $.extend(
                                    !0,
                                    { datastr: $.extend(k.select(), j ? { userdata: i.summary } : {}), datatype: "jsonstring", footerrow: j, userDataOnFooter: j, colModel: i.colModel, viewrecords: !0, sortname: b.xDimension[0].dataName },
                                    i.groupOptions,
                                    c || {}
                                )
                            );
            ...
            setSubGrid: function () {
                return this.each(function () {
                    var a,
                        ...
                        e = { plusicon: d.icon_plus, minusicon: d.icon_minus, openicon: d.icon_open, expandOnLoad: !1, delayOnLoad: 50, selectOnExpand: !1, selectOnCollapse: !1, reloadOnExpand: !0 };
                    if (
                        ((c.p.subGridOptions = $.extend(e, c.p.subGridOptions || {})),
                        c.p.colNames.unshift(""),
                        c.p.colModel.unshift({ name: "subgrid", width: $.jgrid.cell_width ? c.p.subGridWidth + c.p.cellLayout : c.p.subGridWidth, sortable: !1, resizable: !1, hidedlg: !0, search: !1, fixed: !0 }),
                        (a = c.p.subGridModel),
                        a[0])
                    )
            ...
            addSubGrid: function (a, b) {
                return this.each(function () {
                    ...
                    if (c.grid) {
                        var d,
                            ...
                            l = function (a, b) {
                                ...
                                for (e = 0; e < c.p.subGridModel[0].name.length; e++)
                                    (d = $("<th class='" + i.headerBox + " ui-th-subgrid ui-th-column ui-th-" + c.p.direction + "'></th>")), $(d).html(c.p.subGridModel[0].name[e]), $(d).width(c.p.subGridModel[0].width[e]), $(h).append(d);
                                $(g).append(h),
                                    a &&
                                        ((f = c.p.xmlReader.subgrid),
                                        $(f.root + " " + f.row, a).each(function () {
                                            if (((h = $("<tr class='" + j.content + " ui-subtblcell'></tr>")), f.repeatitems === !0))
                            ...
                            m = function (a, b) {
                                ...
                                for (f = 0; f < c.p.subGridModel[0].name.length; f++)
                                    (d = $("<th class='" + i.headerBox + " ui-th-subgrid ui-th-column ui-th-" + c.p.direction + "'></th>")), $(d).html(c.p.subGridModel[0].name[f]), $(d).width(c.p.subGridModel[0].width[f]), $(n).append(d);
                                ...
                                if (c.p.subGridModel[0].params)
                                    for (f = 0; f < c.p.subGridModel[0].params.length; f++)
                                        for (e = 0; e < c.p.colModel.length; e++)
                                            c.p.colModel[e].name === c.p.subGridModel[0].params[f] &&
                                                (d[c.p.colModel[e].name] = $("td:eq(" + e + ")", a)
                                                    .text()
                                                    .replace(/\&#160\;/gi, ""));
                        ...
                        var p = c.rows.length,
                            q = 1;
                        for (void 0 !== b && b > 0 && ((q = b), (p = b + 1)); p > q; )
                            $(c.rows[q]).hasClass("jqgrow") &&
                                (c.p.scroll && $(c.rows[q].cells[a]).unbind("click"),
                                $(c.rows[q].cells[a]).bind("click", function () {
                                    ...
                                    if (((e = c.p.id), (d = b.id), (h = $("#" + e + "_" + d + "_expandedContent")), $(this).hasClass("sgcollapsed"))) {
                                        if (
                                            ((g = $(c).triggerHandler("jqGridSubGridBeforeExpand", [e + "_" + d, d])),
                                            (g = g !== !1 && "stop" !== g),
                                            g && $.isFunction(c.p.subGridBeforeExpand) && (g = c.p.subGridBeforeExpand.call(c, e + "_" + d, d)),
                                            g === !1)
                                        )
                                            return !1;
                                        c.p.subGridOptions.reloadOnExpand === !0 || (c.p.subGridOptions.reloadOnExpand === !1 && !h.hasClass("ui-subgrid"))
                                            ? ((f = a >= 1 ? "<td colspan='" + a + "'>&#160;</td>" : ""),
                                              $(b).after(
                                                  "<tr role='row' id='" +
                                                      e +
                                                      "_" +
                                                      ...
                                                      j.icon_base +
                                                      " " +
                                                      c.p.subGridOptions.openicon +
                                                      "'></span></td><td colspan='" +
                                                      parseInt(c.p.colNames.length - 1 - o, 10) +
                                                      "' class='" +
                                                      j.content +
                                                      " subgrid-data'><div id=" +
                                                      e +
                                              ...
                                              $.isFunction(c.p.subGridRowExpanded) ? c.p.subGridRowExpanded.call(c, e + "_" + d, d) : n(b))
                                            : h.show().removeClass("ui-sg-collapsed").addClass("ui-sg-expanded"),
                                            $(this)
                                                .html("<a style='cursor:pointer;' class='ui-sghref'><span class='" + j.icon_base + " " + c.p.subGridOptions.minusicon + "'></span></a>")
                                                .removeClass("sgcollapsed")
                                                .addClass("sgexpanded"),
                                            c.p.subGridOptions.selectOnExpand && $(c).jqGrid("setSelection", d);
                                    } else if ($(this).hasClass("sgexpanded")) {
                                        if (
                                            ((g = $(c).triggerHandler("jqGridSubGridRowColapsed", [e + "_" + d, d])),
                                            (g = g !== !1 && "stop" !== g),
                                        ...
                                        c.p.subGridOptions.reloadOnExpand === !0 ? h.remove(".ui-subgrid") : h.hasClass("ui-subgrid") && h.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"),
                                            $(this)
                                                .html("<a style='cursor:pointer;' class='ui-sghref'><span class='" + j.icon_base + " " + c.p.subGridOptions.plusicon + "'></span></a>")
                                ...
                                q++;
                        c.p.subGridOptions.expandOnLoad === !0 &&
                            $(c.rows)
                                .filter(".jqgrow")
                                .each(function (a, b) {
                                    $(b.cells[0]).click();
        ...
        $.jgrid.extend({
                    ...
                    if (c.grid && c.p.treeGrid)
                        for (
                            ...
                            var s,
                                ...
                                u = c.p._index[t];
                            (j = c.p.data[u]),
                                "nested" === c.p.treeGridModel &&
                                    (j[n] ||
                                        ((d = parseInt(j[c.p.treeReader.left_field], 10)), (e = parseInt(j[c.p.treeReader.right_field], 10)), (j[n] = e === d + 1 ? "true" : "false"), (c.rows[a].cells[c.p._treeleafpos].innerHTML = j[n]))),
                                (f = parseInt(j[o], 10)),
                                ...
                                $(c.rows[a].cells[l])
                                    ...
                                    .bind("click", function (a) {
                                        ...
                                        return (
                                            c.p.data[e][n] ||
                                                (c.p.data[e][m] ? ($(c).jqGrid("collapseRow", c.p.data[e]), $(c).jqGrid("collapseNode", c.p.data[e])) : ($(c).jqGrid("expandRow", c.p.data[e]), $(c).jqGrid("expandNode", c.p.data[e]))),
                                            !1
                                        );
                                    }),
                                c.p.ExpandColClick === !0 &&
                                    $(c.rows[a].cells[l])
            ...
            setTreeGrid: function () {
                return this.each(function () {
                    ...
                    if (e.p.treeGrid) {
                        e.p.treedatatype || $.extend(e.p, { treedatatype: e.p.datatype }),
                            ...
                            (e.p.treeIcons = $.extend({ plus: a, minus: i.icon_minus, leaf: i.icon_leaf }, e.p.treeIcons || {})),
                            "nested" === e.p.treeGridModel
                                ? (e.p.treeReader = $.extend({ level_field: "level", left_field: "lft", right_field: "rgt", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded", icon_field: "icon" }, e.p.treeReader))
                                : "adjacency" === e.p.treeGridModel &&
                                  (e.p.treeReader = $.extend({ level_field: "level", parent_id_field: "parent", leaf_field: "isLeaf", expanded_field: "expanded", loaded: "loaded", icon_field: "icon" }, e.p.treeReader));
                        ...
                        $.each(e.p.treeReader, function (a, b) {
                            b &&
                                -1 === $.inArray(b, h) &&
                                ("leaf_field" === a && (e.p._treeleafpos = f), f++, e.p.colNames.push(b), e.p.colModel.push({ name: b, width: 1, hidden: !0, sortable: !1, resizable: !1, hidedlg: !0, editable: !0, search: !1 }));
                        });
                    }
                });
            },
                ...
                return (
                    this.each(function () {
                        ...
                        if (f.grid && f.p.treeGrid)
                            switch (("boolean" != typeof a && (a = !1), (e = a ? $(f).jqGrid("getRowData", null, !0) : f.p.data), f.p.treeGridModel)) {
                                case "nested":
                ...
                return (
                    this.each(function () {
                        ...
                        if (e.grid && e.p.treeGrid)
                            switch (((null != b && "boolean" == typeof b) || (b = !1), e.p.treeGridModel)) {
                                case "nested":
                    ...
                    if (this.grid && this.p.treeGrid) {
                        ...
                        (a[d] = !0),
                            ...
                            "nested" === this.p.treeGridModel
                                ? $(this).jqGrid("setGridParam", { postData: { nodeid: j, n_left: a[h], n_right: a[i], n_level: a[g] } })
                                : $(this).jqGrid("setGridParam", { postData: { nodeid: j, parentid: a[e], n_level: a[g] } }),
                            $(this).trigger("reloadGrid"),
                            (a[f] = !0),
                            "nested" === this.p.treeGridModel
                                ? $(this).jqGrid("setGridParam", { selrow: c, postData: { nodeid: "", n_left: "", n_right: "", n_level: "" } })
                ...
                return this.each(function () {
                    if (this.grid && this.p.treeGrid) {
                        ...
                        if (!a[b]) {
                            ...
                            if (k === !1) return;
                            $(this).jqGrid("isNodeLoaded", this.p.data[j])
                                ? ((a[b] = !0),
                                  $("div.treeclick", i)
                                      .removeClass(this.p.treeIcons.plus + " tree-plus")
                                      .addClass(this.p.treeIcons.minus + " tree-minus"))
                                : this.grid.hDiv.loading ||
                                  ...
                                  (this.p.datatype = this.p.treedatatype),
                                  "nested" === this.p.treeGridModel
                                      ? $(this).jqGrid("setGridParam", { postData: { nodeid: h, n_left: a[f], n_right: a[g], n_level: a[e] } })
                                      : $(this).jqGrid("setGridParam", { postData: { nodeid: h, parentid: a[c], n_level: a[e] } }),
                                  $(this).trigger("reloadGrid"),
                                  (a[d] = !0),
                                  "nested" === this.p.treeGridModel
                ...
                return (
                    this.each(function () {
                        if (this.grid && this.p.treeGrid && e)
                            for (c = this.p.localReader.id, b = 0; e > b; b++)
            ...
            collectChildrenSortTree: function (a, b, c, d, e, f) {
                return this.each(function () {
                    if (this.grid && this.p.treeGrid) {
                        var g, h, i, j, k, l;
                        for (j = $(this).jqGrid("getNodeChildren", b), k = $.jgrid.from.call(this, j), k.orderBy(c, d, e, f), l = k.select(), g = 0, h = l.length; h > g; g++)
                            (i = l[g]), a.push(i), $(this).jqGrid("collectChildrenSortTree", a, i, c, d, e, f);
                    }
                });
            },
            ...
            addChildNode: function (a, b, c, d) {
                ...
                if (c) {
                    ...
                    if (((k = j + 1), void 0 === c[n] && (c[n] = !1), void 0 === c[t] && (c[t] = !1), (c[p] = i), void 0 === c[o] && (c[o] = !0), "adjacency" === e.p.treeGridModel && (c[q] = b), "nested" === e.p.treeGridModel)) {
                        var y, z, A;
                        if (null !== b) {
                            if (((m = parseInt(h[s], 10)), (y = $.jgrid.from.call(e, e.p.data)), (y = y.greaterOrEquals(s, m, { stype: "integer" })), (z = y.select()), z.length))
                                for (A in z) z.hasOwnProperty(A) && ((z[A][r] = z[A][r] > m ? parseInt(z[A][r], 10) + 2 : z[A][r]), (z[A][s] = z[A][s] >= m ? parseInt(z[A][s], 10) + 2 : z[A][s]));
                            (c[r] = m), (c[s] = m + 1);
                        } else {
                            if (((m = parseInt($(e).jqGrid("getCol", s, !1, "max"), 10)), (z = $.jgrid.from.call(e, e.p.data).greater(r, m, { stype: "integer" }).select()), z.length))
        ...
        ($.jqDnR = {
            ...
            drag: function (a) {
                return (
                    "d" == M.k
                        ? E.css({ left: M.X + a.pageX - M.pX, top: M.Y + a.pageY - M.pY })
                        : (E.css({ width: Math.max(a.pageX - M.pX + M.W, 0), height: Math.max(a.pageY - M.pY + M.H, 0) }), M1 && E1.css({ width: Math.max(a.pageX - M1.pX + M1.W, 0), height: Math.max(a.pageY - M1.pY + M1.H, 0) })),
                    !1
                );
            },
            stop: function () {
    ...
    var J = $.jqDnR,
        ...
        i = function (a, b, c, d) {
            return a.each(function () {
                (b = b ? $(b, a) : a),
                    b.bind("mousedown", { e: a, k: c }, function (a) {
                        var b = a.data,
                            c = {};
                        if (((E = b.e), (E1 = d ? $(d) : !1), "relative" != E.css("position")))
                            try {
                                E.position(c);
                            } catch (e) {}
                        if (
                            ((M = { X: c.left || f("left") || 0, Y: c.top || f("top") || 0, W: f("width") || E[0].scrollWidth || 0, H: f("height") || E[0].scrollHeight || 0, pX: a.pageX, pY: a.pageY, k: b.k }),
                            (M1 = E1 && "d" != b.k ? { X: c.left || f1("left") || 0, Y: c.top || f1("top") || 0, W: E1[0].offsetWidth || f1("width") || 0, H: E1[0].offsetHeight || f1("height") || 0, pX: a.pageX, pY: a.pageY, k: b.k } : !1),
    ...
    ($.fn.tinyDraggable = function (a) {
        ...
        ($.fn.jqm = function (a) {
            ...
            return this.each(function () {
                return this._jqm
                    ? (H[this._jqm].c = $.extend({}, H[this._jqm].c, a))
                    : (s++, (this._jqm = s), (H[s] = { c: $.extend(b, $.jqm.params, a), a: F, w: $(this).addClass("jqmID" + s), s: s }), void (b.trigger && $(this).jqmAddTrigger(b.trigger)));
            });
        }),
    ...
    ($.fmatter = {}),
        $.extend($.fmatter, {
            ...
            isEmpty: function (a) {
                return !this.isString(a) && this.isValue(a)
                    ? !1
                    : this.isValue(a)
                    ? ((a = $.trim(a)
                          .replace(/\&nbsp\;/gi, "")
        ...
        ($.fn.fmatter.link = function (a, b) {
            var c = { target: b.target },
                d = "";
            return (
                void 0 !== b.colModel && void 0 !== b.colModel.formatoptions && (c = $.extend({}, c, b.colModel.formatoptions)),
        ...
        ($.fn.fmatter.showlink = function (a, b) {
            var c,
                d = { baseLinkUrl: b.baseLinkUrl, showAction: b.showAction, addParam: b.addParam || "", target: b.target, idName: b.idName },
                e = "";
            return (
                void 0 !== b.colModel && void 0 !== b.colModel.formatoptions && (d = $.extend({}, d, b.colModel.formatoptions)),
        ...
        ($.fn.fmatter.date = function (a, b, c, d) {
            var e = $.extend({}, b.date);
            return (
                void 0 !== b.colModel && void 0 !== b.colModel.formatoptions && (e = $.extend({}, e, b.colModel.formatoptions)),
            ...
            if (
                (void 0 !== b.colModel.formatoptions
                    ? ((e = b.colModel.formatoptions.value),
                      ...
                      (d = void 0 === b.colModel.formatoptions.delimiter ? ";" : b.colModel.formatoptions.delimiter))
                ...
                var g,
                    h = (null != b.colModel.editoptions && b.colModel.editoptions.multiple === !0) == !0,
                    i = [];
                if (
                    (h &&
                        ((i = a.split(",")),
                    ...
                    for (j = 0; j < k.length; j++)
                        if (
                            ((g = k[j].split(c)),
                            g.length > 2 &&
                                (g[1] = $.map(g, function (a, b) {
                                    return b > 0 ? a : void 0;
                                }).join(c)),
                            h)
                        )
                            $.inArray(g[0], i) > -1 && ((f[l] = g[1]), l++);
        ...
        ($.fn.fmatter.actions = function (a, b) {
            var c,
                d = { keys: !1, editbutton: !0, delbutton: !0, editformbutton: !1 },
                e = b.rowId,
                f = "",
            ...
            return (
                d.editformbutton
                    ? ((c = "id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); " + j),
                    ...
                    : d.editbutton &&
                      ((c = "id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); " + j),
                      (f += "<div title='" + g.edittitle + "' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' " + c + "><span class='" + i.icon_base + " " + h.icon_edit + "'></span></div>")),
                d.delbutton &&
                    ((c = "id='jDeleteButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'del'); " + j),
                ...
                if (
                    ...
                    for (n = 0; n < o.length; n++)
                        if (
                            ((j = o[n].split(h)),
                            j.length > 2 &&
                                (j[1] = $.map(j, function (a, b) {
                                    return b > 0 ? a : void 0;
                                }).join(h)),
                            l)
                        )
                            $.inArray($.trim(j[1]), m) > -1 && ((e[p] = j[0]), p++);
                        else if ($.trim(j[1]) === $.trim(f)) {
                            e[0] = j[0];
                            break;
                        }
                } else
                    ($.fmatter.isObject(k) || $.isArray(k)) &&
                        (l || (m[0] = f),
                        (e = $.map(m, function (a) {
                            var b;
                            return (
                            ...
                            if (b.hasOwnProperty(j)) {
                                ...
                                j.charAt(0) !== c.attr_prefix
                                    ? null == k
                                        ...
                                        ? (h[h.length] = g(j, k))
                                        : (h[h.length] = e(j, k))
                                    : (i[i.length] = " " + j.substring(1) + '="' + (c.encode ? d.encode(k) : k) + '"');
                            }
                        var l = i.join(""),
                            m = h.join("");
                            ...
                            if (7 !== a.nodeType) {
                                ...
                                if (a.attributes && a.attributes.length)
                                    for (c = {}, d = 0; d < a.attributes.length; d++)
                                        (e = a.attributes[d].nodeName), "string" == typeof e && ((f = a.attributes[d].nodeValue), f && ((e = o.attr_prefix + e), "undefined" == typeof g[e] && (g[e] = 0), g[e]++, addNode(c, e, g[e], f)));
                                if (a.childNodes && a.childNodes.length) {
                                    ...
                                    if (h) for (c || (c = ""), d = 0; d < a.childNodes.length; d++) c += a.childNodes[d].nodeValue;
                                        ...
                                        for (c || (c = {}), d = 0; d < a.childNodes.length; d++)
                                            (e = a.childNodes[d].nodeName), "string" == typeof e && ((f = parseElement(a.childNodes[d])), f && ("undefined" == typeof g[e] && (g[e] = 0), g[e]++, addNode(c, e, g[e], f)));
                                }
                                return c;
                            }
                        },
