...
!(function (a) {
    "function" == typeof define && define.amd
        ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (b) {
    ...
    var e = a.fn.dataTable,
                ...
                var b = a.document,
                    ...
                    q = function (b, j) {
                        ...
                        return (
                            ...
                            j || (j = "download"),
                            f
                                ? ((m = c().createObjectURL(b)), (e.href = m), (e.download = j), g(e), (s.readyState = s.DONE), v(), void n(m))
                                : (a.chrome && t && t !== k && ((r = b.slice || b.webkitSlice), (b = r.call(b, 0, b.size, k)), (u = !0)),
        ...
        k = function (a, b) {
            for (
                var c = j(b),
                    e = a.buttons.exportData(b.exportOptions),
                    f = b.fieldBoundary,
                    g = b.fieldSeparator,
                    h = new RegExp(f, "g"),
                    i = b.escapeChar !== d ? b.escapeChar : "\\",
                    k = function (a) {
                        for (var b = "", c = 0, d = a.length; d > c; c++) c > 0 && (b += g), (b += f ? f + ("" + a[c]).replace(h, i + f) + f : a[c]);
                        return b;
                    },
                    l = b.header ? k(e.header) + c : "",
                    m = b.footer && e.footer ? c + k(e.footer) : "",
                    n = [],
                    o = 0,
                    p = e.body.length;
                p > o;
    ...
    return (
                ...
                if (c.queryCommandSupported("copy")) {
                    ...
                    try {
                        return (
                            c.execCommand("copy"),
                            i.remove(),
                            void d.buttons.info(d.i18n("buttons.copyTitle", "Copy to clipboard"), d.i18n("buttons.copySuccess", { 1: "Copied one row to clipboard", _: "Copied %d rows to clipboard" }, g.rows), 2e3)
                        );
                    } catch (l) {}
                }
        ...
        (e.ext.buttons.excelHtml5 = {
            ...
            action: function (c, e, i, j) {
                var k = "",
                    ...
                    n = function (b) {
                        for (var c = [], e = 0, f = b.length; f > e; e++)
                            (null !== b[e] && b[e] !== d) || (b[e] = ""),
                                c.push(
                                    "number" == typeof b[e] || (b[e].match && a.trim(b[e]).match(/^-?\d+(\.\d+)?$/) && "0" !== b[e].charAt(0))
                                        ? '<c t="n"><v>' + b[e] + "</v></c>"
                                        : '<c t="inlineStr"><is><t>' +
                                              (b[e].replace
                                                  ? b[e]
                ...
                q.file("[Content_Types].xml", m["[Content_Types].xml"]),
                    r.file(".rels", m["_rels/.rels"]),
                    s.file("workbook.xml", m["xl/workbook.xml"].replace("__SHEET_NAME__", h(j))),
                    t.file("workbook.xml.rels", m["xl/_rels/workbook.xml.rels"]),
                    u.file("sheet1.xml", m["xl/worksheets/sheet1.xml"].replace("__DATA__", k)),
                    f(q.generate({ type: "blob", mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" }), g(j));
            },
            filename: "*",
            extension: ".xlsx",
            exportOptions: {},
        ...
        (e.ext.buttons.pdfHtml5 = {
            ...
            action: function (c, d, e, h) {
                ...
                h.message && p.content.unshift({ text: h.message, style: "message", margin: [0, 0, 0, 12] }), h.title && p.content.unshift({ text: i(h, !1), style: "title", margin: [0, 0, 0, 12] }), h.customize && h.customize(p, h);
                var q = b.pdfMake.createPdf(p);
                "open" !== h.download || l()
                    ? q.getBuffer(function (a) {
