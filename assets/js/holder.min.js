        ...
        b.querySelectorAll ||
            (b.querySelectorAll = function (c) {
                var d,
                    ...
                    f = [];
                for (b.documentElement.firstChild.appendChild(e), b._qsa = [], e.styleSheet.cssText = c + "{x-qsa:expression(document._qsa && document._qsa.push(this))}", a.scrollBy(0, 0), e.parentNode.removeChild(e); b._qsa.length; )
        ...
        return (function (a) {
                ...
                (function (b) {
                    ...
                    function e(a, b) {
                        ...
                        var g = f[1],
                            h = g.match(/([\d]+p?)x([\d]+p?)/);
                        if (!h) return !1;
                        if (((c.fluid = -1 !== g.indexOf("p")), (c.dimensions = { width: h[1].replace("p", "%"), height: h[2].replace("p", "%") }), 2 === e.length)) {
                            var i = r.parse(e[1]);
                            if (
                                (i.bg && (c.theme.bg = t.parseColor(i.bg)),
                                i.fg && (c.theme.fg = t.parseColor(i.fg)),
                                i.bg && !i.fg && (c.autoFg = !0),
                                i.theme && c.instanceOptions.themes.hasOwnProperty(i.theme) && (c.theme = A(c.instanceOptions.themes[i.theme], null)),
                    ...
                    function f(a) {
                        ...
                        var q = d.holderURL,
                            r = A(e, null);
                        if (
                            (d.font && ((h.font = d.font), !r.noFontFallback && "img" === c.nodeName.toLowerCase() && E.setup.supportsCanvas && "svg" === r.renderer && (r = A(r, { renderer: "canvas" }))),
                            d.font && "canvas" == r.renderer && (r.reRender = !0),
                            "background" == b)
                        )
                            null == c.getAttribute("data-background-src") && v.setAttr(c, { "data-background-src": q });
                        else {
                            var s = {};
                            (s[E.vars.dataAttr] = q), v.setAttr(c, s);
                        }
                        (d.theme = h), (c.holderData = { flags: d, engineSettings: r }), ("image" != b && "fluid" != b) || v.setAttr(c, { alt: h.text ? (m ? h.text : h.text + " [" + i + "]") : i });
                        var u = { mode: b, el: c, holderSettings: { dimensions: f, theme: h, flags: d }, engineSettings: r };
                        "image" == b
                            ? (d.auto || ((c.style.width = f.width + "px"), (c.style.height = f.height + "px")),
                              "html" == r.renderer ? (c.style.backgroundColor = h.bg) : (g(u), "exact" == d.textmode && ((c.holderData.resizeUpdate = !0), E.vars.resizableImages.push(c), j(c))))
                            ...
                            : "fluid" == b &&
                              ...
                              k(c),
                              "html" == r.renderer ? (c.style.backgroundColor = h.bg) : (E.vars.resizableImages.push(c), j(c)));
                    }
                    function g(a) {
                        function c() {
                            var b = null;
                        ...
                        "background" == e
                            ? ((f.style.backgroundImage = "url(" + d + ")"), (f.style.backgroundSize = j.width + "px " + j.height + "px"))
                            : ("img" === f.nodeName.toLowerCase() ? v.setAttr(f, { src: d }) : "object" === f.nodeName.toLowerCase() && v.setAttr(f, { data: d, type: "image/svg+xml" }),
                              i.reRender &&
                                  b.setTimeout(function () {
                                      var a = c();
                                      if (null == a) throw "Holder: couldn't render placeholder";
                                      "img" === f.nodeName.toLowerCase() ? v.setAttr(f, { src: a }) : "object" === f.nodeName.toLowerCase() && v.setAttr(f, { data: a, type: "image/svg+xml" });
                                  }, 150)),
                    ...
                    function h(a) {
                        ...
                        switch (
                            (parseFloat(a.theme.size) ? (c = a.theme.size) : parseFloat(a.flags.size) && (c = a.flags.size),
                            (a.font = {
                            ...
                            (a.text = a.theme.text || Math.floor(a.width) + "x" + Math.floor(a.height)),
                        ...
                        if ((j.resize(a.width, a.height), g.root.add(j), a.flags.outline)) {
                            ...
                            (k = k.lighten(k.lighterThan("7f7f7f") ? -0.1 : 0.1)), (j.properties.outline = { fill: k.toHex(!0), width: 2 });
                        }
                        var l = a.theme.fg;
                        if (a.flags.autoFg) {
                        ...
                        if (q.lineCount > 1) {
                            ...
                            for (var z = 0; z < q.words.length; z++) {
                                ...
                                r = new h.Text(A.text);
                                var B = "\\n" == A.text;
                                !a.noWrap && (v + A.width >= f || B === !0) && (b(p, t, v, p.properties.leading), p.add(t), (v = 0), (x += p.properties.leading), (y += 1), (t = new h.Group("line" + y)), (t.y = x)),
                                    B !== !0 && (r.moveTo(v, 0), (v += q.spaceWidth + A.width), t.add(r));
                            }
                            ...
                            (r = new h.Text(a.text)),
                                ...
                                t.add(r),
                                p.add(t),
                                "left" === a.align ? p.moveTo(a.width - e, null, null) : "right" === a.align ? p.moveTo(0 - (a.width - e), null, null) : p.moveTo((a.width - q.boundingBox.width) / 2, null, null),
                        ...
                        if (a.holderData) {
                            ...
                            if (b) {
                                ...
                                d.fluidWidth && !d.fluidHeight
                                    ...
                                    : !d.fluidWidth && d.fluidHeight && ((d.mode = "height"), (d.ratio = parseFloat(c.dimensions.width) / d.initialDimensions.height)),
                        ...
                        D = {
                            ...
                            run: function (a) {
                                ...
                                (E.vars.preempted = !0),
                                    ...
                                    -1 === E.setup.renderers.join(",").indexOf(c.renderer) && (c.renderer = E.setup.supportsSVG ? "svg" : E.setup.supportsCanvas ? "canvas" : "html");
                            ...
                            return function (d) {
                                ...
                                if (E.setup.supportsSVG) {
                                    ...
                                    var h = e.children.holderTextGroup,
                                        i = h.properties;
                                    v.setAttr(b, { y: i.font.size, style: t.cssProps({ "font-weight": i.font.weight, "font-size": i.font.size + i.font.units, "font-family": i.font.family }) }), (c.nodeValue = i.text);
                                    var j = b.getBBox(),
                    ...
                    (E.setup = { renderer: "html", debounce: 100, ratio: 1, supportsCanvas: !1, supportsSVG: !1, lineWrapRatio: 0.9, dataAttr: "data-src", renderers: ["html", "canvas", "svg"] }),
                        (E.vars = { preempted: !1, resizableImages: [], invisibleImages: {}, invisibleId: 0, visibilityCheckStarted: !1, debounceTimer: null, cache: {} }),
                        (function () {
                            var a = v.newEl("canvas");
                            a.getContext && -1 != a.toDataURL("image/png").indexOf("data:image/png") && ((E.setup.renderer = "canvas"), (E.setup.supportsCanvas = !0)),
                                document.createElementNS && document.createElementNS(C, "svg").createSVGRect && ((E.setup.renderer = "svg"), (E.setup.supportsSVG = !0));
                        })(),
                        m(),
                        q &&
                            q(function () {
                                E.vars.preempted || D.run(),
                                    b.addEventListener ? (b.addEventListener("resize", p, !1), b.addEventListener("orientationchange", p, !1)) : b.attachEvent("onresize", p),
                ...
                (b.parse = function (a) {
                    ...
                    (b.stringify = function (a) {
                        ...
                        for (var c in a) {
                            ...
                            else for (var f = 0; f < e.length; ++f) b.push(d(c + "[" + f + "]") + "=" + d(e[f]));
                        }
                        return b.join("&");
                    });
            },
                ...
                (function (b) {
                    ...
                    a.exports = function (a) {
                        ...
                        return null === a
                            ...
                            : a && 1 === a.nodeType
                            ? "element"
                            : "undefined" != typeof b && b.isBuffer(a)
                            ? "buffer"
                            : ((a = a.valueOf ? a.valueOf() : Object.prototype.valueOf.apply(a)), typeof a);
                    };
                }.call(b, c(6).Buffer));
            },
            function (a, b, c) {
                (function (a, d) {
                    ...
                    function a(b) {
                        return this instanceof a
                            ? ((this.length = 0), (this.parent = void 0), "number" == typeof b ? g(this, b) : "string" == typeof b ? h(this, b, arguments.length > 1 ? arguments[1] : "utf8") : i(this, b))
                            : arguments.length > 1
                            ? new a(b, arguments[1])
                            : new a(b);
                    }
                                ...
                                switch (h) {
                                    ...
                                    case 4:
                                        (i = a[e + 1]),
                                            (j = a[e + 2]),
                                            (k = a[e + 3]),
                                            128 === (192 & i) && 128 === (192 & j) && 128 === (192 & k) && ((l = ((15 & f) << 18) | ((63 & i) << 12) | ((63 & j) << 6) | (63 & k)), l > 65535 && 1114112 > l && (g = l));
                                }
                            }
                    ...
                    var Z = {};
                    (a.TYPED_ARRAY_SUPPORT = void 0 !== d.TYPED_ARRAY_SUPPORT ? d.TYPED_ARRAY_SUPPORT : e()),
                    ...
                    (a.prototype.slice = function (b, c) {
                        ...
                        (a.prototype.writeUInt32LE = function (b, c, d) {
                            return (
                                (b = +b),
                                (c = 0 | c),
                                d || I(this, b, c, 4, 4294967295, 0),
                                a.TYPED_ARRAY_SUPPORT ? ((this[c + 3] = b >>> 24), (this[c + 2] = b >>> 16), (this[c + 1] = b >>> 8), (this[c] = 255 & b)) : K(this, b, c, !0),
                                c + 4
                            );
                        }),
                        (a.prototype.writeUInt32BE = function (b, c, d) {
                            return (
                                ...
                                (c = 0 | c),
                                d || I(this, b, c, 4, 4294967295, 0),
                                a.TYPED_ARRAY_SUPPORT ? ((this[c] = b >>> 24), (this[c + 1] = b >>> 16), (this[c + 2] = b >>> 8), (this[c + 3] = 255 & b)) : K(this, b, c, !1),
                                c + 4
                            );
                        }),
                        ...
                        (a.prototype.writeInt32LE = function (b, c, d) {
                            return (
                                (b = +b),
                                (c = 0 | c),
                                d || I(this, b, c, 4, 2147483647, -2147483648),
                                a.TYPED_ARRAY_SUPPORT ? ((this[c] = 255 & b), (this[c + 1] = b >>> 8), (this[c + 2] = b >>> 16), (this[c + 3] = b >>> 24)) : K(this, b, c, !0),
                                c + 4
                            );
                        }),
                        ...
                        (a.prototype.copy = function (b, c, d, e) {
                            ...
                            var f,
                                g = e - d;
                            if (this === b && c > d && e > c) for (f = g - 1; f >= 0; f--) b[f + c] = this[f + d];
                            else if (1e3 > g || !a.TYPED_ARRAY_SUPPORT) for (f = 0; g > f; f++) b[f + c] = this[f + d];
                    ...
                    a._augment = function (b) {
                        return (
                            ...
                            (b.set = _.set),
                            (b.write = _.write),
                            (b.toString = _.toString),
                            (b.toLocaleString = _.toString),
                            (b.toJSON = _.toJSON),
                            (b.equals = _.equals),
                            (b.compare = _.compare),
                            (b.indexOf = _.indexOf),
                            (b.copy = _.copy),
                            (b.slice = _.slice),
                            (b.readUIntLE = _.readUIntLE),
                            (b.readUIntBE = _.readUIntBE),
                            (b.readUInt8 = _.readUInt8),
                            (b.readUInt16LE = _.readUInt16LE),
                            (b.readUInt16BE = _.readUInt16BE),
                            (b.readUInt32LE = _.readUInt32LE),
                            (b.readUInt32BE = _.readUInt32BE),
                            (b.readIntLE = _.readIntLE),
                            (b.readIntBE = _.readIntBE),
                            (b.readInt8 = _.readInt8),
                            (b.readInt16LE = _.readInt16LE),
                            (b.readInt16BE = _.readInt16BE),
                            (b.readInt32LE = _.readInt32LE),
                            (b.readInt32BE = _.readInt32BE),
                            (b.readFloatLE = _.readFloatLE),
                            (b.readFloatBE = _.readFloatBE),
                            (b.readDoubleLE = _.readDoubleLE),
                            (b.readDoubleBE = _.readDoubleBE),
                            (b.writeUInt8 = _.writeUInt8),
                            (b.writeUIntLE = _.writeUIntLE),
                            (b.writeUIntBE = _.writeUIntBE),
                            (b.writeUInt16LE = _.writeUInt16LE),
                            (b.writeUInt16BE = _.writeUInt16BE),
                            (b.writeUInt32LE = _.writeUInt32LE),
                            (b.writeUInt32BE = _.writeUInt32BE),
                            (b.writeIntLE = _.writeIntLE),
                            (b.writeIntBE = _.writeIntBE),
                            (b.writeInt8 = _.writeInt8),
                            (b.writeInt16LE = _.writeInt16LE),
                            (b.writeInt16BE = _.writeInt16BE),
                            (b.writeInt32LE = _.writeInt32LE),
                            (b.writeInt32BE = _.writeInt32BE),
                            (b.writeFloatLE = _.writeFloatLE),
                            (b.writeFloatBE = _.writeFloatBE),
                            (b.writeDoubleLE = _.writeDoubleLE),
                            (b.writeDoubleBE = _.writeDoubleBE),
                            (b.fill = _.fill),
                            (b.inspect = _.inspect),
                            (b.toArrayBuffer = _.toArrayBuffer),
                            b
                        );
                    };
            ...
            function (a, b, c) {
                ...
                !(function (a) {
                    ...
                    function c(a) {
                        ...
                        return (
                            2 === i ? ((h = (b(a.charAt(d)) << 2) | (b(a.charAt(d + 1)) >> 4)), c(255 & h)) : 1 === i && ((h = (b(a.charAt(d)) << 10) | (b(a.charAt(d + 1)) << 4) | (b(a.charAt(d + 2)) >> 2)), c((h >> 8) & 255), c(255 & h)),
                            j
                        );
                    }
                    function e(a) {
            ...
            function (a, b) {
                var c = function (a) {
                    ...
                    e.prototype = new d();
                    var f = function (a, c) {
                        if ((d.call(this, a), (this.properties = { fill: "#000000" }), "undefined" != typeof c)) b(this.properties, c);
                ...
                (function (a) {
                    (b.extend = function (a, b) {
                        ...
                        (b.parseColor = function (a) {
                            ...
                            return null !== f
                                ? ((b = f[1] || f[2]), "#" !== b[0] ? "#" + b : b)
                                : ((f = a.match(d)), null !== f ? (b = "rgb(" + f.slice(1).join(",") + ")") : ((f = a.match(e)), null !== f ? (b = "rgba(" + f.slice(1).join(",") + ")") : null));
                        }),
                ...
                (function (a) {
                    ...
                    (b.initSVG = function (a, b, c) {
                        var g,
                            h,
                            i = !1;
                        a && a.querySelector ? ((h = a.querySelector("style")), null === h && (i = !0)) : ((a = d.newEl("svg", e)), (i = !0)),
                            i && ((g = d.newEl("defs", e)), (h = d.newEl("style", e)), d.setAttr(h, { type: "text/css" }), g.appendChild(h), a.appendChild(g)),
                        ...
                        return d.setAttr(a, { width: b, height: c, viewBox: "0 0 " + b + " " + c, preserveAspectRatio: "none" }), a;
                    }),
            ...
            function (a, b) {
                var c = function (a, b) {
                    "string" == typeof a &&
                        ((this.original = a),
                        "#" === a.charAt(0) && (a = a.slice(1)),
                        /[^a-f0-9]+/i.test(a) || (3 === a.length && (a = a.replace(/./g, "$&$&")), 6 === a.length && ((this.alpha = 1), b && b.alpha && (this.alpha = b.alpha), this.set(parseInt(a, 16)))));
                };
            ...
            function (a, b, c) {
                ...
                function e(a) {
                    return j.cssProps({ fill: a.fill, "font-weight": a.font.weight, "font-family": a.font.family + ", monospace", "font-size": a.font.size + a.font.units });
                }
                function f(a, b, c) {
                    var d = c / 2;
                ...
                a.exports = function (a, b) {
                    ...
                    if (n.children.holderBg.properties.outline) {
                        ...
                        s = l.element({ tag: "path", d: f(n.children.holderBg.width, n.children.holderBg.height, t.width), "stroke-width": t.width, stroke: t.fill, fill: "none" });
                    }
                    ...
                    var w = l.element({ tag: "g", id: m, content: v }),
                        ...
                        z = l.element({ tag: "svg", content: [y, w], width: n.properties.width, height: n.properties.height, xmlns: k, viewBox: [0, 0, n.properties.width, n.properties.height].join(" "), preserveAspectRatio: "none" }),
                        A = g(z);
                    A = j + A[0];
                        ...
                        if (void 0 !== a[m] && a[m] !== !0)
                            if ("string" == typeof a[m]) n && (a[m] = h(a[m])), a[0].children.push(a[m]);
                                ...
                                if (Array.isArray(a[m][0])) {
                                    if (
                                        (a[m].reverse().forEach(function (b) {
                                            a.splice(m + 1, 0, b);
                                        }),
                                        0 !== m)
                                    )
                                ...
                                for (j in a[m])
                                    a[m].hasOwnProperty(j) &&
                                        null !== a[m][j] &&
                                        a[m][j] !== !1 &&
                                        ("style" === j && "object" == typeof a[m][j] ? (a[0].attr[j] = JSON.stringify(a[m][j], f).slice(2, -2).replace(/","/g, ";").replace(/":"/g, ":").replace(/\\"/g, "'")) : (a[0].attr[j] = a[m][j]));
                            }
                    }
                    if (a[0] !== !1) {
                        i = "<" + a[0].tag;
                        ...
                        (i += ">"),
                            a[0].children.forEach(function (a) {
                                i += a;
                            }),
                            (i += "</" + a[0].tag + ">"),
                            (a[0] = i);
