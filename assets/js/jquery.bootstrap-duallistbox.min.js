...
!(function (a, b, c, d) {
        ...
        if (b.settings.showFilterInputs) {
            ...
            (f = 1 === c ? e.not(":selected") : f.find("option:selected")),
                f.each(function (f, g) {
                    var h = a(g),
                        i = !0;
                    (g.text.match(d) || (b.settings.filterOnValues && h.attr("value").match(d))) && ((i = !1), b.elements["select" + c].append(h.clone(!0).prop("selected", h.data("_selected")))),
    ...
    function p(b) {
        "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect ? "moved" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect || m(b, 1) : (m(b, 1), m(b, 2)),
    ...
    function q(b) {
        "all" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect ? "moved" !== b.settings.preserveSelectionOnMove || b.settings.moveOnSelect || m(b, 2) : (m(b, 1), m(b, 2)),
    ...
    (e.prototype = {
            ...
            return (
                ...
                a
                    ...
                    : (this.container.removeClass("row-fluid bs2compatible").addClass("row"),
                      ...
                      this.container.find(".btn").addClass(this.settings.buttonClass),
        ...
        setHelperSelectNamePostfix: function (a, b) {
            return (
                ...
                a
                    ? (this.elements.select1.attr("name", this.originalSelectName + a + "1"), this.elements.select2.attr("name", this.originalSelectName + a + "2"))
        ...
        setShowFilterInputs: function (a, b) {
            return (
                a ? (this.elements.filterInput1.show(), this.elements.filterInput2.show()) : (this.setNonSelectedFilter(""), this.setSelectedFilter(""), k(this), this.elements.filterInput1.hide(), this.elements.filterInput2.hide()),
        ...
        (a.fn[u] = function (b) {
            ...
            if (b === d || "object" == typeof b)
                return this.each(function () {
                    a(this).is("select")
                        ? a.data(this, "plugin_" + u) || a.data(this, "plugin_" + u, new e(this, b))
                        : a(this)
                              .find("select")
                              .each(function (c, d) {
