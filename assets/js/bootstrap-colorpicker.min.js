    ...
    var c = {
        ...
        d = function (d, e) {
            if (
                ...
                (this.color = new b(this.options.color !== !1 ? this.options.color : this.getValue(), this.options.colorSelectors)),
                ...
                ("rgba" !== this.format && "hsla" !== this.format && this.options.format !== !1) || this.picker.addClass("colorpicker-with-alpha"),
        ...
        (d.prototype = {
            ...
            show: function (b) {
                return this.isDisabled()
                    ...
                    : (this.picker.addClass("colorpicker-visible").removeClass("colorpicker-hidden"),
                      ...
                      !b || (this.hasInput() && "color" !== this.input.attr("type")) || (b.stopPropagation && b.preventDefault && (b.stopPropagation(), b.preventDefault())),
            ...
            updatePicker: function (a) {
                ...
                return 0 !== d.length
                    ? (this.options.horizontal === !1
                      ...
                      d.eq(0).css({ top: c.saturation.maxTop - this.color.value.b * c.saturation.maxTop, left: this.color.value.s * c.saturation.maxLeft }),
            ...
            keyup: function (a) {
                38 === a.keyCode
                    ...
                    : 40 === a.keyCode
                    ? (this.color.value.a > 0 && (this.color.value.a = Math.round(100 * (this.color.value.a - 0.01)) / 100), this.update(!0))
                    : ((this.color = new b(this.input.val(), this.options.colorSelectors)),
