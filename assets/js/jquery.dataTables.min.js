...
!(function (a) {
    ...
    function j(b) {
        if (!Ua.__browser) {
            ...
            (c.barWidth = e[0].offsetWidth - e[0].clientWidth),
                ...
                (c.bBounding = !!d[0].getBoundingClientRect().width),
                d.remove();
        }
    ...
    function l(b, d) {
        var e = Ua.defaults.column,
            ...
            g = a.extend({}, Ua.models.oColumn, e, { nTh: d ? d : c.createElement("th"), sTitle: e.sTitle ? e.sTitle : d ? d.innerHTML : "", aDataSort: e.aDataSort ? e.aDataSort : [f], mData: e.mData ? e.mData : f, idx: f });
        b.aoColumns.push(g);
        ...
        if (c)
            for (g = c.length - 1; g >= 0; g--) {
                ...
                for (a.isArray(p) || (p = [p]), i = 0, j = p.length; j > i; i++)
                    ...
                    else if ("string" == typeof p[i]) for (k = 0, m = o.length; m > k; k++) ("_all" == p[i] || a(o[k].nTh).hasClass(p[i])) && f(k, n);
            }
        ...
        var c = function (b, e, f) {
            for (var g, h, i, j, k, l = A(f), m = l[l.length - 1], n = 0, o = l.length - 1; o > n; n++) {
                if (((h = l[n].match(rb)), (i = l[n].match(sb)), h)) {
                    if (((l[n] = l[n].replace(rb, "")), (b[l[n]] = []), (g = l.slice()), g.splice(0, n + 1), (k = g.join(".")), a.isArray(e))) for (var p = 0, q = e.length; q > p; p++) (j = {}), c(j, e[p], k), b[l[n]].push(j);
                    else b[l[n]] = e;
                    return;
                }
    ...
    function K(b) {
        ...
        for (j && (f = a("<tr/>").appendTo(h)), c = 0, d = l.length; d > c; c++)
            (g = l[c]),
                ...
                j && e.appendTo(f),
                b.oFeatures.bSort && (e.addClass(g.sSortingClass), g.bSortable !== !1 && (e.attr("tabindex", b.iTabIndex).attr("aria-controls", b.sTableId), Ca(b, g.nTh, c))),
    ...
    function M(b) {
        ...
        if (0 !== l.length)
            ...
            1 == b.iDraw && "ajax" == Qa(b) ? (w = i.sLoadingRecords) : i.sEmptyTable && 0 === b.fnRecordsTotal() && (w = i.sEmptyTable),
                (e[0] = a("<tr/>", { class: h ? g[0] : "" }).append(a("<td />", { valign: "top", colSpan: q(b), class: b.oClasses.sRowEmpty }).html(w))[0]);
        }
            ...
            for (d = o[f], k = 0, e = d.firstChild; e; ) {
                if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase())
                    for (l = 1 * e.getAttribute("colspan"), m = 1 * e.getAttribute("rowspan"), l = l && 0 !== l && 1 !== l ? l : 1, m = m && 0 !== m && 1 !== m ? m : 1, j = p(b, f, k), n = 1 === l, h = 0; l > h; h++)
                        for (g = 0; m > g; g++) (b[f + g][j + h] = { cell: e, unique: n }), (b[f + g].nTr = d);
                e = e.nextSibling;
            }
    }
    function Q(a, b, c) {
    ...
    function T(b) {
        ...
        var q = { draw: b.iDraw, columns: [], order: [], start: n, length: o, search: { value: j.sSearch, regex: j.bRegex } };
        for (c = 0; h > c; c++)
            (e = g[c]),
                (f = k[c]),
                (d = "function" == typeof e.mData ? "function" : e.mData),
                q.columns.push({ data: d, name: e.sName, searchable: e.bSearchable, orderable: e.bSortable, search: { value: f.sSearch, regex: f.bRegex } }),
                p("mDataProp_" + c, d),
                i.bFilter && (p("sSearch_" + c, f.sSearch), p("bRegex_" + c, f.bRegex), p("bSearchable_" + c, e.bSearchable)),
    ...
    function W(b) {
        ...
        var k = a("<div/>", { id: h.f ? null : e + "_filter", class: d.sFilter }).append(a("<label/>").append(j)),
            l = function () {
                ...
                a != g.sSearch && (X(b, { sSearch: a, bRegex: g.bRegex, bSmart: g.bSmart, bCaseInsensitive: g.bCaseInsensitive }), (b._iDisplayStart = 0), M(b));
            },
            ...
            if (((i = a.aoData[c]), !i._aFilterData)) {
                for (g = [], d = 0, f = j.length; f > d; d++)
                    (b = j[d]),
                        ...
                        h.indexOf && -1 !== h.indexOf("&") && ((tb.innerHTML = h), (h = ub ? tb.textContent : tb.innerText)),
    ...
    function ea(b) {
        ...
        return d || (b.aoDrawCallback.push({ fn: fa, sName: "information" }), e.attr("role", "status").attr("aria-live", "polite"), a(b.nTable).attr("aria-describedby", c + "_info")), e[0];
    }
    function fa(b) {
    ...
    function ka(b) {
        for (
            var c = b.oClasses, d = b.sTableId, e = b.aLengthMenu, f = a.isArray(e[0]), g = f ? e[0] : e, h = f ? e[1] : e, i = a("<select/>", { name: d + "_length", "aria-controls": d, class: c.sLengthSelect }), j = 0, k = g.length;
            k > j;
            j++
        )
    ...
    function ma(a, b, c) {
        ...
        0 === f || -1 === e
            ...
            : Ia(a, 0, "Unknown paging action: " + b, 5);
    ...
    function pa(b) {
        ...
        return (
            ...
            (b.nScrollBody = r),
            (b.nScrollFoot = s),
            b.aoDrawCallback.push({ fn: qa, sName: "scrolling" }),
            o[0]
        );
    }
    function qa(b) {
        ...
        (b.scrollBarVis = S),
            ...
            (l = F.outerWidth()),
            "" === p
                ? ((H.width = "100%"), K && (F.find("tbody").height() > y.offsetHeight || "scroll" == z.css("overflow-y")) && (H.width = xa(F.outerWidth() - s)), (l = F.outerWidth()))
                : "" !== q && ((H.width = xa(q)), (l = F.outerWidth())),
            ra(R, f),
            ra(function (b) {
            ...
            F.outerWidth() < l
                ? ((k = y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y") ? l + s : l),
                  K && (y.scrollHeight > y.offsetHeight || "scroll" == z.css("overflow-y")) && (H.width = xa(k - s)),
                  ("" !== p && "" === q) || Ia(b, 1, "Possible column misalignment", 6))
                : (k = "100%"),
            (A.width = xa(k)),
            (u.width = xa(k)),
    ...
    function sa(c) {
        ...
        if (x || (!v && !k && !j && m == q(c) && m == s.length))
            ...
            for (A.find("thead, tfoot").remove(), A.append(a(c.nTHead).clone()).append(a(c.nTFoot).clone()), A.find("tfoot th, tfoot td").css("width", ""), s = Q(c, A.find("thead")[0]), d = 0; d < p.length; d++)
                (e = h[p[d]]),
                    (s[d].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? xa(e.sWidthOrig) : ""),
                    e.sWidthOrig && k && a(s[d]).append(a("<div/>").css({ width: e.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
            ...
            var C = a("<div/>")
                .css(k || j ? { position: "absolute", top: 0, left: 0, height: 1, right: 0, overflow: "hidden" } : {})
                .append(A)
                .appendTo(u);
    ...
    function ya(b) {
        ...
        for (a.isArray(m) && p(m), n && m.pre && p(m.pre), p(b.aaSorting), n && m.post && p(m.post), c = 0; c < o.length; c++)
            for (j = o[c][0], g = l[j].aDataSort, e = 0, f = g.length; f > e; e++)
                (h = g[e]), (i = l[h].sType || "string"), o[c]._idx === d && (o[c]._idx = a.inArray(o[c][1], l[h].asSorting)), k.push({ src: j, col: h, dir: o[c][1], index: o[c]._idx, type: i, formatter: Ua.ext.type.order[i + "-pre"] });
        return k;
    }
    function za(a) {
        var b,
            ...
            if (h && h.time) {
                ...
                if (-1 === a.inArray(!1, i)) {
                    ...
                    if (!(j > 0 && h.time < +new Date() - 1e3 * j) && g.length === h.columns.length) {
                        for (
                            b.oLoadedState = a.extend(!0, {}, h),
                                h.start !== d && ((b._iDisplayStart = h.start), (b.iInitDisplayStart = h.start)),
                                h.length !== d && (b._iDisplayLength = h.length),
                                h.order !== d &&
                                    ((b.aaSorting = []),
                                    a.each(h.order, function (a, c) {
                                        b.aaSorting.push(c[0] >= g.length ? [0, c[1]] : c);
                                    })),
                                h.search !== d && a.extend(b.oPreviousSearch, da(h.search)),
                                e = 0,
                                f = h.columns.length;
                            f > e;
                            e++
    ...
    function Ra(a, b) {
        ...
        return (
            d >= b
                ? (c = mb(0, b))
                : e >= a
                ? ((c = mb(0, d - 2)), c.push("ellipsis"), c.push(b - 1))
                : a >= b - 1 - e
                ? ((c = mb(b - (d - 2), b)), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0))
                : ((c = mb(a - e + 2, a + e - 1)), c.push("ellipsis"), c.push(b - 1), c.splice(0, 0, "ellipsis"), c.splice(0, 0, 0)),
            (c.DT_el = "span"),
            c
        );
    }
    ...
    Ua = function (b) {
        ...
        return (
            this.each(function () {
                ...
                if (
                    (p.bJQueryUI
                        ? (a.extend(E, Ua.ext.oJUIClasses, p.oClasses),
                          p.sDom === w.sDom && "lfrtip" === w.sDom && (D.sDom = '<"H"lfr>t<"F"ip>'),
                          D.renderer ? a.isPlainObject(D.renderer) && !D.renderer.header && (D.renderer.header = "jqueryui") : (D.renderer = "jqueryui"))
                        : a.extend(E, Ua.ext.classes, p.oClasses),
                    x.addClass(E.sTable),
                ...
                if ((0 !== L.length && (P(D.aoHeader, L[0]), (K = Q(D))), null === p.aoColumns)) for (J = [], q = 0, n = K.length; n > q; q++) J.push(null);
                else J = p.aoColumns;
                    ...
                    a(I[0])
                        ...
                        .each(function (a, b) {
                            ...
                            if (c.mData === a) {
                                ...
                                (null === e && null === f) || ((c.mData = { _: a + ".display", sort: null !== e ? a + ".@data-" + e : d, type: null !== e ? a + ".@data-" + e : d, filter: null !== f ? a + ".@data-" + f : d }), m(D, a));
                            }
                        });
                }
                var N = D.oFeatures;
                ...
                if (
                    (0 === U.length && R.length > 0 && ("" !== D.oScroll.sX || "" !== D.oScroll.sY) && (U = a("<tfoot/>").appendTo(this)),
                    0 === U.length || 0 === U.children().length ? x.addClass(E.sNoFooter) : U.length > 0 && ((D.nTFoot = U[0]), P(D.aoFooter, D.nTFoot)),
                    p.aaData)
                )
    ...
    (Wa = function (b, c) {
        ...
        (this.context = pb(d)), c && a.merge(this, c), (this.selector = { rows: null, cols: null, opts: null }), Wa.extend(this, this, wb);
    }),
        (Ua.Api = Wa),
        a.extend(Wa.prototype, {
            ...
            filter: function (a) {
                ...
                else for (var c = 0, d = this.length; d > c; c++) a.call(this, this[c], c, this) && b.push(this[c]);
            ...
            map: function (a) {
                ...
                else for (var c = 0, d = this.length; d > c; c++) b.push(a.call(this, this[c], c));
                return new Wa(this.context, b);
            },
            pluck: function (a) {
        ...
        (Wa.register = Xa = function (b, c) {
            if (a.isArray(b)) for (var d = 0, e = b.length; e > d; d++) Wa.register(b[d], c);
            else {
                var f,
                    g,
                    h,
                ...
                for (f = 0, g = j.length; g > f; f++) {
                    ...
                    var m = l(k, h);
                    m || ((m = { name: h, val: {}, methodExt: [], propExt: [] }), k.push(m)), f === g - 1 ? (m.val = c) : (k = i ? m.methodExt : m.propExt);
                }
            }
        }),
    ...
    Xa("tables()", function (a) {
        ...
        Xa("page.info()", function (a) {
            ...
            var b = this.context[0],
                ...
                g = -1 === e;
            return { page: g ? 0 : Math.floor(c / e), pages: g ? 1 : Math.ceil(f / e), start: c, end: b.fnDisplayEnd(), length: e, recordsTotal: b.fnRecordsTotal(), recordsDisplay: f, serverSide: "ssp" === Qa(b) };
        }),
    ...
    var Bb = function (b, c, e, f, g) {
        ...
        Eb = function (b, c) {
            ...
            if ("current" == l) for (d = b._iDisplayStart, e = b.fnDisplayEnd(); e > d; d++) g.push(h[d]);
    ...
    var Gb = function (b, c, d, e) {
            var f = [],
                g = function (c, d) {
                    if (a.isArray(c) || c instanceof a) for (var e = 0, h = c.length; h > e; e++) g(c[e], d);
    ...
    var Rb = function (b, c, e) {
        var f,
            ...
            r = function (c) {
                ...
                if (null === c || c === d || e) {
                    for (g = [], h = 0, i = n.length; i > h; h++) for (f = n[h], j = 0; q > j; j++) (k = { row: f, column: j }), e ? ((l = m[f]), c(k, y(b, f, j), l.anCells ? l.anCells[j] : null) && g.push(k)) : g.push(k);
                    return g;
                }
                ...
                var o = p
                    ...
                    .toArray();
                return o.length || !c.nodeName ? o : ((l = a(c).closest("*[data-dt-row]")), l.length ? [{ row: l.data("dt-row"), column: l.data("dt-column") }] : []);
            };
    ...
    Xa("cells()", function (b, c, e) {
        ...
        var f,
            ...
            m = this.iterator(
                "table",
                function (a, b) {
                    for (f = [], g = 0, h = l[b].length; h > g; g++) for (i = 0, j = k[b].length; j > i; i++) f.push({ row: l[b][g], column: k[b][i] });
                    return f;
                },
                1
            );
        ...
        Xa("order()", function (b, c) {
            ...
            return b === d
                ? 0 !== e.length
                    ? e[0].aaSorting
                    : d
                : ("number" == typeof b ? (b = [[b, c]]) : a.isArray(b[0]) || (b = Array.prototype.slice.call(arguments)),
                  this.iterator("table", function (a) {
                      a.aaSorting = b.slice();
                  }));
        }),
        ...
        Xa("search()", function (b, c, e, f) {
            ...
            return b === d
                ...
                : this.iterator("table", function (d) {
                      d.oFeatures.bFilter && X(d, a.extend({}, d.oPreviousSearch, { sSearch: b + "", bRegex: null === c ? !1 : c, bSmart: null === e ? !0 : e, bCaseInsensitive: null === f ? !0 : f }), 1);
                  });
        }),
        Ya("columns().search()", "column().search()", function (b, c, e, f) {
            return this.iterator("column", function (g, h) {
                ...
                return b === d
                    ? i[h].sSearch
                    : void (g.oFeatures.bFilter && (a.extend(i[h], { sSearch: b + "", bRegex: null === c ? !1 : c, bSmart: null === e ? !0 : e, bCaseInsensitive: null === f ? !0 : f }), X(g, g.oPreviousSearch, 1)));
            });
        }),
        Xa("state()", function () {
        ...
        (Ua.util = { throttle: ta, escapeRegex: aa }),
            ...
            return (
                ...
                this.iterator("table", function (d) {
                    ...
                    (d.bDestroying = !0),
                        ...
                        d.bJUI &&
                            (a("th span." + g.sSortIcon + ", td span." + g.sSortIcon, j).detach(),
        ...
        a.extend(Va, { afnFiltering: Va.search, aTypes: Va.type.detect, ofnSearch: Va.type.search, oSort: Va.type.order, afnSortData: Va.order, aoFeatures: Va.feature, oApi: Va.internal, oStdClasses: Va.classes, oPagination: Va.pager }),
                            ...
                            if (b === f) {
                                ...
                                c.removeClass(e.sSortAsc + " " + e.sSortDesc).addClass("asc" == h[i] ? e.sSortAsc : "desc" == h[i] ? e.sSortDesc : d.sSortingClass),
                                    c
                                        ...
                                        .addClass("asc" == h[i] ? e.sSortJUIAsc : "desc" == h[i] ? e.sSortJUIDesc : d.sSortingClassJUI);
                            }
                        });
                },
            },
