        ...
        var e,
            ...
            x = function (a) {
                var c,
                    ...
                    i = !1;
                return (
                    void 0 !== b.tz && void 0 !== d.timeZone && null !== d.timeZone && "" !== d.timeZone && (i = !0),
                    void 0 === a || null === a
                        ? (c = i ? b().tz(d.timeZone).startOf("d") : b().startOf("d"))
                        : i
                        ? ((e = b().tz(d.timeZone).utcOffset()),
                          (f = b(a, j, d.useStrict).utcOffset()),
                          f !== e ? ((g = b().tz(d.timeZone).format("Z")), (h = b(a, j, d.useStrict).format("YYYY-MM-DD[T]HH:mm:ss") + g), (c = b(h, j, d.useStrict).tz(d.timeZone))) : (c = b(a, j, d.useStrict).tz(d.timeZone)))
                        : (c = b(a, j, d.useStrict)),
                    c
                );
            },
            ...
            C = function () {
                ...
                return (
                    ...
                    y("m") &&
                        (y("h") && (b.append(a("<td>").addClass("separator")), c.append(a("<td>").addClass("separator").html(":")), e.append(a("<td>").addClass("separator"))),
                    ...
                    y("s") &&
                        (y("m") && (b.append(a("<td>").addClass("separator")), c.append(a("<td>").addClass("separator").html(":")), e.append(a("<td>").addClass("separator"))),
            ...
            V = function () {
                ...
                if (A()) {
                    for (
                        ...
                        0 === b.weekday() && ((c = a("<tr>")), d.calendarWeeks && c.append('<td class="cw">' + b.week() + "</td>"), k.push(c)),
                            (g = ""),
            ...
            _ = function (a) {
                ...
                return a
                    ? ((a = a.clone().locale(d.locale)),
                      ...
                      void (Q(a)
                          ? ((e = a), (f = e.clone()), g.val(e.format(i)), c.data("date", e.format(i)), (m = !1), $(), I({ type: "dp.change", date: e.clone(), oldDate: b }))
                          : (d.keepInvalid || g.val(m ? "" : e.format(i)), I({ type: "dp.error", date: a }))))
            ...
            ea = function () {
                ...
                return g.prop("disabled") || (!d.ignoreReadonly && g.prop("readonly")) || o
                    ...
                    : (void 0 !== g.val() && 0 !== g.val().trim().length
                          ? _(ga(g.val().trim()))
                          : d.useCurrent && m && ((g.is("input") && 0 === g.val().trim().length) || d.inline) && ((b = x()), "string" == typeof d.useCurrent && (b = c[d.useCurrent](b)), _(b)),
                      (o = F()),
                      L(),
                      R(),
