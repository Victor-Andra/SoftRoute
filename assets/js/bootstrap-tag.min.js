...
!(function (a) {
    ...
    var b = function (b, c) {
        (this.element = a(b)),
            (this.options = a.extend(!0, {}, a.fn.tag.defaults, c)),
            (this.values = a.grep(a.map(this.element.val().split(","), a.trim), function (a) {
                return a.length > 0;
            })),
            this.show();
    };
    b.prototype = {
        ...
        show: function () {
            ...
            b.element.parent().prepend(b.element.detach().hide()),
                b.element
                    .wrap(a('<div class="tags">'))
                    .parent()
                    .on("click", function () {
                        b.input.focus();
                    }),
                b.values.length &&
                    a.each(b.values, function () {
                        b.createBadge(this);
                    }),
                (b.input = a('<input type="text">')
                    .attr("placeholder", b.options.placeholder)
                    ...
                    .on("keydown", function (c) {
                        if (188 == c.keyCode || 13 == c.keyCode || 9 == c.keyCode)
                            !a.trim(a(this).val()) || (b.element.siblings(".typeahead").length && !b.element.siblings(".typeahead").is(":hidden"))
                                ? 188 == c.keyCode &&
                                  (b.options.autocompleteOnComma
                                      ? !b.element.siblings(".typeahead").length || b.element.siblings(".typeahead").is(":hidden")
                                          ? c.preventDefault()
                                          : (b.input.data("bs_typeahead").select(), c.stopPropagation(), c.preventDefault())
                                      : (c.preventDefault(), b.process()))
                                : (9 != c.keyCode && c.preventDefault(), b.process());
        ...
        inValues: function (b) {
            if (this.options.caseInsensitive) {
                var c = -1;
                return (
                    a.each(this.values, function (a, d) {
        ...
        createBadge: function (b) {
            ...
            a("<span/>", { class: "tag" })
                .text(b.toString())
                .append(
                    a('<button type="button" class="close">&times;</button>').on("click", function () {
    ...
    (a.fn.tag = function (c) {
        ...
        (a.fn.tag.defaults = { allowDuplicates: !1, caseInsensitive: !0, autocompleteOnComma: !1, placeholder: "", source: [] }),
