!(function () {
    "ace" in window || (window.ace = {}),
        (ace.config = { storage_method: 0, cookie_expiry: 604800, cookie_path: "" }),
        ...
        (ace.data_storage = function (a, b) {
            var c = "ace_",
                d = null,
                e = 0;
            (1 == a || a === b || 0 == a) && "localStorage" in window && null !== window.localStorage
                ? ((d = ace.storage), (e = 1))
                : null == d && (2 == a || a === b) && "cookie" in document && null !== document.cookie && ((d = ace.cookie), (e = 2)),
