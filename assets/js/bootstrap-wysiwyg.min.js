        ...
        (a.fn.wysiwyg = function (c) {
            var d,
                ...
                p = function (b, c) {
                    ...
                    b
                        .find("input[type=text][data-" + c.commandRole + "]")
            ...
            return (
                (e = a.extend({}, a.fn.wysiwyg.defaults, c)),
                (f = "a[data-" + e.commandRole + "],button[data-" + e.commandRole + "],input[type=button][data-" + e.commandRole + "]"),
                j(e.hotKeys),
                e.dragAndDropImages && q(),
                p(a(e.toolbarSelector), e),
                g.attr("contenteditable", !0).on("mouseup keyup mouseout", function () {
                    l(), h();
                }),
