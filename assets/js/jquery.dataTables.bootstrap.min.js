...
$.extend(!0, $.fn.dataTable.defaults, { sDom: "<'row'<'col-xs-6'l><'col-xs-6'f>r>t<'row'<'col-xs-6'i><'col-xs-6'p>>", oLanguage: { sLengthMenu: "Display _MENU_ records" } }),
          ...
          $.extend($.fn.dataTableExt.oPagination, {
              bootstrap: {
                  fnInit: function (a, b, c) {
                      ...
                      $(b).append(
                          '<ul class="pagination"><li class="prev disabled"><a href="#"><i class="fa fa-angle-double-left"></i></a></li><li class="prev disabled"><a href="#"><i class="fa fa-angle-left"></i></a></li><li class="next disabled"><a href="#"><i class="fa fa-angle-right"></i></a></li><li class="next disabled"><a href="#"><i class="fa fa-angle-double-right"></i></a></li></ul>'
                      );
                      var e = $("a", b);
                  ...
                  fnUpdate: function (a, b) {
                      var c,
                          ...
                          l = Math.floor(i / 2);
                      for (
                          j.iTotalPages < i ? ((g = 1), (h = j.iTotalPages)) : j.iPage <= l ? ((g = 1), (h = i)) : j.iPage >= j.iTotalPages - l ? ((g = j.iTotalPages - i + 1), (h = j.iTotalPages)) : ((g = j.iPage - l + 1), (h = g + i - 1)),
                              c = 0,
                              d = k.length;
                          d > c;
                          c++
                          ...
                          for ($("li:gt(0)", k[c]).filter(":not(.next,.prev)").remove(), e = g; h >= e; e++)
                              (f = e == j.iPage + 1 ? 'class="active"' : ""),
                                  $("<li " + f + '><a href="#">' + e + "</a></li>")
                                      .insertBefore($("li.next:eq(0)", k[c])[0])
