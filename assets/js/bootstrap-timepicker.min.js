...
!(function (a, b, c) {
    ...
    (d.prototype = {
        ...
        _init: function () {
            var b = this;
            this.showWidgetOnAddonClick && this.$element.parent().hasClass("input-group") && this.$element.parent().hasClass("bootstrap-timepicker")
                ? (this.$element
        ...
        getTemplate: function () {
            ...
            switch (
                ...
                (f =
                    ...
                    this.icons.up +
                    '"></span></a></td>' +
                    (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="incrementSecond"><span class="' + this.icons.up + '"></span></a></td>' : "") +
                    (this.showMeridian ? '<td class="separator">&nbsp;</td><td class="meridian-column"><a href="#" data-action="toggleMeridian"><span class="' + this.icons.up + '"></span></a></td>' : "") +
                    "</tr><tr><td>" +
                    b +
                    ...
                    this.icons.down +
                    '"></span></a></td>' +
                    (this.showSeconds ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="decrementSecond"><span class="' + this.icons.down + '"></span></a></td>' : "") +
                    (this.showMeridian ? '<td class="separator">&nbsp;</td><td><a href="#" data-action="toggleMeridian"><span class="' + this.icons.down + '"></span></a></td>' : "") +
                    "</tr></table>"),
                this.template)
            ) {
                case "modal":
            ...
            if (!this.isInline) {
                ...
                this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"),
                    "auto" !== this.orientation.x
                        ? (this.$widget.addClass("timepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (m -= c - l))
        ...
        setDefaultTime: function (a) {
            if (this.$element.val()) this.updateFromElementVal();
                ...
                var b = new Date(),
                    ...
                    e = b.getSeconds(),
                    f = "AM";
                0 !== e && ((e = Math.ceil(b.getSeconds() / this.secondStep) * this.secondStep), 60 === e && ((d += 1), (e = 0))),
                    0 !== d && ((d = Math.ceil(b.getMinutes() / this.minuteStep) * this.minuteStep), 60 === d && ((c += 1), (d = 0))),
        ...
        setTime: function (a, b) {
            ...
            if ("object" == typeof a && a.getMonth) (e = a.getHours()), (f = a.getMinutes()), (g = a.getSeconds()), this.showMeridian && ((h = "AM"), e > 12 && ((h = "PM"), (e %= 12)), 12 === e && (h = "PM"));
                ...
                (f = d[1] ? d[1].toString() : ""),
                    ...
                    this.showMeridian
                        ? (e > 12 && ((c = 2), (e -= 12)), c || (c = 1), 0 === e && (e = 12), (h = 1 === c ? "AM" : "PM"))
                        : 12 > e && 2 === c
                        ? (e += 12)
                        : e >= this.maxHours
                        ? (e = this.maxHours - 1)
            ...
            (this.hour = e),
                this.snapToStep ? ((this.minute = this.changeToNearestStep(f, this.minuteStep)), (this.second = this.changeToNearestStep(g, this.secondStep))) : ((this.minute = f), (this.second = g)),
                (this.meridian = h),
                this.update(b);
        },
        showWidget: function () {
