...
!(function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
        a.extend(b.prototype, {
            ...
            render: function () {
                ...
                (this.$input = this.$tpl.find("input[type=hidden]:eq(0)")),
                    ...
                    (this.options.image.before_remove =
                        this.options.image.before_remove ||
                        function () {
        ...
        (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, {
            ...
            inputclass: "",
            image: { style: "well", btn_choose: "Change Image", btn_change: null, no_icon: "fa fa-picture-o", thumbnail: "large" },
        })),
                ...
                render: function () {
                    (this.$editor = this.$input.nextAll(".wysiwyg-editor:eq(0)")),
                        this.$tpl
                            ...
                            .find(".wysiwyg-editor")
                            .show()
                            .ace_wysiwyg(this.options.wysiwyg)
                            .prev()
                            .addClass("wysiwyg-style2")
                            .closest(".editable-input")
                            .addClass("editable-wysiwyg")
                            .closest(".editable-container")
                            .css({ display: "block" }),
    ...
    (function (a) {
        ...
        a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput),
                    ...
                    if (this.$input.is(":visible"))
                        if ((this.$input.focus(), a.fn.editableutils.setCursorPosition(this.$input.get(0), this.$input.val().length), this.nativeUI)) {
                            ...
                            var d = parseInt(this.$input.val()),
                                b = a.extend({ value: d }, this.options.spinner);
            ...
            (b.defaults = a.extend({}, a.fn.editabletypes.abstractinput.defaults, {
                tpl: '<input type="text" />',
                inputclass: "",
                spinner: { min: 0, max: 100, step: 1, icon_up: "fa fa-plus", icon_down: "fa fa-minus", btn_up_class: "btn-success", btn_down_class: "btn-danger" },
            })),
                            ...
                            var e = this,
                                ...
                                b = a.extend(this.options.slider, {
                                    ...
                                    slide: function (b, c) {
                                        ...
                                        e.$input.val(d),
                                            null == c.handle.firstChild &&
                                                a(c.handle).prepend("<div class='tooltip top in' style='display:none; top:-38px; left:-5px;'><div class='tooltip-arrow'></div><div class='tooltip-inner'></div></div>"),
