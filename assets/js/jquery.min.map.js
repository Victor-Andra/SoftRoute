        ...
        function c(c, e, f, g) {
            ...
            function j(b) {
                a.extend(!0, ea, b),
                    ...
                    null == ea.xaxis.color && (ea.xaxis.color = a.color.parse(ea.grid.color).scale("a", 0.22).toString()),
                    null == ea.yaxis.color && (ea.yaxis.color = a.color.parse(ea.grid.color).scale("a", 0.22).toString()),
                    ...
                    null == ea.grid.tickColor && (ea.grid.tickColor = a.color.parse(ea.grid.color).scale("a", 0.22).toString());
                var d,
                    e,
                    f,
                    g = c.css("font-size"),
                    i = g ? +g.replace("px", "") : 13,
                    j = { style: c.css("font-style"), size: Math.round(0.8 * i), variant: c.css("font-variant"), weight: c.css("font-weight"), family: c.css("font-family") };
                ...
                for (f = ea.yaxes.length || 1, d = 0; f > d; ++d)
                    (e = ea.yaxes[d]),
                        ...
                        e.font && ((e.font = a.extend({}, j, e.font)), e.font.color || (e.font.color = e.color), e.font.lineHeight || (e.font.lineHeight = Math.round(1.15 * e.font.size)));
                for (
                    ea.xaxis.noTicks && null == ea.xaxis.ticks && (ea.xaxis.ticks = ea.xaxis.noTicks),
                        ea.yaxis.noTicks && null == ea.yaxis.ticks && (ea.yaxis.ticks = ea.yaxis.noTicks),
                        ea.x2axis && ((ea.xaxes[1] = a.extend(!0, {}, ea.xaxis, ea.x2axis)), (ea.xaxes[1].position = "top"), null == ea.x2axis.min && (ea.xaxes[1].min = null), null == ea.x2axis.max && (ea.xaxes[1].max = null)),
                        ea.y2axis && ((ea.yaxes[1] = a.extend(!0, {}, ea.yaxis, ea.y2axis)), (ea.yaxes[1].position = "right"), null == ea.y2axis.min && (ea.yaxes[1].min = null), null == ea.y2axis.max && (ea.yaxes[1].max = null)),
                ...
                for (d = 0; d < ea.yaxes.length; ++d) q(la, d + 1).options = ea.yaxes[d];
                for (var k in pa) ea.hooks[k] && ea.hooks[k].length && (pa[k] = pa[k].concat(ea.hooks[k]));
            ...
            function o(a) {
                var b,
                    c,
                    d = {};
                for (b = 0; b < ka.length; ++b) (c = ka[b]), c && c.used && (d["x" + c.n] = c.c2p(a.left));
                for (b = 0; b < la.length; ++b) (c = la[b]), c && c.used && (d["y" + c.n] = c.c2p(a.top));
            ...
            function q(b, c) {
                return b[c - 1] || (b[c - 1] = { n: c, direction: b == ka ? "x" : "y", options: a.extend(!0, {}, b == ka ? ea.xaxis : ea.yaxis) }), b[c - 1];
            }
            function r() {
                var b,
                    c = da.length,
                ...
                var f,
                    ...
                    i = h.length,
                    j = 0;
                for (b = 0; c > b; b++) (f = a.color.parse(h[b % i] || "#666")), b % i == 0 && b && (j = j >= 0 ? (0.5 > j ? -j - 0.2 : 0) : -j), (g[b] = f.scale("rgb", 1 + j));
                var k,
                    l = 0;
                for (b = 0; b < da.length; ++b) {
            ...
            function s() {
                ...
                for (
                    ...
                    (g = da[c]), (g.datapoints = { points: [] }), h(pa.processRawData, [g, g.data, g.datapoints]);
                            ...
                            if (!v)
                                for (f = 0; j > f; ++f)
                                    (k = m[f]),
                                        (l = p[f]),
                                        l &&
                                            (l.number && null != k && ((k = +k), isNaN(k) ? (k = null) : k == 1 / 0 ? (k = s) : k == -(1 / 0) && (k = -s)),
                                            null == k && (l.required && (v = !0), null != l.defaultValue && (k = l.defaultValue))),
                                        (i[e + f] = k);
                            if (v) for (f = 0; j > f; ++f) (k = i[e + f]), null != k && ((l = p[f]), l.autoscale !== !1 && (l.x && b(g.xaxis, k, k), l.y && b(g.yaxis, k, k))), (i[e + f] = null);
                ...
                for (c = 0; c < da.length; ++c) {
                    ...
                    for (d = 0; d < i.length; d += j)
                        if (null != i[d]) for (f = 0; j > f; ++f) (k = i[d + f]), (l = p[f]), l && l.autoscale !== !1 && k != s && k != -s && (l.x && (w > k && (w = k), k > y && (y = k)), l.y && (x > k && (x = k), k > z && (z = k)));
                    if (g.bars.show) {
                        var A;
                        switch (g.bars.align) {
                            case "left":
            ...
            function x(a) {
                for (
                    var b = a.options,
                        ...
                        d = b.labelWidth || 0,
                        e = b.labelHeight || 0,
                        f = d || ("x" == a.direction ? Math.floor(fa.width / (c.length || 1)) : null),
                        g = a.direction + "Axis " + a.direction + a.n + "Axis",
                        h = "flot-" + a.direction + "-axis flot-" + a.direction + a.n + "-axis " + g,
            ...
            function y(b) {
                ...
                a.each(f ? ka : la, function (a, c) {
                    ...
                    isNaN(+g) || (i += +g),
                    f
                        ? ((d += i), "bottom" == e ? ((ma.bottom += d + h), (b.box = { top: fa.height - ma.bottom, height: d })) : ((b.box = { top: ma.top + h, height: d }), (ma.top += d + h)))
                        : ((c += i), "left" == e ? ((b.box = { left: ma.left + h, width: c }), (ma.left += c + h)) : ((ma.right += c + h), (b.box = { left: fa.width - ma.right, width: c }))),
                    (b.position = e),
                    (b.tickLength = g),
                    (b.box.padding = i),
                    (b.innermost = j);
            ...
            function z(a) {
                "x" == a.direction
                    ? ((a.box.left = ma.left - a.labelWidth / 2), (a.box.width = fa.width - ma.left - ma.right + a.labelWidth))
                    : ((a.box.top = ma.top - a.labelHeight / 2), (a.box.height = fa.height - ma.bottom - ma.top + a.labelHeight));
            }
            function A() {
                var b,
                    c = ea.grid.minBorderMargin;
                if (null == c) for (c = 0, b = 0; b < da.length; ++b) c = Math.max(c, 2 * (da[b].points.radius + da[b].points.lineWidth / 2));
                ...
                a.each(n(), function (a, b) {
                    b.reserveSpace &&
                        ...
                        b.ticks.length &&
                        ("x" === b.direction
                            ? ((d.left = Math.max(d.left, b.labelWidth / 2)), (d.right = Math.max(d.right, b.labelWidth / 2)))
                            : ((d.bottom = Math.max(d.bottom, b.labelHeight / 2)), (d.top = Math.max(d.top, b.labelHeight / 2))));
                }),
            ...
            function B() {
                ...
                for (var e in ma) "object" == typeof ea.grid.borderWidth ? (ma[e] += d ? ea.grid.borderWidth[e] : 0) : (ma[e] += d ? ea.grid.borderWidth : 0);
                if (
            ...
            function D(b) {
                var c,
                    e = b.options;
                c = "number" == typeof e.ticks && e.ticks > 0 ? e.ticks : 0.3 * Math.sqrt("x" == b.direction ? fa.width : fa.height);
                var f = (b.max - b.min) / c,
                ...
                var i,
                    ...
                    k = f / j;
                if (
                    (1.5 > k ? (i = 1) : 3 > k ? ((i = 2), k > 2.25 && (null == h || h >= g + 1) && ((i = 2.5), ++g)) : (i = 7.5 > k ? 5 : 10),
                    (i *= j),
                ...
                if (
                    ...
                    if (l && l.used && l != b) {
                        ...
                        if (
                            (m.length > 0 && (null == e.min && (b.min = Math.min(b.min, m[0])), null == e.max && m.length > 1 && (b.max = Math.max(b.max, m[m.length - 1]))),
                            (b.tickGenerator = function (a) {
                                var b,
                                    c,
                                    d = [];
            ...
            function G() {
                ...
                for (var b = 0; b < da.length; ++b) h(pa.drawSeries, [ia, da[b]]), L(da[b]);
            ...
            function J() {
                ...
                if (f)
                    for (a.isFunction(f) && ((c = qa.getAxes()), (c.xmin = c.xaxis.min), (c.xmax = c.xaxis.max), (c.ymin = c.yaxis.min), (c.ymax = c.yaxis.max), (f = f(c))), b = 0; b < f.length; ++b) {
                        var g = f[b],
                            h = H(g, "x"),
                            i = H(g, "y");
                        if (
                            ...
                            if (!j || !k)
                                if (((h.from = Math.floor(h.axis.p2c(h.from))), (h.to = Math.floor(h.axis.p2c(h.to))), (i.from = Math.floor(i.axis.p2c(i.from))), (i.to = Math.floor(i.axis.p2c(i.to))), j || k)) {
                                    ...
                                    ia.beginPath(),
                                        ...
                                        (ia.lineWidth = l),
                                        j ? (ia.moveTo(h.to + m, i.from), ia.lineTo(h.to + m, i.to)) : (ia.moveTo(h.from, i.to + m), ia.lineTo(h.to, i.to + m)),
                                        ia.stroke();
                ...
                for (var o = 0; o < c.length; ++o) {
                    ...
                    if (t.show && 0 != t.ticks.length) {
                        for (
                            ia.lineWidth = 1,
                                "x" == t.direction
                                    ? ((p = 0), (q = "full" == v ? ("top" == t.position ? 0 : oa) : u.top - ma.top + ("top" == t.position ? u.height : 0)))
                                    : ((q = 0), (p = "full" == v ? ("left" == t.position ? 0 : na) : u.left - ma.left + ("left" == t.position ? u.width : 0))),
                                t.innermost ||
                                    ((ia.strokeStyle = t.options.color),
                                    ia.beginPath(),
                                    (r = s = 0),
                                    "x" == t.direction ? (r = na + 1) : (s = oa + 1),
                                    1 == ia.lineWidth && ("x" == t.direction ? (q = Math.floor(q) + 0.5) : (p = Math.floor(p) + 0.5)),
                                    ia.moveTo(p, q),
                                    ia.lineTo(p + r, q + s),
                                    ia.stroke()),
                            ...
                            (r = s = 0),
                                isNaN(w) ||
                                    w < t.min ||
                                    w > t.max ||
                                    ("full" == v && (("object" == typeof d && d[t.position] > 0) || d > 0) && (w == t.min || w == t.max)) ||
                                    ("x" == t.direction ? ((p = t.p2c(w)), (s = "full" == v ? -oa : v), "top" == t.position && (s = -s)) : ((q = t.p2c(w)), (r = "full" == v ? -na : v), "left" == t.position && (r = -r)),
                                    1 == ia.lineWidth && ("x" == t.direction ? (p = Math.floor(p) + 0.5) : (q = Math.floor(q) + 0.5)),
                                    ia.moveTo(p, q),
                                    ia.lineTo(p + r, q + s));
                        }
                        ia.stroke();
                ...
                d &&
                    ...
                    "object" == typeof d || "object" == typeof e
                        ? ("object" != typeof d && (d = { top: d, right: d, bottom: d, left: d }),
                          "object" != typeof e && (e = { top: e, right: e, bottom: e, left: e }),
                          d.top > 0 && ((ia.strokeStyle = e.top), (ia.lineWidth = d.top), ia.beginPath(), ia.moveTo(0 - d.left, 0 - d.top / 2), ia.lineTo(na, 0 - d.top / 2), ia.stroke()),
                          d.right > 0 && ((ia.strokeStyle = e.right), (ia.lineWidth = d.right), ia.beginPath(), ia.moveTo(na + d.right / 2, 0 - d.top), ia.lineTo(na + d.right / 2, oa), ia.stroke()),
                          d.bottom > 0 && ((ia.strokeStyle = e.bottom), (ia.lineWidth = d.bottom), ia.beginPath(), ia.moveTo(na + d.right, oa + d.bottom / 2), ia.lineTo(0, oa + d.bottom / 2), ia.stroke()),
                          d.left > 0 && ((ia.strokeStyle = e.left), (ia.lineWidth = d.left), ia.beginPath(), ia.moveTo(0 - d.left / 2, oa + d.bottom), ia.lineTo(0 - d.left / 2, 0), ia.stroke()))
                        : ((ia.lineWidth = d), (ia.strokeStyle = ea.grid.borderColor), ia.strokeRect(-d / 2, -d / 2, na + d, oa + d))),
                    ia.restore();
            }
            function K() {
                a.each(n(), function (a, b) {
                        ...
                        for (var l = 0; l < b.ticks.length; ++l)
                            (c = b.ticks[l]),
                                !c.label ||
                                    ...
                                    c.v > b.max ||
                                    ("x" == b.direction
                                        ? ((f = "center"), (d = ma.left + b.p2c(c.v)), "bottom" == b.position ? (e = h.top + h.padding) : ((e = h.top + h.height - h.padding), (g = "bottom")))
                                        : ((g = "middle"), (e = ma.top + b.p2c(c.v)), "left" == b.position ? ((d = h.left + h.width - h.padding), (f = "right")) : (d = h.left + h.padding)),
                ...
                function c(a, b, c) {
                    for (var d = a.points, e = a.pointsize, f = Math.min(Math.max(0, c.min), c.max), g = 0, h = !1, i = 1, j = 0, k = 0; ; ) {
                        ...
                        if (null != l && null != n) {
                            ...
                            if ((h || (ia.beginPath(), ia.moveTo(b.p2c(l), c.p2c(f)), (h = !0)), m >= c.max && o >= c.max)) ia.lineTo(b.p2c(l), c.p2c(c.max)), ia.lineTo(b.p2c(n), c.p2c(c.max));
                            else if (m <= c.min && o <= c.min) ia.lineTo(b.p2c(l), c.p2c(c.min)), ia.lineTo(b.p2c(n), c.p2c(c.min));
                            else {
                                var p = l,
                                    q = n;
                                o >= m && m < c.min && o >= c.min ? ((l = ((c.min - m) / (o - m)) * (n - l) + l), (m = c.min)) : m >= o && o < c.min && m >= c.min && ((n = ((c.min - m) / (o - m)) * (n - l) + l), (o = c.min)),
                                    ...
                                    n != q && (ia.lineTo(b.p2c(n), c.p2c(o)), ia.lineTo(b.p2c(q), c.p2c(o)));
                            }
                        }
                    }
                }
                ...
                function b(a, b, c, d, e, f, g, h) {
                    for (var i = a.points, j = a.pointsize, k = 0; k < i.length; k += j) {
                        ...
                        null == l ||
                            ...
                            m < g.min ||
                            m > g.max ||
                            (ia.beginPath(), (l = f.p2c(l)), (m = g.p2c(m) + d), "circle" == h ? ia.arc(l, m, b, 0, e ? Math.PI : 2 * Math.PI, !1) : h(ia, l, m, b, e), ia.closePath(), c && ((ia.fillStyle = c), ia.fill()), ia.stroke());
                    }
                }
                ia.save(), ia.translate(ma.left, ma.top);
            ...
            function O(a, b, c, d, e, f, g, h, i, j, k) {
                ...
                j
                    ? ((s = q = r = !0), (p = !1), (l = c), (m = a), (o = b + d), (n = b + e), l > m && ((t = m), (m = l), (l = t), (p = !0), (q = !1)))
                    : ((p = q = r = !0), (s = !1), (l = a + d), (m = a + e), (n = c), (o = b), n > o && ((t = o), (o = n), (n = t), (s = !0), (r = !1))),
                    m < g.min ||
                        l > g.max ||
                        o < h.min ||
                        n > h.max ||
                        ...
                        k > 0 &&
                            (p || q || r || s) &&
                            (i.beginPath(), i.moveTo(l, n), p ? i.lineTo(l, o) : i.moveTo(l, o), r ? i.lineTo(m, o) : i.moveTo(m, o), q ? i.lineTo(m, n) : i.moveTo(m, n), s ? i.lineTo(l, n) : i.moveTo(l, n), i.stroke()));
            }
            function P(a) {
                function b(b, c, d, e, f, g) {
                    for (var h = b.points, i = b.pointsize, j = 0; j < h.length; j += i) null != h[j] && O(h[j], h[j + 1], h[j + 2], c, d, e, f, g, ia, a.bars.horizontal, a.bars.lineWidth);
                }
            ...
            function Q(b, c, d, e) {
                ...
                return (g.a = "number" == typeof f ? f : 0.4), g.normalize(), g.toString();
            }
            function R() {
                if ((null != ea.legend.container ? a(ea.legend.container).html("") : c.find(".legend").remove(), ea.legend.show)) {
                    ...
                    for (var i = 0; i < f.length; ++i) {
                        var k = f[i];
                        i % ea.legend.noColumns == 0 && (g && e.push("</tr>"), e.push("<tr>"), (g = !0)),
                            e.push(
                    ...
                    if ((g && e.push("</tr>"), 0 != e.length)) {
                        ...
                        if (null != ea.legend.container) a(ea.legend.container).html(l);
                            ...
                            if (0 != ea.legend.backgroundOpacity) {
                                ...
                                var r = p.children();
                                a('<div style="position:absolute;width:' + r.width() + "px;height:" + r.height() + "px;" + m + "background-color:" + q + ';"> </div>')
                                    .prependTo(p)
            ...
            function S(a, b, c) {
                ...
                return i ? ((d = i[0]), (e = i[1]), (f = da[d].datapoints.pointsize), { datapoint: da[d].datapoints.points.slice(e * f, (e + 1) * f), dataIndex: e, series: da[d], seriesIndex: d }) : null;
            }
            function T(a) {
                ea.grid.hoverable &&
            ...
            function Y() {
                ...
                var a, b;
                for (a = 0; a < ra.length; ++a) (b = ra[a]), b.series.bars.show ? ba(b.series, b.point) : aa(b.series, b.point);
            ...
            function Z(a, b, c) {
                ...
                var e = _(a, b);
                -1 == e ? (ra.push({ series: a, point: b, auto: c }), X()) : c || (ra[e].auto = !1);
            }
            function $(a, b) {
            ...
            function aa(b, c) {
                var d = c[0],
                    ...
                    f = b.xaxis,
                    g = b.yaxis,
                    h = "string" == typeof b.highlightColor ? b.highlightColor : a.color.parse(b.color).scale("a", 0.5).toString();
            ...
            function ba(b, c) {
                var d,
                    e = "string" == typeof b.highlightColor ? b.highlightColor : a.color.parse(b.color).scale("a", 0.5).toString(),
                    f = e;
                switch (b.bars.align) {
                    case "left":
                        d = 0;
            ...
            var da = [],
                ...
                na = 0,
                oa = 0,
                pa = { processOptions: [], processRawData: [], processDatapoints: [], processOffset: [], drawBackground: [], drawSeries: [], draw: [], bindEvents: [], drawOverlay: [], shutdown: [] },
                qa = this;
            (qa.setData = k),
                (qa.setupGrid = B),
                (qa.draw = G),
                ...
                (qa.pointOffset = function (a) {
                    return { left: parseInt(ka[m(a, "x") - 1].p2c(+a.x) + ma.left, 10), top: parseInt(la[m(a, "y") - 1].p2c(+a.y) + ma.top, 10) };
                }),
                (qa.shutdown = v),
                (qa.destroy = function () {
                ...
                return (
                    null == c &&
                        (null == this.textContainer &&
                            (this.textContainer = a("<div class='flot-text'></div>").css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0, "font-size": "smaller", color: "#545454" }).insertAfter(this.element)),
                        (c = this.text[b] = a("<div></div>").addClass(b).css({ position: "absolute", top: 0, left: 0, bottom: 0, right: 0 }).appendTo(this.textContainer))),
                    c
                );
            }),
