...
const ContaRecSchema = mongoose.Schema({
    ...
    //Identificador da NF
    contarec_nftipo :{ type: String, required: true},
    ...
    contarec_benenometipo :{ type: String, required: false },
    ...
    contarec_vlrnflote :{ type: String, required: false },
    ...
    contarec_alqirpj :{ type: String, required: false },
    ...
    contarec_vlrirpj :{ type: String, required: false },
    contarec_vlriss :{ type: String, required: false },
    //Observações
    contarec_pg :{ type: String, required: false },
...
class ContaRec{
    constructor(
        ...
        this.contarec_vlrnflote = contarec_vlrnflote,
        ...
        this.contarec_alqirpj = contarec_alqirpj,
        ...
        this.contarec_vlrirpj = contarec_vlrirpj,
...
module.exports = {ContaRecModel, ContaRecSchema,
    contarecEditar: async (req, res) => {
        ...
        contarec_vlrnflote : req.body.contarecVlrnflote,
        ...
        contarec_alqirpj : req.body.contarecAlqirpj,
        ...
        contarec_vlrirpj : req.body.contarecVlrirpj,
