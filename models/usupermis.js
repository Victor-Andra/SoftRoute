...
class Usupermis {
    constructor(
        ...
        this.usupermis_codigofunc = usupermis_codigofunc;
...
const UsupermisSchema = mongoose.Schema({
    ...
    usupermis_codfunc:   { type: ObjectId, ref: 'tb_usufunc', required: true },
    usupermis_nomefunc:  { type: String, required: true },
    usupermis_codigofunc: { type: String, required: true },
    usupermis_tipo:      { 
        type: String,
        enum: ['1', '2', '3', '4', '5', '6'],
        default: '1',
