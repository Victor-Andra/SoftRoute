...
//Enfermidades, aadicionar 13-04-2026
anamn_problcardiaco: { type: String, required: false }, //Ok
anamn_asmabronquite: { type: String, required: false }, //Ok
anamn_desmaiotontura: { type: String, required: false }, //Ok
anamn_feridainfectpele: { type: String, required: false }, //Ok
...
anamn_fraquesamuscular: { type: String, required: false }, //13-04-2026  ← CORRIGIDO: fraqueza → fraquesa (com s)
...
//Aquatica 13-04-2026
anamn_piscina: { type: String, required: false }, //Já teve contato com piscina?
anamn_medoagua: { type: String, required: false }, //Apresenta medo da água?
anamn_molharrosto: { type: String, required: false }, //Aceita molhar o rosto?
anamn_mergulha: { type: String, required: false }, //Já mergulha?
anamn_prenderesp: { type: String, required: false }, //Consegue prender a respiração?
anamn_flutua: { type: String, required: false }, //Flutua: ( ) Sozinho  ( ) Com ajuda  ( ) Não flutua
anamn_buscaexeagua: { type: String, required: false }, //Demonstra busca excessiva pela água (impulsividade)?
anamn_afogoutrauma: { type: String, required: false }, //Já teve experiência de afogamento ou trauma com água?
anamn_sensiagua: { type: String, required: false }, //Apresenta sensibilidade ao toque da água?
anamn_aguatempmal: { type: String, required: false }, //Reage mal à temperatura da água?
anamn_estintensosagua: { type: String, required: false }, //Busca estímulos intensos (pular, mergulhar, bater na água)?
anamn_obsaqua: { type: String, required: false }, //Observação: (campo aberto para escrever)
//Rotinas
...
anamn_cirurgia, //Ok
//Enfermidades,
anamn_problcardiaco, //Ok
anamn_asmabronquite, //Ok
anamn_desmaiotontura, //Ok
anamn_feridainfectpele, //Ok
//Enfermidades Adicionais 13-04-2026
...
anamn_fraquesamuscular, //13-04-2026  ← CORRIGIDO: fraquesaMuscular → fraquesamuscular
//Desenvolvimento Tatil
...
anamn_obsescola, //Ok
//Aquatica 13-04-2026
anamn_piscina, //Já teve contato com piscina?
anamn_medoagua, //Apresenta medo da água?
anamn_molharrosto, //Aceita molhar o rosto?
anamn_mergulha, //Já mergulha?
anamn_prenderesp, //Consegue prender a respiração?
anamn_flutua, //Flutua: ( ) Sozinho  ( ) Com ajuda  ( ) Não flutua
anamn_buscaexeagua, //Demonstra busca excessiva pela água (impulsividade)?
anamn_afogoutrauma, //Já teve experiência de afogamento ou trauma com água?
anamn_sensiagua, //Apresenta sensibilidade ao toque da água?
anamn_aguatempmal, //Reage mal à temperatura da água?
anamn_estintensosagua, //Busca estímulos intensos (pular, mergulhar, bater na água)?
anamn_obsaqua, //Observação: (campo aberto para escrever)
//Rotinas
...
//Enfermidades adicionais em 13-04-2026,
this.anamn_problcardiaco = anamn_problcardiaco, //Ok
this.anamn_asmabronquite = anamn_asmabronquite, //Ok
this.anamn_desmaiotontura = anamn_desmaiotontura, //Ok
this.anamn_feridainfectpele = anamn_feridainfectpele, //Ok
...
this.anamn_fraquesamuscular = anamn_fraquesamuscular, //13-04-2026 ← CORRIGIDO: fraquesaMuscular → fraquesamuscular
//Desenvolvimento Tatil
...
//Aquatica 13-04-2026
this.anamn_piscina = anamn_piscina, //Já teve contato com piscina?
this.anamn_medoagua = anamn_medoagua, //Apresenta medo da água?
this.anamn_molharrosto = anamn_molharrosto, //Aceita molhar o rosto?
this.anamn_mergulha = anamn_mergulha, //Já mergulha?
this.anamn_prenderesp = anamn_prenderesp, //Consegue prender a respiração?
this.anamn_flutua = anamn_flutua, //Flutua: ( ) Sozinho  ( ) Com ajuda  ( ) Não flutua
this.anamn_buscaexeagua = anamn_buscaexeagua, //Demonstra busca excessiva pela água (impulsividade)?
this.anamn_afogoutrauma = anamn_afogoutrauma, //Já teve experiência de afogamento ou trauma com água?
this.anamn_sensiagua = anamn_sensiagua, //Apresenta sensibilidade ao toque da água?
this.anamn_aguatempmal = anamn_aguatempmal, //Reage mal à temperatura da água?
this.anamn_estintensosagua = anamn_estintensosagua, //Busca estímulos intensos (pular, mergulhar, bater na água)?
this.anamn_obsaqua = anamn_obsaqua, //Observação: (campo aberto para escrever)
//Rotinas
...
const LocalAnamn = getModel(db, 'tb_anamn', AnamnSchema); // ← CORRIGIDO: variável local para evitar reatribuição global
//;
...
//Realiza Atualização
try { // ← CORRIGIDO: try/catch para retorno correto em async
await LocalAnamn.findByIdAndUpdate(req.body.id,
{$set: {
...
//Enfermidades adicionais em 13-04-2026,
anamn_problcardiaco: req.body.anamnProblcardiaco, //Ok
anamn_asmabronquite: req.body.anamnAsmabronquite, //Ok
anamn_desmaiotontura: req.body.anamnDesmaiotontura, //Ok
anamn_feridainfectpele: req.body.anamnFeridainfectpele, //Ok
//Enfermidades
...
anamn_fraquesamuscular: req.body.anamnFraquesamuscular,
//Desenvolvimento Tatil
...
//Aquatica 13-04-2026
anamn_piscina: req.body.anamnPiscina, //Já teve contato com piscina?
anamn_medoagua: req.body.anamnMedoagua, //Apresenta medo da água?
anamn_molharrosto: req.body.anamnMolharrosto, //Aceita molhar o rosto?
anamn_mergulha: req.body.anamnMergulha, //Já mergulha?
anamn_prenderesp: req.body.anamnPrenderesp, //Consegue prender a respiração?
anamn_flutua: req.body.anamnFlutua, //Flutua: ( ) Sozinho  ( ) Com ajuda  ( ) Não flutua
anamn_buscaexeagua: req.body.anamnBuscaexeagua, //Demonstra busca excessiva pela água (impulsividade)?
anamn_afogoutrauma: req.body.anamnAfogoutrauma, //Já teve experiência de afogamento ou trauma com água?
anamn_sensiagua: req.body.anamnSensiagua, //Apresenta sensibilidade ao toque da água?
anamn_aguatempmal: req.body.anamnAguatempmal, //Reage mal à temperatura da água?
anamn_estintensosagua: req.body.anamnEstintensosagua, //Busca estímulos intensos (pular, mergulhar, bater na água)?
anamn_obsaqua: req.body.anamnObsaqua, //Observação: (campo aberto para escrever)
//Rotinas
...
console.log("Salvo")
return true; // ← CORRIGIDO: retorno direto dentro do try
} catch (err) {
console.log("erro mongo:")
console.log(err)
return err; // ← CORRIGIDO: retorno do erro propagado corretamente
}
},
// Add Anamnese
// Criado por: Wagner Cintra
...
//Estrura Multiempresa
let db = req.cookies['preferredDb'];
const LocalAnamn = getModel(db, 'tb_anamn', AnamnSchema); // ← CORRIGIDO: variável local
//;
...
anamn_sudorese: req.body.anamnSudorese,
anamn_terrornoturno: req.body.anamnTerrornoturno,
anamn_ronca: req.body.anamnRonca, // ← CORRIGIDO: anamnRouco → anamnRonca
anamn_respiraoral: req.body.anamnRespiraoral,
anamn_proximoolhos: req.body.anamnProximoolhos,
anamn_proximoolhosdesc: req.body.anamnProximoolhosdesc,
anamn_choranoitedesc: req.body.anamnChoranoitedesc,
...
try { // ← CORRIGIDO: try/catch para retorno correto
await newAnamn.save();
console.log("Cadastro realizado!");
return true; // ← CORRIGIDO: retorno propagado corretamente
} catch (err) {
console.log(err)
return err; // ← CORRIGIDO: erro propagado corretamente
}
}
};