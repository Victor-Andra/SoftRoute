...
class Anamn{
    constructor(
        ...
        anamn_tecid
            ...
            this.anamn_rubéola = anamn_rubeola, 
...
module.exports = {AnamnModel,AnamnSchema,
    anamnEditar: async (req, res) => {
        ...
        await AnamnModel.findByIdAndUpdate(req.body.anamnId, 
            {$set: {
                ...
                anamn_rubéola: req.body.anamnRubeola,
    ...
    anamnAdicionar: async (req,res) => {
        let anamnExiste =  await AnamnModel.findOne({anamn_nome: req.body.anamnNome});//quando não acha fica null
        let dataAtual = new Date();
        
        if(anamnExiste){//se tiver null cai no else
            return "O nome da anamn já existe";
        } else {
