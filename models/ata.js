...
const AtaSchema = mongoose.Schema({
    ...
    ata_xvi06:{ type: String, required: false },
    ata_xvi07:{ type: String, required: false },
    ata_xvi08:{ type: String, required: false },
...
class Ata{
    ...
    this.ata_xvi06 = ata_xvi06,
    this.ata_xvi07 = ata_xvi07,
    this.ata_xvi08 = ata_xvi08,
    //XVII
    ...
    ataEditar: async (req, res) => {
        ...
        await AtaModel.findByIdAndUpdate(req.body.ataId, 
            {$set: {
                ...
                ata_xvi06: req.body.ataXvi06temp,
                ata_xvi07: req.body.ataXvi07temp,
                ata_xvi08: req.body.ataXvi08temp,
                //XVII
