...
const BeneSchema = mongoose.Schema({
    ...
    bene_datanasc:{ type: Date, required: false },
    ...
    bene_endcidade:{ type: String, required: false},
    ...
    bene_ncarteiraconv: { type: String, required: false },
    ...
    bene_aba:{ type: String, required: false},
...
class Bene{
    constructor(
        ...
        bene_escolacoordtel,
        bene_escolaoutro1,
        bene_escolaoutro1func,
        bene_escolaoutro1tel,
        bene_escolaoutro2,
        bene_escolaoutro2func,
        bene_escolaoutro2tel,
        bene_escolaoutro3,
        bene_escolaoutro3func,
        bene_escolaoutro3tel,
        bene_escolaobs,
        bene_escolaemail,
        bene_escolaturno,
        bene_escolahoraini,
        ...
        bene_dataedi
            ...
            this.bene_ncarteiraconv = bene_ncarteiraconv,
    ...
    beneEditar: async (req, res) => {
        ...
        await BeneModel.findByIdAndUpdate(req.body.id, 
            {$set: {
                ...
                bene_ncarteiraconv: req.body.beneNcarteiraconv,
                ...
                bene_pai: fncGeral.capitalizarNome(req.body.benePai),
                ...
                bene_mae: fncGeral.capitalizarNome(req.body.beneMae),
