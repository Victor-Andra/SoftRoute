...
module.exports = {
    ...
    atualizaUsuario(req,res){
        let resposta;        
        console.log("req.body.usuarioNome: "+req.body.usuarioNome)//SE TIRAR O EDITAR PARA DE FUNCIONAR, NÃO MECHA
        try{
            usuarioClass.usuarioEditar(req,res).then((fim)=>{
