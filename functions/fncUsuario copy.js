...
var Perfil = getModel("SoftRoute", 'tb_perfil', perfilClass.PerfilSchema)
...
var Usufunc = getModel("softRoute", 'tb_usufunc', usufuncClass.UsufuncSchema)
var Usupermis = getModel("softRoute", 'tb_usupermis', usupermisClass.UsupermisSchema)
