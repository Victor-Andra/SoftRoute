...
module.exports = {
    ...
    relAtendimentoValFiltro(req,res){
        ...
        let atends;
        let conv_nome;
        let voidId = new mongoose.mongo.ObjectId('766f69643132333435366964');
        ...
        .then(([atRaw, convs, convSelecionado, terapias, anos, usuarios, benes]) => {
            ...
            terapias.forEach(t => {
                ...
                atOrdenado.forEach(at => {
                    let terapiaId;
                    if (at.atend_fixo === true || at.atend_fixo === "true"){
                   ...
                   const origemLabel = (() => {
                    ...
                    const formatValor = (v) => v === "0,00"
                        ? `<span class="label label-sm label-warning">${v}</span>`
                        : v;
                        ...
                        Bene.find().then((bene)=>{
                            ...
                            Conv.findOne({_id: conv_id}).then((conv)=>{
                                ...
                                at.forEach((atend) => {
                                    ...
                                    if (categorias !== "Apoio" && categorias !== "Feriado" && categorias !== "Falta Absoluta" && terapiaAtend !== "break") {
                                        ...
                                        arrayconvid.forEach((convid)=>{
                                            terapia.forEach((t)=>{
                                                ...
                                                atends.forEach((atend)=>{
                                                    ...
                                                    if (categorias != "Apoio" && categorias != "Feriado" && categorias != "Falta Absoluta" && categorias != "Falta Justificada" && atend.atend_fixo == "true" && (creVal == "0,00" || creVal == undefined || creVal == "undefined")){
                                                        let convcreval;
                                                        let convcreTes;
                                                        let agendacreTes;
                                                        terapiaAtend = atend.atend_fixoterapiaid;
...
//NEW END
    ...
    relfaltasbeneOLD: async (req, res) => {
        try {
            console.log("\n======================");
            ...
            const atendimentos = await Atend.find(
                ...
                'atend_beneid atend_convid atend_categoria atend_atenddata atend_atendhora atend_terapia atend_terapeuta'
            ).lean();
