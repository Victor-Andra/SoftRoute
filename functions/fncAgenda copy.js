...
module.exports = {
    ...
    converteAgendaEmAtend(req,res){//Fazer ajuste para encontrar agendas diarias e substituir as fixas correspondentes.
        ...
        let cc = convcreClass.convcreCarregarTodos(req,res); //Convcre.find().then((convcre) => {//{convcre_convid: a.agenda_convid, convcre_terapiaid: a.agenda_terapiaid}
                    let cd = convdebClass.convdebCarregarTodos(req,res); //Convdeb.find().then((convdeb) => {//{convdeb_convid: a.agenda_convid, convdeb_terapiaid: a.agenda_terapiaid}
        ...
        Agenda.find({agenda_data: { $gte: dataIni, $lte: dataFim}}).then((agenda)=>{
            ...
            Atend.find().sort({atend_num : -1}).limit(1).then((atendimento) =>{
                ...
                console.log("atendNum: "+atend.atend_num)
                    ...
                    console.log("Geek!");
                        ...
                        agenda.forEach((a)=>{
                            ...
                            if(a.agenda_migrado != true){
                                ...
                                convcre.forEach((cre)=>{
                                    if(cre.convcre_convid == a.agenda_convid && cre.convcre_terapiaid == a.agenda_terapiaid){
                                        console.log("if ("+cre.convcre_convid+" == "+a.agenda_convid+" && "+cre.convcre_terapiaid+" == "+a.agenda_terapiaid)
                                        convcreval = cre.convcre_valor;
                                    }
                                })
                                convdeb.forEach((deb)=>{
                                    if(deb.convdeb_convid == a.agenda_convid && deb.convdeb_terapiaid == a.agenda_terapiaid){
                                        console.log("if ("+deb.convdeb_convid+" == "+a.agenda_convid+" && "+deb.convdeb_terapiaid+" == "+a.agenda_terapiaid)
